...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(session != null && session.getAttribute(WebKeys.USUARIO) != null){
                Boolean isAdmin = session.getAttribute(WebKeys.INICIA_SESION_ADMINISTRACION) == null? false: (Boolean)session.getAttribute(WebKeys.INICIA_SESION_ADMINISTRACION);
                if(isAdmin){
                    url = "seguridad.do?ACCION=" + AWSeguridad.INICIAR_COMO_ADMINISTRADOR;
                }else{
                    url = "roles.view";
                }
            }
