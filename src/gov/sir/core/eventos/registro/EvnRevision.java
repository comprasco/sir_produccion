...
public class EvnRevision extends EvnSIR {
	 ...
	 * @param tipoEvento
	 */
	public EvnRevision(Usuario usuario, String tipoEvento) {
	 ...
	 */
	public EvnRevision(Usuario usuario, String tipoEvento, Folio folio, gov.sir.core.negocio.modelo.Usuario usuarioNeg){
		super(usuario, tipoEvento);
		this.folio=folio;
	...
	public EvnRevision(Usuario usuario , Turno turno, gov.sir.core.negocio.modelo.Usuario usuarioNeg) {
	 ...
	 * @param string
	 */
	public EvnRevision(Usuario usuario, gov.sir.core.negocio.modelo.Usuario usuarioNeg, Turno turno, Fase fase,  String respuestaWf, int tipoAvance) {
