 ...
 * @author jmendez
 */
public class EvnRespRecargarListasContexto extends EvnSIRRespuesta {
	 ...
	 * @param payload
	 */
	public EvnRespRecargarListasContexto(Object payload) {
		super(payload);
	}
	 ...
	 * @param tipoEvento
	 */
	public EvnRespRecargarListasContexto(Object payload, String tipoEvento) {
