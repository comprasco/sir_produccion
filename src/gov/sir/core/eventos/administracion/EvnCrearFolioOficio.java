 ...
 */
public class EvnCrearFolioOficio extends EvnSIR {
	 ...
	 * @param usuario
	 */
	public EvnCrearFolioOficio(Usuario usuario) {
        super(usuario);
    }
	 ...
	 * @param tipoEvento
	 */
	public EvnCrearFolioOficio(Usuario usuario, String tipoEvento) {
	 ...
	 * @param usuarioSir
	 */
	public EvnCrearFolioOficio(Usuario usuario, String tipoEvento, Folio folio, gov.sir.core.negocio.modelo.Usuario usuarioSir) {
		super(usuario, tipoEvento);
		this.folio = folio;
