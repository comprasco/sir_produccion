 ...
 */
public class EvnRespCrearFolioOficio extends EvnSIRRespuesta {
    ...
    /** @param payload */
    public EvnRespCrearFolioOficio(Object payload) {
        super(payload);
    }

    /** @param payload
     /** @param tipoEvento */
    public EvnRespCrearFolioOficio(Object payload, String tipoEvento) {
