...
/** Clase que define los atributos que identifican a ResultadoAnotacion	  */

public class ResultadoAnotacionPk implements java.io.Serializable {
    ...
    public ResultadoAnotacionPk() {
    }

    public ResultadoAnotacionPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResultadoAnotacionPk)) return false;

        final ResultadoAnotacionPk id = (ResultadoAnotacionPk) o;
