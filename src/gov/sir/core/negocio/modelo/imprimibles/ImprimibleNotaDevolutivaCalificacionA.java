 ...
 */
public class ImprimibleNotaDevolutivaCalificacionA extends ImprimibleBase{
     ...
     * @param nota
     */
	public ImprimibleNotaDevolutivaCalificacionA(Vector notas, String nombreCirculo, String turno, String matricula, Documento documento, Usuario usuarioSIR, String textoCertificadosAsociados, String fechaImpresion,String tipoImprimible) {
...
/**
	...
	public void generate(PageFormat pageFormat)
	{
            ...
            this.imprimirLinea(ImprimibleConstantes.TITULO2,ImprimibleConstantes.MARGEN_IZQ,"");
            this.imprimirLinea(ImprimibleConstantes.TITULO2,ImprimibleConstantes.MARGEN_IZQ,"Conforme con el principio de Legalidad Registral previsto por el articulo 37 del Decreto Ley 1250 de 1970 (Estatuto del Registro de Instrumentos Publicos), se rechaza sin registrar el citado documento  por las siguientes razones y fundamentos de derecho:",135);
            ...
            */
            ...
            String descDevolutiva3 = "LOS ACTOS O NEGOCIOS JURIDICOS A QUE SE REFIERE EL ARTICULO 2 DEL " +
                    "ESTATUTO DEL REGISTRO DE INSTRUMENTOS PUBLICOS, DEBERAN PRESENTARSE PARA SU INSCRIPCION, " +
            ...
            String descDevolutiva4 = "EXCEPTUESE DE LO ANTERIOR, LOS CASOS RELACIONADOS CON EL NEGOCIO JURIDICO " +
                    "DE HIPOTECA Y EL ACTO DE CONSTITUCION DE PATRIMONIO DE FAMILIA DE QUE TRATA EL ARTICULO 32 " +
                    "DEL DECRETO LEY 1250 DE 1970, LOS CUALES SE DEBEN REGISTRAR DENTRO DE LOS NOVENTA (90)  " +
                    "DIAS HABILES SIGUIENTES A SU AUTORIZACION. VENCIDO EL TERMINO REGISTRAL ANTES SENALADO, " +
                    "DEBERAN CONSTITUIRSE A TRAVES DE UN NUEVO TITULO.";
            ...
            String descDevolutiva5 = "CONTRA EL PRESENTE ACTO ADMINISTRATIVO, PROCEDE EL RECURSO DE REPOSICION ANTE"
                    ...
                    + " POR EL NUMERAL 2 DEL ARTICULO 24 DEL DECRETO 2163 DEL 17 DE JUNIO DE 2011, PREVIO"
...
/**
	...
	protected void imprimirFirmaNotaDevolutiva() {
        ...
        protected void imprimirEntregado() {
            ...
            */
            String linea1 = "CONFORME LO DISPUESTO EN EL ARTICULO 44 DEL CODIGO CONTENCIOSO ADMINISTRATIVO, EN LA FECHA ____________________";
