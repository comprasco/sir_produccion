 ...
 */
public class ImprimibleRepartoMinuta extends ImprimibleBase {
	 ...
	 */
	public ImprimibleRepartoMinuta(Minuta minuta, Circulo circulo, String fechaImpresion, String radicacion, String tipoImprimible) {
	...
	private void imprimirDatosReparto() {
		...
		if(minuta!=null && minuta.getRepartoNotarial()!=null && minuta.getRepartoNotarial().getIdRepartoNotarial()!=null){
			...
			this.imprimirLinea(ImprimibleConstantes.TITULO2, "REPARTO NÚMERO : " + "1", false);	
		}
