 ...
 */
public class ImprimibleNotaDevolutivaCalificacion extends ImprimibleBase{
   ...
   private static final long serialVersionUID = 1L;
     ...
     * @param nota
     */
	public ImprimibleNotaDevolutivaCalificacion(Vector notas, String nombreCirculo, String turno, String matricula, Documento documento, Usuario usuarioSIR, String textoCertificadosAsociados, String fechaImpresion,String tipoImprimible) {
...
/**
	...
	public void generate(PageFormat pageFormat)
	{
            ...
            */
            ...
            /**
             * @Autor: fernando padilla velez, 22.06.2015
             * @change: 1202.AJUSTE.LEY.1579.NOTAS.DEVOLUTIVAS, se cambia el texto segun lo requerido.
             */
            String descDevolutiva3 = "LOS ACTOS O NEGOCIOS JURIDICOS A QUE SE REFIERE EL ARTICULO 4 " +
                    ...
                    "EN LA LEY 223 DE 1995 Y SU DECRETO REGLAMENTARIO 650 DE 1996 ARTICULO 14. ";
            ...
            String descDevolutiva5 = "CONTRA EL PRESENTE ACTO ADMINISTRATIVO, PROCEDE EL RECURSO DE REPOSICION ANTE"
                    + " EL REGISTRADOR DE INSTRUMENTOS PUBLICOS Y EN SUBSIDIO, EL DE APELACION ANTE LA"
                    + " SUBDIRECCION DE APOYO JURIDICO REGISTRAL DE LA SUPERINTENDENCIA DE NOTARIADO Y REGISTRO DENTRO DE"
                    + " LOS DIEZ(10) DIAS HABILES SIGUIENTES A SU NOTIFICACION, EN VIRTUD DE LO PREVISTO"
                    + " POR EL NUMERAL DOS (2) DEL ARTICULO 21 DEL DECRETO 2723 DEL 29 DE DICIEMBRE DE 2014, PREVIO"
