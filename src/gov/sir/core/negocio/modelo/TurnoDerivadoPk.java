...
public class TurnoDerivadoPk implements java.io.Serializable {
    ...
    public TurnoDerivadoPk() {
    }

    public TurnoDerivadoPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TurnoDerivadoPk)) return false;

        final TurnoDerivadoPk id = (TurnoDerivadoPk) o;
