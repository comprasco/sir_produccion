...
/** Clase que define los atributos que identifican a SolicitudAsociada   */

public class SolicitudAsociadaPk implements java.io.Serializable {

    public String idSolicitud;
    public String idSolicitud1;

    public SolicitudAsociadaPk() {
    }

    public SolicitudAsociadaPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SolicitudAsociadaPk)) return false;

        final SolicitudAsociadaPk id = (SolicitudAsociadaPk) o;
