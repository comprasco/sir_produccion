 ...
 */
public class WebAnotacionEnhancedPk implements java.io.Serializable {

    public String idSolicitud;
    public String idWebSegeng;

    public WebAnotacionEnhancedPk() {
    }

    public WebAnotacionEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAnotacionEnhancedPk)) return false;

        final WebAnotacionEnhancedPk id = (WebAnotacionEnhancedPk) o;
