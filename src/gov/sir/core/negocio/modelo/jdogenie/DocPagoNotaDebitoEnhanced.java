 ...
 */
public class DocPagoNotaDebitoEnhanced extends DocumentoPagoEnhanced {
	...
	public DocPagoNotaDebitoEnhanced() {
	}
    /**
     ...
     * @param valor
     */
    public DocPagoNotaDebitoEnhanced(BancoEnhanced banco, String codSucursalBanco, String noCuenta,
        String noNotaDebito, double valor) {
        this.tipoPago = DocumentoPagoEnhanced.PAGO_NOTA_DEBITO;
        this.banco = banco;
    ...
    public boolean equals(Object other) {
        if ((other == null) || !(other instanceof DocPagoNotaDebitoEnhanced)) {
            return false;
        }

        DocPagoNotaDebitoEnhanced p = (DocPagoNotaDebitoEnhanced) other;
	...
	public static DocPagoNotaDebitoEnhanced enhance(DocPagoNotaDebito docPagoNotaDebito){
	   return (DocPagoNotaDebitoEnhanced)Enhanced.enhance(docPagoNotaDebito);
	}
	/**
	 * @return
	 */
