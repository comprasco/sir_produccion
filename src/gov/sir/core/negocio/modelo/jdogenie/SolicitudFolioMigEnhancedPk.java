...
import gov.sir.core.negocio.modelo.SolicitudFolioMigPk;

/**
 * Application identity objectid-class.
 */
public class SolicitudFolioMigEnhancedPk implements java.io.Serializable {
    ...
    public SolicitudFolioMigEnhancedPk() {
    }

	public SolicitudFolioMigEnhancedPk(SolicitudFolioMigPk id){
	...
	public SolicitudFolioMigPk getSolicitudFolioMigID(){
		SolicitudFolioMigPk id = new SolicitudFolioMigPk();
    ...
    public SolicitudFolioMigEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SolicitudFolioMigEnhancedPk)) return false;

        final SolicitudFolioMigEnhancedPk id = (SolicitudFolioMigEnhancedPk) o;
