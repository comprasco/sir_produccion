 ...
 */
    public class VeredaEnhancedPk implements java.io.Serializable {
        public String idVereda;
		public String idMunicipio;
		public String idDepartamento;

        public VeredaEnhancedPk() {
        }

        public VeredaEnhancedPk(String s) {
			int i;
			int p = 0;
			i = s.indexOf('-', p);
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof VeredaEnhancedPk)) {
                return false;
            }

            final VeredaEnhancedPk id = (VeredaEnhancedPk) o;
