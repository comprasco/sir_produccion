 ...
 */
public class TurnoHistoriaEnhancedPk implements java.io.Serializable {
    ...
    public TurnoHistoriaEnhancedPk() {
    }
    

	public TurnoHistoriaEnhancedPk(TurnoHistoriaPk id) {
		anio = id.anio;
	...
	public TurnoHistoriaPk getTurnoID() {
		TurnoHistoriaPk rta = new TurnoHistoriaPk();
		rta.anio = anio;
    ...
    public TurnoHistoriaEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TurnoHistoriaEnhancedPk)) return false;

        final TurnoHistoriaEnhancedPk id = (TurnoHistoriaEnhancedPk) o;
