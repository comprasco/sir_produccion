 ...
 */
public class ValidacionNotaDetalleEnhancedPk implements java.io.Serializable {
    ...
    public ValidacionNotaDetalleEnhancedPk() {
    }

    public ValidacionNotaDetalleEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidacionNotaDetalleEnhancedPk)) return false;

        final ValidacionNotaDetalleEnhancedPk id = (ValidacionNotaDetalleEnhancedPk) o;
