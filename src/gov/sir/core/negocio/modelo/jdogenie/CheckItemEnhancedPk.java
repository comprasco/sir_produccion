 ...
 */
public class CheckItemEnhancedPk implements java.io.Serializable {

    public String idCheckItem;
    public String idSubtipoSol;

    public CheckItemEnhancedPk() {
    }
    
    public CheckItemEnhancedPk(CheckItemPk oid){
    	idCheckItem = oid.idCheckItem;
		idSubtipoSol = oid.idSubtipoSol;
    }
    
    public CheckItemPk getCheckItemID() {
		CheckItemPk rta = new CheckItemPk();
		rta.idCheckItem = idCheckItem;
		rta.idSubtipoSol = idSubtipoSol;
		return rta;
    }

    public CheckItemEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckItemEnhancedPk)) return false;

        final CheckItemEnhancedPk id = (CheckItemEnhancedPk) o;
