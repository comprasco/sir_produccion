...
import gov.sir.core.negocio.modelo.CirculoRelacionPk;

/**
 * Application identity objectid-class.
 */
public class CirculoRelacionEnhancedPk implements java.io.Serializable {

    public String anio;
    public String idCirculo;

    public CirculoRelacionEnhancedPk() {
    }

    public CirculoRelacionEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
