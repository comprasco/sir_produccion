 ...
 */
public class WebFolioEnglobeEnhancedPk implements java.io.Serializable {

    public String idMatricula;
    public String idSolicitud;
    public String idWebSegeng;

    public WebFolioEnglobeEnhancedPk() {
    }

    public WebFolioEnglobeEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioEnglobeEnhancedPk)) return false;

        final WebFolioEnglobeEnhancedPk id = (WebFolioEnglobeEnhancedPk) o;
