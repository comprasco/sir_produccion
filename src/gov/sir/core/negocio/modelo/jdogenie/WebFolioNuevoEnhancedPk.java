 ...
 */
public class WebFolioNuevoEnhancedPk implements java.io.Serializable {

    public String idSolicitud;
    public String idWebSegeng;

    public WebFolioNuevoEnhancedPk() {
    }

    public WebFolioNuevoEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioNuevoEnhancedPk)) return false;

        final WebFolioNuevoEnhancedPk id = (WebFolioNuevoEnhancedPk) o;
