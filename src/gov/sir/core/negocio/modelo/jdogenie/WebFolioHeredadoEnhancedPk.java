 ...
 */
public class WebFolioHeredadoEnhancedPk implements java.io.Serializable {

    public String idMatricula;
    public String idSolicitud;
    public String idWebSegeng;

    public WebFolioHeredadoEnhancedPk() {
    }

    public WebFolioHeredadoEnhancedPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioHeredadoEnhancedPk)) return false;

        final WebFolioHeredadoEnhancedPk id = (WebFolioHeredadoEnhancedPk) o;
