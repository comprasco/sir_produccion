 ...
 */
public class DocPagoGeneralEnhanced extends DocumentoPagoEnhanced {
...
//    private String nombreCanal;
    ...
    public DocPagoGeneralEnhanced() {
    }

    public DocPagoGeneralEnhanced(int idTipoDocPago, String fechaDocu, String noConsignacion,
    ...
    public static DocPagoGeneralEnhanced enhance(DocPagoGeneral docPagoGeneral) {
        return (DocPagoGeneralEnhanced) Enhanced.enhance(docPagoGeneral);
    }
