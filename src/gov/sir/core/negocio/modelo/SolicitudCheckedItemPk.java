...
/** Clase que define los atributos que identifican a SolicitudCheckedItem	  */

public class SolicitudCheckedItemPk implements java.io.Serializable {

    public String idCheckItem;
    public String idSolicitud;
    public String idSubtipoSol;

    public SolicitudCheckedItemPk() {
    }

    public SolicitudCheckedItemPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SolicitudCheckedItemPk)) return false;

        final SolicitudCheckedItemPk id = (SolicitudCheckedItemPk) o;
