...
public class DocPagoTarjetaCredito extends DocumentoPago implements TransferObject {
     ...
     */
    public DocPagoTarjetaCredito() {
    }

    public DocPagoTarjetaCredito(BancoFranquicia bancoFranquicia, String numeroTarjeta, String fecha, String numAprobacion) {
        this.tipoPago = DocumentoPago.PAGO_TARJETA_CREDITO;
        this.bancoFranquicia = bancoFranquicia;
        this.numeroTarjeta = numeroTarjeta;
        this.fecha = fecha;
        this.numeroAprobacion = numAprobacion;
    }
    public DocPagoTarjetaCredito(BancoFranquicia bancoFranquicia, String numeroTarjeta, String numAprobacion) {
        this.tipoPago = DocumentoPago.PAGO_TARJETA_CREDITO;
        this.bancoFranquicia = bancoFranquicia;
        this.numeroTarjeta = numeroTarjeta;
    ...
    public boolean equals(Object obj) {
        ...
        final DocPagoTarjetaCredito other = (DocPagoTarjetaCredito) obj;
