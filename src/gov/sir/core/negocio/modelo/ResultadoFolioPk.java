...
/** Clase que define los atributos que identifican a ResultadoFolio	  */

public class ResultadoFolioPk implements java.io.Serializable {

    public String idBusqueda;
    public String idMatricula;
    public String idSolicitud;

    public ResultadoFolioPk() {
    }

    public ResultadoFolioPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResultadoFolioPk)) return false;

        final ResultadoFolioPk id = (ResultadoFolioPk) o;
