...
public class SolicitudChecedItemPk implements java.io.Serializable {

    public String idCheckItem;
    public String idSolicitud;
    public String idSubtipoSol;

    public SolicitudChecedItemPk() {
    }

    public SolicitudChecedItemPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SolicitudChecedItemPk)) return false;

        final SolicitudChecedItemPk id = (SolicitudChecedItemPk) o;
