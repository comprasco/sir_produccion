 ...
 *
 */
public class LiquidacionTurnoConsultaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoConsultaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoConsulta transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoConsulta();
		cache.put(enhancedObject, transferObject );
		
		  // AlcanceGeografico
  	  gov.sir.core.negocio.modelo.jdogenie.AlcanceGeograficoEnhanced alcanceGeograficoEnh = null;
	  try {
	  	alcanceGeograficoEnh = enhancedObject.getAlcanceGeografico();
	  	} catch (Throwable th) {}
	  	if (alcanceGeograficoEnh != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.AlcanceGeografico objTo =  (gov.sir.core.negocio.modelo.AlcanceGeografico)cache.get(alcanceGeograficoEnh);
	  		if (objTo == null)
	  		{
	  			objTo = (gov.sir.core.negocio.modelo.AlcanceGeografico)AlcanceGeograficoTransferCopier.deepCopy(alcanceGeograficoEnh, cache);
	  		}
	  		transferObject.setAlcanceGeografico(objTo);
	  		}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoConsulta transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoConsultaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoConsultaEnhanced();
		cache.put(transferObject, enhancedObject);
		  // AlcanceGeografico
  	    gov.sir.core.negocio.modelo.AlcanceGeografico alcanceGeografico = null;
	  	try {
	  	alcanceGeografico = (gov.sir.core.negocio.modelo.AlcanceGeografico)transferObject.getAlcanceGeografico();
	  	} catch (Throwable th ) {}
	  	if (alcanceGeografico != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.jdogenie.AlcanceGeograficoEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.AlcanceGeograficoEnhanced)cache.get(alcanceGeografico);
	  		if (objEn == null)
	  		{
	  			objEn = (gov.sir.core.negocio.modelo.jdogenie.AlcanceGeograficoEnhanced)AlcanceGeograficoTransferCopier.deepCopy(alcanceGeografico, cache);
	  		}
	  		enhancedObject.setAlcanceGeografico(objEn);
	  		}
