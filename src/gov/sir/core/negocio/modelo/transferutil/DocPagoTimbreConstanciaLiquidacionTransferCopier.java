 ...
 *
 */
public class DocPagoTimbreConstanciaLiquidacionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoTimbreConstanciaLiquidacionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoTimbreConstanciaLiquidacion transferObject = new gov.sir.core.negocio.modelo.DocPagoTimbreConstanciaLiquidacion();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoTimbreConstanciaLiquidacion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoTimbreConstanciaLiquidacionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoTimbreConstanciaLiquidacionEnhanced();
