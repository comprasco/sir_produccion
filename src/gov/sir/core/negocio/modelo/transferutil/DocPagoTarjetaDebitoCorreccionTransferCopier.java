...
public class DocPagoTarjetaDebitoCorreccionTransferCopier {
    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaDebitoCorreccionEnhanced enhancedObject, java.util.HashMap cache){
        gov.sir.core.negocio.modelo.DocPagoTarjetaDebitoCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoTarjetaDebitoCorreccion();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoTarjetaDebitoCorreccion transferObject, java.util.HashMap cache){
        gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaDebitoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaDebitoCorreccionEnhanced();
