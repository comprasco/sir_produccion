 ...
 *
 */
public class SolicitudPermisoCorreccionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudPermisoCorreccionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudPermisoCorreccion transferObject = new gov.sir.core.negocio.modelo.SolicitudPermisoCorreccion();
	  ...
	  try {
		  ...
		  // Permiso
  	  gov.sir.core.negocio.modelo.jdogenie.PermisoCorreccionEnhanced permisoEnh = null;
	  try {
	  	permisoEnh = enhancedObject.getPermiso();
	  	} catch (Throwable th) {}
	  	if (permisoEnh != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.PermisoCorreccion objTo =  (gov.sir.core.negocio.modelo.PermisoCorreccion)cache.get(permisoEnh);
	  		if (objTo == null)
	  		{
	  			objTo = (gov.sir.core.negocio.modelo.PermisoCorreccion)PermisoCorreccionTransferCopier.deepCopy(permisoEnh, cache);
	  		}
	  		transferObject.setPermiso(objTo);
	  		}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudPermisoCorreccion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudPermisoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudPermisoCorreccionEnhanced();
		...
		if (transferObject.getFechaCreacion() != null)
		{
		  ...
		  // Permiso
  	    gov.sir.core.negocio.modelo.PermisoCorreccion permiso = null;
	  	try {
	  	permiso = (gov.sir.core.negocio.modelo.PermisoCorreccion)transferObject.getPermiso();
	  	} catch (Throwable th ) {}
	  	if (permiso != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.jdogenie.PermisoCorreccionEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.PermisoCorreccionEnhanced)cache.get(permiso);
	  		if (objEn == null)
	  		{
	  			objEn = (gov.sir.core.negocio.modelo.jdogenie.PermisoCorreccionEnhanced)PermisoCorreccionTransferCopier.deepCopy(permiso, cache);
	  		}
	  		enhancedObject.setPermiso(objEn);
	  		}
