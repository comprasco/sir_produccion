 ...
 *
 */
public class SolicitudAntiguoSistemaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudAntiguoSistemaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudAntiguoSistema transferObject = new gov.sir.core.negocio.modelo.SolicitudAntiguoSistema();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudAntiguoSistema transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudAntiguoSistemaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudAntiguoSistemaEnhanced();
