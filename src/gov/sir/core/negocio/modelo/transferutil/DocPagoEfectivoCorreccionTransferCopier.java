 ...
 *
 */
public class DocPagoEfectivoCorreccionTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoCorreccionEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoEfectivoCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoEfectivoCorreccion();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoEfectivoCorreccion transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoCorreccionEnhanced();
