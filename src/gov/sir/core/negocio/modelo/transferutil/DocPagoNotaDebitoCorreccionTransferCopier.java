...
/**
 *
 * @author OSBERT LINERO - Iridium Telecominicaciones e Informática.
 */
public class DocPagoNotaDebitoCorreccionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoCorreccionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoNotaDebitoCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoNotaDebitoCorreccion();
		cache.put(enhancedObject, transferObject );
		  ...
		  // NoNotaDebito
  	    try {
	  	transferObject.setNoNotaDebito(enhancedObject.getNoNotaDebito());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoNotaDebitoCorreccion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoCorreccionEnhanced();
		cache.put(transferObject, enhancedObject);
		  ...
		  // NoNotaDebito
  	    try {
	  	enhancedObject.setNoNotaDebito(transferObject.getNoNotaDebito());
	  	} catch (Throwable th ) {}
