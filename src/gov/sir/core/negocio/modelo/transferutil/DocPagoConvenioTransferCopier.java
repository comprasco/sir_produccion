 ...
 *
 */
public class DocPagoConvenioTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoConvenioEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoConvenio transferObject = new gov.sir.core.negocio.modelo.DocPagoConvenio();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoConvenio transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoConvenioEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoConvenioEnhanced();
