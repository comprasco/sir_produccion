 ...
 *
 */
public class FaseAlertaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.FaseAlertaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.FaseAlerta transferObject = new gov.sir.core.negocio.modelo.FaseAlerta();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.FaseAlerta transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.FaseAlertaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.FaseAlertaEnhanced();
