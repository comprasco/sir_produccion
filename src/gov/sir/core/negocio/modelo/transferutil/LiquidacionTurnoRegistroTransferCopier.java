 ...
 *
 */
public class LiquidacionTurnoRegistroTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoRegistroEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoRegistro transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoRegistro();
		cache.put(enhancedObject, transferObject );
		  ...
		  // JustificacionMayorValor
  	    try {
	  	transferObject.setJustificacionMayorValor(enhancedObject.getJustificacionMayorValor());
	  	} catch (Throwable th ) {}
            
              // numMatAgr
  	    try {
	  	transferObject.setNumMatAgr(enhancedObject.getNumMatAgr());
	  	} catch (Throwable th ) {}
  	...
  	try
  	{
  	acto = enhancedObject.getActos();
  	} catch (Throwable th) {}
	  	if (acto != null)
	  	{
		  	for(Iterator itera = acto.iterator();
		  			itera.hasNext();)
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.jdogenie.ActoEnhanced actoEnh = (gov.sir.core.negocio.modelo.jdogenie.ActoEnhanced)itera.next();
		  				  				  		if (!assigned)
		  		{
		  		gov.sir.core.negocio.modelo.Acto objTo = (gov.sir.core.negocio.modelo.Acto)cache.get(actoEnh);
		  		if (objTo == null)
		  		{
		  		objTo = (gov.sir.core.negocio.modelo.Acto)ActoTransferCopier.deepCopy(actoEnh, cache);
		  		}
		  		transferObject.addActo(objTo);
		  		}
		  				  	}
		}
		  ...
		  // LastIdActo
  	    try {
	  	transferObject.setLastIdActo(enhancedObject.getLastIdActo());
	  	} catch (Throwable th ) {}
	  			
		  // ValorDerechos
  	    try {
	  	transferObject.setValorDerechos(enhancedObject.getValorDerechos());
	  	} catch (Throwable th ) {}
            
            // ValorConservacion
  	    try {
	  	transferObject.setValorConservacionDoc(enhancedObject.getValorConservacionDoc()); 
	  	} catch (Throwable th ) {}
	  			
		  // OtroImpuesto
  	    try {
	  	transferObject.setOtroImpuesto(enhancedObject.getOtroImpuesto());
	  	} catch (Throwable th ) {}
	  			
		  // ValorOtroImp
  	    try {
	  	transferObject.setValorOtroImp(enhancedObject.getValorOtroImp());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoRegistro transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoRegistroEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoRegistroEnhanced();
		cache.put(transferObject, enhancedObject);
		  ...
		  // JustificacionMayorValor
  	    try {
	  	enhancedObject.setJustificacionMayorValor(transferObject.getJustificacionMayorValor());
	  	} catch (Throwable th ) {}
  	...
  	acto = transferObject.getActos();
	  	...
	  	if (acto != null)
	  	{
		  	...
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.Acto actoto = (gov.sir.core.negocio.modelo.Acto)itera.next();
		  				  				  		if (!assigned)
		  		{
		  				  		gov.sir.core.negocio.modelo.jdogenie.ActoEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.ActoEnhanced)cache.get(actoto);
		  		if (objEn == null)
		  		{
		  			objEn = (gov.sir.core.negocio.modelo.jdogenie.ActoEnhanced)ActoTransferCopier.deepCopy(actoto, cache);
		  		}
		  		enhancedObject.addActo(objEn);
		  				  		}
		  				  	}
		}
		  ...
		  // LastIdActo
  	    try {
	  	enhancedObject.setLastIdActo(transferObject.getLastIdActo());
	  	} catch (Throwable th ) {}
	  			
		  // ValorDerechos
  	    try {
	  	enhancedObject.setValorDerechos(transferObject.getValorDerechos());
	  	} catch (Throwable th ) {}
            
            // ValorConservacion
  	    try {
	  	enhancedObject.setValorConservacionDoc(transferObject.getValorConservacionDoc());
	  	} catch (Throwable th ) {}
	  			
		  // OtroImpuesto
  	    try {
	  	enhancedObject.setOtroImpuesto(transferObject.getOtroImpuesto());
	  	} catch (Throwable th ) {}
	  			
		  // ValorOtroImp
  	    try {
	  	enhancedObject.setValorOtroImp(transferObject.getValorOtroImp());
	  	} catch (Throwable th ) {}
	  	...
	  	enhancedObject.setCirculo(transferObject.getCirculo());
              ...
              // NumMatAgr
  	    try {
	  	enhancedObject.setNumMatAgr(transferObject.getNumMatAgr());
	  	} catch (Throwable th ) {}
