 ...
 *
 */
public class DocPagoChequeGerenciaCorreccionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaCorreccionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoChequeGerenciaCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoChequeGerenciaCorreccion();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoChequeGerenciaCorreccion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaCorreccionEnhanced();
