...
public class DocPagoElectronicoPSECorreccionTransferCopier {
    public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoElectronicoPSECorreccionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoElectronicoPSECorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoElectronicoPSECorreccion();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoElectronicoPSECorreccion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoElectronicoPSECorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoElectronicoPSECorreccionEnhanced();
