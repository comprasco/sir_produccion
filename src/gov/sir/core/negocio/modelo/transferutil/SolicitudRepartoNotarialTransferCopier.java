 ...
 *
 */
public class SolicitudRepartoNotarialTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudRepartoNotarialEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudRepartoNotarial transferObject = new gov.sir.core.negocio.modelo.SolicitudRepartoNotarial();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudRepartoNotarial transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudRepartoNotarialEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudRepartoNotarialEnhanced();
