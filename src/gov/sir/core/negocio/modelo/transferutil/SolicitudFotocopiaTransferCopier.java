 ...
 *
 */
public class SolicitudFotocopiaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudFotocopiaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudFotocopia transferObject = new gov.sir.core.negocio.modelo.SolicitudFotocopia();
	  ...
	  try {
		  ...
		  // DocumentoFotocopia
    	List documentoFotocopia = null;
  	try
  	{
  	documentoFotocopia = enhancedObject.getDocumentoFotocopia();
  	} catch (Throwable th) {}
	  	if (documentoFotocopia != null)
	  	{
		  	for(Iterator itera = documentoFotocopia.iterator();
		  			itera.hasNext();)
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.jdogenie.DocumentoFotocopiaEnhanced documentoFotocopiaEnh = (gov.sir.core.negocio.modelo.jdogenie.DocumentoFotocopiaEnhanced)itera.next();
		  				  				  		if (!assigned)
		  		{
		  		gov.sir.core.negocio.modelo.DocumentoFotocopia objTo = (gov.sir.core.negocio.modelo.DocumentoFotocopia)cache.get(documentoFotocopiaEnh);
		  		if (objTo == null)
		  		{
		  		objTo = (gov.sir.core.negocio.modelo.DocumentoFotocopia)DocumentoFotocopiaTransferCopier.deepCopy(documentoFotocopiaEnh, cache);
		  		}
		  		transferObject.addDocumentoFotocopia(objTo);
		  		}
		  				  	}
		}
				
		  // LastIdDocumentoFotocopia
  	    try {
	  	transferObject.setLastIdDocumentoFotocopia(enhancedObject.getLastIdDocumentoFotocopia());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudFotocopia transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudFotocopiaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudFotocopiaEnhanced();
  	...
  	try
  	{
  	documentoFotocopia = transferObject.getDocumentoFotocopia();
  	} catch (Throwable th) { }
	  	if (documentoFotocopia != null)
	  	{
		  	for(Iterator itera = documentoFotocopia.iterator();
		  	...
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.DocumentoFotocopia documentoFotocopiato = (gov.sir.core.negocio.modelo.DocumentoFotocopia)itera.next();
		  				  				  		if (!assigned)
		  		{
		  				  		gov.sir.core.negocio.modelo.jdogenie.DocumentoFotocopiaEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.DocumentoFotocopiaEnhanced)cache.get(documentoFotocopiato);
		  		if (objEn == null)
		  		{
		  			objEn = (gov.sir.core.negocio.modelo.jdogenie.DocumentoFotocopiaEnhanced)DocumentoFotocopiaTransferCopier.deepCopy(documentoFotocopiato, cache);
		  		}
		  		enhancedObject.addDocumentoFotocopia(objEn);
		  				  		}
		  				  	}
		}
		  ...
		  // LastIdDocumentoFotocopia
  	    try {
	  	enhancedObject.setLastIdDocumentoFotocopia(transferObject.getLastIdDocumentoFotocopia());
	  	} catch (Throwable th ) {}
