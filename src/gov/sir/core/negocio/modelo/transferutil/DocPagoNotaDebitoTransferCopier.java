 ...
 */
public class DocPagoNotaDebitoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoNotaDebito transferObject = new gov.sir.core.negocio.modelo.DocPagoNotaDebito();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoNotaDebito transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoNotaDebitoEnhanced();
