 ...
 *
 */
public class LiquidacionTurnoCertificadoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoCertificado transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoCertificado();
	  ...
	  try {
		  ...
		  // TipoTarifa
  	    try {
	  	transferObject.setTipoTarifa(enhancedObject.getTipoTarifa());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoCertificado transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoEnhanced();
		cache.put(transferObject, enhancedObject);
		  ...
		  // TipoTarifa
  	    try {
	  	enhancedObject.setTipoTarifa(transferObject.getTipoTarifa());
	  	} catch (Throwable th ) {}
