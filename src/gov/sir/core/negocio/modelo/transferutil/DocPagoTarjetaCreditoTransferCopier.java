...
public class DocPagoTarjetaCreditoTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(
            gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaCreditoEnhanced enhancedObject,
            java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoTarjetaCredito transferObject = new gov.sir.core.negocio.modelo.DocPagoTarjetaCredito();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoTarjetaCredito transferObject,
            java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaCreditoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoTarjetaCreditoEnhanced();
