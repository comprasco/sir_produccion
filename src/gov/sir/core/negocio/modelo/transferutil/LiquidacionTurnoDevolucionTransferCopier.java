 ...
 *
 */
public class LiquidacionTurnoDevolucionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoDevolucionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoDevolucion transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoDevolucion();
		cache.put(enhancedObject, transferObject );
	  	...
	  	transferObject.setValorDerechos(enhancedObject.getValorDerechos());
            ...
            //valorConservacionDoc            
            try {
	  	transferObject.setValorConservacionDoc(enhancedObject.getValorConservacionDoc());
	  	} catch (Throwable th ) {}
            
            // ValorImpuestosMayorValor            
  	    try {
	  	transferObject.setValorImpuestosMayorValor(enhancedObject.getValorImpuestosMayorValor());
	  	} catch (Throwable th ) {}
	  	
	  		// ValorDerechosMayorValor
	  	try {
	  	transferObject.setValorDerechosMayorValor(enhancedObject.getValorDerechosMayorValor());
	  	} catch (Throwable th ) {}
	  	
	  		// ValorMayorValor
  	    try {
	  	transferObject.setValorMayorValor(enhancedObject.getValorMayorValor());
	  	} catch (Throwable th ) {}
	  	
	 // ValorSaldoFavor
  	    try {
	  	transferObject.setValorSaldoFavor(enhancedObject.getValorSaldoFavor());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoDevolucion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoDevolucionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoDevolucionEnhanced();
	 ...
	 // ValorImpuestosMayorValor
  	    try {
	  	enhancedObject.setValorImpuestosMayorValor(transferObject.getValorImpuestosMayorValor());
	  	} catch (Throwable th ) {}
	  	
	 // ValorDerechosMayorValor
  	    try {
	  	enhancedObject.setValorDerechosMayorValor(transferObject.getValorDerechosMayorValor());
	  	} catch (Throwable th ) {}
	  	
	 // ValorMayorValor
  	    try {
	  	enhancedObject.setValorMayorValor(transferObject.getValorMayorValor());
	  	} catch (Throwable th ) {}
	  	
	 // ValorSaldoFavor
  	    try {
	  	enhancedObject.setValorSaldoFavor(transferObject.getValorSaldoFavor());
	  	} catch (Throwable th ) {}
