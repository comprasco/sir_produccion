 ...
 *
 */
public class DocPagoHeredadoTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoHeredado transferObject = new gov.sir.core.negocio.modelo.DocPagoHeredado();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoHeredado transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoEnhanced();
