 ...
 *
 */
public class SolicitudConsultaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudConsultaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudConsulta transferObject = new gov.sir.core.negocio.modelo.SolicitudConsulta();
  	...
  	try
  	{
  	busqueda = enhancedObject.getBusquedas();
  	} catch (Throwable th) {}
	  	if (busqueda != null)
	  	{
		  	for(Iterator itera = busqueda.iterator();
		  			itera.hasNext();)
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.jdogenie.BusquedaEnhanced busquedaEnh = (gov.sir.core.negocio.modelo.jdogenie.BusquedaEnhanced)itera.next();
		  				  				  		if (!assigned)
		  		{
		  		...
		  		transferObject.addBusqueda(objTo);
		  		}
		  				  	}
		}
				
		  // TipoConsulta
  	  gov.sir.core.negocio.modelo.jdogenie.TipoConsultaEnhanced tipoConsultaEnh = null;
	  try {
	  	tipoConsultaEnh = enhancedObject.getTipoConsulta();
	  	} catch (Throwable th) {}
	  	if (tipoConsultaEnh != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.TipoConsulta objTo =  (gov.sir.core.negocio.modelo.TipoConsulta)cache.get(tipoConsultaEnh);
	  		if (objTo == null)
	  		{
	  			objTo = (gov.sir.core.negocio.modelo.TipoConsulta)TipoConsultaTransferCopier.deepCopy(tipoConsultaEnh, cache);
	  		}
	  		transferObject.setTipoConsulta(objTo);
	  		}
		  ...
		  // LastIdBusqueda
  	    try {
	  	transferObject.setLastIdBusqueda(enhancedObject.getLastIdBusqueda());
	  	} catch (Throwable th ) {}
	  			
		  // NumeroMaximoBusquedas
  	    try {
	  	transferObject.setNumeroMaximoBusquedas(enhancedObject.getNumeroMaximoBusquedas());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudConsulta transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudConsultaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudConsultaEnhanced();
  	...
  	try
  	{
  	busqueda = transferObject.getBusquedas();
  	} catch (Throwable th) { }
	  	if (busqueda != null)
	  	{
		  	for(Iterator itera = busqueda.iterator();
		  	...
		  	{
		  		boolean assigned = false;
		  		gov.sir.core.negocio.modelo.Busqueda busquedato = (gov.sir.core.negocio.modelo.Busqueda)itera.next();
		  				  				  		if (!assigned)
		  		{
		  				  		gov.sir.core.negocio.modelo.jdogenie.BusquedaEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.BusquedaEnhanced)cache.get(busquedato);
		  		if (objEn == null)
		  		{
		  			objEn = (gov.sir.core.negocio.modelo.jdogenie.BusquedaEnhanced)BusquedaTransferCopier.deepCopy(busquedato, cache);
		  		}
		  		enhancedObject.addBusqueda(objEn);
		  				  		}
		  				  	}
		}
				
		  // TipoConsulta
  	    gov.sir.core.negocio.modelo.TipoConsulta tipoConsulta = null;
	  	try {
	  	tipoConsulta = (gov.sir.core.negocio.modelo.TipoConsulta)transferObject.getTipoConsulta();
	  	} catch (Throwable th ) {}
	  	if (tipoConsulta != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.jdogenie.TipoConsultaEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.TipoConsultaEnhanced)cache.get(tipoConsulta);
	  		if (objEn == null)
	  		{
	  			objEn = (gov.sir.core.negocio.modelo.jdogenie.TipoConsultaEnhanced)TipoConsultaTransferCopier.deepCopy(tipoConsulta, cache);
	  		}
	  		enhancedObject.setTipoConsulta(objEn);
	  		}
		  ...
		  // LastIdBusqueda
  	    try {
	  	enhancedObject.setLastIdBusqueda(transferObject.getLastIdBusqueda());
	  	} catch (Throwable th ) {}
	  			
		  // NumeroMaximoBusquedas
  	    try {
	  	enhancedObject.setNumeroMaximoBusquedas(transferObject.getNumeroMaximoBusquedas());
	  	} catch (Throwable th ) {}
