 ...
 *
 */
public class SolicitudAsociadaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudAsociadaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudAsociada transferObject = new gov.sir.core.negocio.modelo.SolicitudAsociada();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudAsociada transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudAsociadaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudAsociadaEnhanced();
