 ...
 */
public class TarifaRegistralTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.TarifaRegistralEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.TarifaRegistral transferObject = new gov.sir.core.negocio.modelo.TarifaRegistral();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.TarifaRegistral transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.TarifaRegistralEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.TarifaRegistralEnhanced();
