 ...
 *
 */
public class DocPagoEfectivoTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoEfectivo transferObject = new gov.sir.core.negocio.modelo.DocPagoEfectivo();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoEfectivo transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoEfectivoEnhanced();
