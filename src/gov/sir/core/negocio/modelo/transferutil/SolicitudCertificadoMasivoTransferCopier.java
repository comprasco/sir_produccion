 ...
 *
 */
public class SolicitudCertificadoMasivoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudCertificadoMasivoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudCertificadoMasivo transferObject = new gov.sir.core.negocio.modelo.SolicitudCertificadoMasivo();
  	  ...
  	  gov.sir.core.negocio.modelo.jdogenie.CiudadanoEnhanced ciudadanoEnh = null;
           ...
           * @change      :   TransferObject al documento
           * Caso Mantis  :   000941
           */
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudCertificadoMasivo transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudCertificadoMasivoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudCertificadoMasivoEnhanced();
