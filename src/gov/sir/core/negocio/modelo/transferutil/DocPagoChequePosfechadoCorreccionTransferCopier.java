 ...
 *
 */
public class DocPagoChequePosfechadoCorreccionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoCorreccionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoChequePosfechadoCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoChequePosfechadoCorreccion();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoChequePosfechadoCorreccion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoCorreccionEnhanced();
