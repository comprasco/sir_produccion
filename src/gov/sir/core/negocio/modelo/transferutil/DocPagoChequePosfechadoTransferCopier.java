 ...
 *
 */
public class DocPagoChequePosfechadoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoChequePosfechado transferObject = new gov.sir.core.negocio.modelo.DocPagoChequePosfechado();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoChequePosfechado transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoChequePosfechadoEnhanced();
