 ...
 *
 */
public class SolicitudRestitucionRepartoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudRestitucionRepartoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.SolicitudRestitucionReparto transferObject = new gov.sir.core.negocio.modelo.SolicitudRestitucionReparto();
		cache.put(enhancedObject, transferObject );
		
		  // CausalRestitucion
  	  gov.sir.core.negocio.modelo.jdogenie.CausalRestitucionEnhanced causalRestitucionEnh = null;
	  try {
	  	causalRestitucionEnh = enhancedObject.getCausalRestitucion();
	  	} catch (Throwable th) {}
	  	if (causalRestitucionEnh != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.CausalRestitucion objTo =  (gov.sir.core.negocio.modelo.CausalRestitucion)cache.get(causalRestitucionEnh);
	  		if (objTo == null)
	  		{
	  			objTo = (gov.sir.core.negocio.modelo.CausalRestitucion)CausalRestitucionTransferCopier.deepCopy(causalRestitucionEnh, cache);
	  		}
	  		transferObject.setCausalRestitucion(objTo);
	  		}
		  ...
		  // Aceptacion
    try {
  	transferObject.setAceptacion(enhancedObject.getAceptacion());
  } catch (Throwable th ) {}
		  ...
		  // FechaResolucion
  		try {
		if (enhancedObject.getFechaResolucion() != null)
		{
	  	 transferObject.setFechaResolucion(new Date(enhancedObject.getFechaResolucion().getTime()));
	  	}
	  	} catch (Throwable th ) {}
	  			
		  // Observaciones
  	    try {
	  	transferObject.setObservaciones(enhancedObject.getObservaciones());
	  	} catch (Throwable th ) {}
	  			
		  // ObservacionesRestitucion
  	    try {
	  	transferObject.setObservacionesRestitucion(enhancedObject.getObservacionesRestitucion());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.SolicitudRestitucionReparto transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudRestitucionRepartoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudRestitucionRepartoEnhanced();
		cache.put(transferObject, enhancedObject);
		  // CausalRestitucion
  	    gov.sir.core.negocio.modelo.CausalRestitucion causalRestitucion = null;
	  	try {
	  	causalRestitucion = (gov.sir.core.negocio.modelo.CausalRestitucion)transferObject.getCausalRestitucion();
	  	} catch (Throwable th ) {}
	  	if (causalRestitucion != null)
	  	{
	  		boolean assigned = false;
	  			  			  		if (!assigned)
	  		{
	  		gov.sir.core.negocio.modelo.jdogenie.CausalRestitucionEnhanced objEn = (gov.sir.core.negocio.modelo.jdogenie.CausalRestitucionEnhanced)cache.get(causalRestitucion);
	  		if (objEn == null)
	  		{
	  			objEn = (gov.sir.core.negocio.modelo.jdogenie.CausalRestitucionEnhanced)CausalRestitucionTransferCopier.deepCopy(causalRestitucion, cache);
	  		}
	  		enhancedObject.setCausalRestitucion(objEn);
	  		}
		  ...
		  // Aceptacion
      try {
  	enhancedObject.setAceptacion(transferObject.getAceptacion());
  	} catch (Throwable th ) {}
		  ...
		  // FechaResolucion
  	    try {
		if (transferObject.getFechaResolucion() != null)
		{
		  	enhancedObject.setFechaResolucion(new Date(transferObject.getFechaResolucion().getTime()));
		}
		} catch (Throwable th ) {}
	  			
		  // Observaciones
  	    try {
	  	enhancedObject.setObservaciones(transferObject.getObservaciones());
	  	} catch (Throwable th ) {}
	  			
		  // ObservacionesRestitucion
  	    try {
	  	enhancedObject.setObservacionesRestitucion(transferObject.getObservacionesRestitucion());
	  	} catch (Throwable th ) {}
