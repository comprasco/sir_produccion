 ...
 *
 */
public class NotaActuacionTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.NotaActuacionEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.NotaActuacion transferObject = new gov.sir.core.negocio.modelo.NotaActuacion();
	  ...
	  try {
		  ...
		  // IdNotaActuacion
  	    try {
	  	transferObject.setIdNotaActuacion(enhancedObject.getIdNotaActuacion());
	  	} catch (Throwable th ) {}
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.NotaActuacion transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.NotaActuacionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.NotaActuacionEnhanced();
		...
		if (transferObject.getFechaCreacion() != null)
		{
		  ...
		  // IdNotaActuacion
  	    try {
	  	enhancedObject.setIdNotaActuacion(transferObject.getIdNotaActuacion());
	  	} catch (Throwable th ) {}
