 ...
 *
 */
public class DocPagoGeneralCorreccionTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoGeneralCorreccionEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoGeneralCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoGeneralCorreccion();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoGeneralCorreccion transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoGeneralCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoGeneralCorreccionEnhanced();
