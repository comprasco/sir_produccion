 ...
 *
 */
public class DocPagoChequeGerenciaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.DocPagoChequeGerencia transferObject = new gov.sir.core.negocio.modelo.DocPagoChequeGerencia();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.DocPagoChequeGerencia transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoChequeGerenciaEnhanced();
