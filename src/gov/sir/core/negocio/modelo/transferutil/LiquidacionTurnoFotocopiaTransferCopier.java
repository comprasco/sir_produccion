 ...
 *
 */
public class LiquidacionTurnoFotocopiaTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoFotocopiaEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoFotocopia transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoFotocopia();
		cache.put(enhancedObject, transferObject );
		
            /** @author : HGOMEZ
            *** @change : Se habilita la persistencia de la tarifa con valor igual
            *** a cero cuando la fotocopia sea igual a exenta.
            *** Caso Mantis : 12288
            */
            try {
                    transferObject.setTarifa(enhancedObject.getTarifa());
	  	} catch (Throwable th ) {
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoFotocopia transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoFotocopiaEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoFotocopiaEnhanced();
		cache.put(transferObject, enhancedObject);
            ...
            */    
            try {
	  	enhancedObject.setTarifa(transferObject.getTarifa());
	  	} catch (Throwable th ) {
                    System.out.println("ERROR: " + th.getMessage());
                }
