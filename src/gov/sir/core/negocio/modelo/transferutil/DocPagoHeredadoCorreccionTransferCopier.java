 ...
 *
 */
public class DocPagoHeredadoCorreccionTransferCopier {

    public static org.auriga.core.modelo.TransferObject deepCopy(gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoCorreccionEnhanced enhancedObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.DocPagoHeredadoCorreccion transferObject = new gov.sir.core.negocio.modelo.DocPagoHeredadoCorreccion();
    ...
    public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy(gov.sir.core.negocio.modelo.DocPagoHeredadoCorreccion transferObject, java.util.HashMap cache) {
        gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoCorreccionEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.DocPagoHeredadoCorreccionEnhanced();
