 ...
 *
 */
public class LiquidacionTurnoCertificadoMasivoTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoMasivoEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.LiquidacionTurnoCertificadoMasivo transferObject = new gov.sir.core.negocio.modelo.LiquidacionTurnoCertificadoMasivo();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.LiquidacionTurnoCertificadoMasivo transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoMasivoEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.LiquidacionTurnoCertificadoMasivoEnhanced();
