 ...
 *
 */
public class SolicitudTransferCopier {

	public static org.auriga.core.modelo.TransferObject deepCopy( gov.sir.core.negocio.modelo.jdogenie.SolicitudEnhanced enhancedObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.Solicitud transferObject = new gov.sir.core.negocio.modelo.Solicitud();
	...
	public static gov.sir.core.negocio.modelo.jdogenie.Enhanced deepCopy( gov.sir.core.negocio.modelo.Solicitud transferObject, java.util.HashMap cache)
	{
		gov.sir.core.negocio.modelo.jdogenie.SolicitudEnhanced enhancedObject = new gov.sir.core.negocio.modelo.jdogenie.SolicitudEnhanced();
