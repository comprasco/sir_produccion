...
/** Clase que define los atributos que identifican a TurnoSalvedadFolio */

public class TurnoSalvedadFolioPk implements java.io.Serializable {
    ...
    public TurnoSalvedadFolioPk() {
    }

    public TurnoSalvedadFolioPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TurnoSalvedadFolioPk)) return false;

        final TurnoSalvedadFolioPk id = (TurnoSalvedadFolioPk) o;
