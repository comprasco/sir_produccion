...
/** Clase que define los atributos que identifican a TurnoAnotacion */

public class TurnoAnotacionPk implements java.io.Serializable {
    ...
    public TurnoAnotacionPk() {
    }

    public TurnoAnotacionPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TurnoAnotacionPk)) return false;

        final TurnoAnotacionPk id = (TurnoAnotacionPk) o;
