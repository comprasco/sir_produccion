 ...
 * @author eacosta
 */
public class DocPagoCheque extends DocumentoPago implements TransferObject {
    /**
     ...
     * @param valor
     */
    public DocPagoCheque(Banco banco, String codSucursalBanco, String noCuenta,
        String noCheque, double valor) {
        this.tipoPago = DocumentoPago.PAGO_CHEQUE;
        this.banco = banco;
...
/**
    ...
    public boolean equals(Object other) {
        if ((other == null) || !(other instanceof DocPagoCheque)) {
            return false;
        }

        DocPagoCheque p = (DocPagoCheque) other;
