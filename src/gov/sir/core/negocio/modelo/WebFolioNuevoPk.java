 ...
 */
public class WebFolioNuevoPk implements java.io.Serializable {

    public String idSolicitud;
    public String idWebSegeng;

    public WebFolioNuevoPk() {
    }

    public WebFolioNuevoPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioNuevoPk)) return false;

        final WebFolioNuevoPk id = (WebFolioNuevoPk) o;
