 ...
 * @author eacosta
 */
public class DocPagoConsignacion extends DocumentoPago implements TransferObject{
	 ...
	 * @param valor
	 */
	public DocPagoConsignacion(Banco banco, String codSucursal, String fecha, String noConsignacion, double valor) {
		this.tipoPago = DocumentoPago.PAGO_CONSIGNACION;
		this.banco = banco;
	...
	/**
	 * Constructor que especifica los atributos de un pago para su actualizacion de canal de recaudo realizado por medio de consignación bancaria.
	 * @param codBanco
	 * @param fecha
	 * @param noConsignacion
	 * @param valor
	 */
	public DocPagoConsignacion(Banco banco, String codSucursal, String noConsignacion) {
		this.tipoPago = DocumentoPago.PAGO_CONSIGNACION;
		this.banco = banco;
		this.codSucursal = codSucursal;
		this.noConsignacion = noConsignacion;
	...
	public boolean equals(Object other) {
		if (other==null || !(other instanceof DocPagoConsignacion)) return false;
		DocPagoConsignacion p = (DocPagoConsignacion) other;
