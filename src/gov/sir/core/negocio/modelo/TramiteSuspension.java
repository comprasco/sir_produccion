 ...
 * @author developer5
 */
public class TramiteSuspension implements TransferObject {
    ...
    private ArchivosJustifica tramsIdArchivoJustifica;
    ...
    public ArchivosJustifica getTramsIdArchivoJustifica() {
        return tramsIdArchivoJustifica;
    }

    public void setTramsIdArchivoJustifica(ArchivosJustifica tramsIdArchivoJustifica) {
