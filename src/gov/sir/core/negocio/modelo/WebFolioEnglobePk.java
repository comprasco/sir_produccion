 ...
 */
public class WebFolioEnglobePk implements java.io.Serializable {

    public String idMatricula;
    public String idSolicitud;
    public String idWebSegeng;

    public WebFolioEnglobePk() {
    }

    public WebFolioEnglobePk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioEnglobePk)) return false;

        final WebFolioEnglobePk id = (WebFolioEnglobePk) o;
