 ...
 */
public class DocPagoNotaDebito extends DocumentoPago implements TransferObject {
     ...
     * @param valor
     */
    public DocPagoNotaDebito(Banco banco, String codSucursalBanco, String noCuenta,
        String noNotaDebito, double valor) {
        this.tipoPago = DocumentoPago.PAGO_NOTA_DEBITO;
        this.banco = banco;
    ...
    public boolean equals(Object other) {
        if ((other == null) || !(other instanceof DocPagoNotaDebito)) {
            return false;
        }

        DocPagoNotaDebito p = (DocPagoNotaDebito) other;
