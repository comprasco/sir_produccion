 ...
 */
public class WebFolioDerivadoPk implements java.io.Serializable {

    public String idSolicitud;
    public String idWebFolioDerivado;
    public String idWebSegeng;

    public WebFolioDerivadoPk() {
    }

    public WebFolioDerivadoPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebFolioDerivadoPk)) return false;

        final WebFolioDerivadoPk id = (WebFolioDerivadoPk) o;
