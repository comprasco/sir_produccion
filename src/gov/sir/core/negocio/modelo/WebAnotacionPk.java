 ...
 */
public class WebAnotacionPk implements java.io.Serializable {

    public String idSolicitud;
    public String idWebSegeng;

    public WebAnotacionPk() {
    }

    public WebAnotacionPk(String s) {
        int i, p = 0;
        i= s.indexOf('-', p);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAnotacionPk)) return false;

        final WebAnotacionPk id = (WebAnotacionPk) o;
