 ...
 * @author desarrollo3
 */
public class LiquidacionConservacion implements TransferObject {
    ...
    /**
     * @param valorPorcentajeLiquidacionConserva the valorPorcentajeLiquidacionConserva to set
     */
    ...
    /**
     * @param tarifaPlenaLiquidacionConserva the tarifaPlenaLiquidacionConserva to set
     */
    ...
    /**
     * @param tarifaBaseLiquidacionConserva the tarifaBaseLiquidacionConserva to set
     */
    ...
    /**
     * @param valorTarifaLiquidacionConserva the valorTarifaLiquidacionConserva to set
     */
    ...
    /**
     * @param idSolicituLiquidacionConserva the idSolicituLiquidacionConserva to set
     */
