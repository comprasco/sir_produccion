 ...
 * @author ppabon
 */
public class ValidacionParametrosMesaControlException extends ValidacionParametrosException {

	/**
	 * Constructor de la clase. 
	 */
	public ValidacionParametrosMesaControlException() {
		super();
	}
	 ...
	 * @param listErrores
	 */
	public ValidacionParametrosMesaControlException(List listErrores) {
		super();
