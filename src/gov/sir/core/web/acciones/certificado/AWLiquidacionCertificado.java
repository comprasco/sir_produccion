 ...
 */
public class AWLiquidacionCertificado extends SoporteAccionWeb {
	...
	public final static String COPIAS = "COPIAS";
        ...
        /** Constante que identifica el cambio de acción a certificadoEspecial.do*/
        public final static String CERTIFICADO_ESPECIAL = "CERTIFICADO_ESPECIAL";
	 ...
	 */
	public AWLiquidacionCertificado() {
		super();
	}
	...
	private EvnValidacionMatricula adicionarMatricula(HttpServletRequest request) throws AccionWebException{
		...
		String tipoCertificado = isNacional ? CTipoCertificado.TIPO_INMEDIATO_ID : request.getParameter(AWLiquidacionCertificado.TIPO_CERTIFICADO);
	...
	private EvnCertificado adicionarTurno(HttpServletRequest request) throws AccionWebException {
		...
		String idWfTurno = request.getParameter(AWLiquidacionCertificado.TURNO_ANTERIOR);
	...
	public SolicitudCertificado getSolicitudCertificadoValidada(HttpServletRequest request, ValidacionParametrosException exception) {
		...
		if (!tipoTarifa.equals("EXENTO")) {
			try {
				...
				Log.getInstance().error(AWLiquidacionCertificado.class, e);
		...
		try {
			String cadCopias = request.getParameter(AWLiquidacionCertificado.COPIAS);
...
//		VALIDACIONES PARA EL TESTADOR (CIUDADANO)
	...
	* Datos del documento (Opcionales)
		...
		if (evento == null)
		{
			if (accion.equals(CAMBIAR_TIPO_OFICINA_ORIGEN))
			{
                ...
                try {
                    ...
                    Logger.getLogger(AWLiquidacionCertificado.class.getName()).log(Level.SEVERE, null, ex);
                }
	...
	public void removerInformacion(HttpServletRequest request) {
		...
		session.removeAttribute(AWLiquidacionCertificado.ID_CIUDADANO);
