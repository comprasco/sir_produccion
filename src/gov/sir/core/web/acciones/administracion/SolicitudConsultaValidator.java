...
public class SolicitudConsultaValidator implements java.io.Serializable {
	...
	*/
	public SolicitudConsultaValidator(String tipo, Circulo circulo,Usuario usuario, String Alcance) {
	...
	*/
	public Busqueda siguienteBusqueda(String Alcance) throws MaximoNumeroConsultasException {
...
/*			if (!esValidaOtraBusquedaCompleja()) {
		...
		if (Alcance.equals("LOCAL")) {
			busqueda.setIdCirculoBusqueda(solicitudConsulta.getCirculo().getIdCirculo());
		}
	...
	private String validarParametrosBusqueda(String cadena_anterior, String cadena_nueva)
		...
		if (cadena_anterior != null) {
			if (cadena_nueva != null) {
				...
				if (inicio_anterior.equals(inicio_nuevo)) {
					return cadena_nueva;
				} else {
