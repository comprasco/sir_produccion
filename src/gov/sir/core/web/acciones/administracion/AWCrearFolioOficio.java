 ...
 */
public class AWCrearFolioOficio extends SoporteAccionWeb {
    ...
    public static final String NUM_A_TEMPORAL = "NUM_A_TEMPORAL";
    ...
    public final static String PARAM_ITEM_FOLIO_IDMATRICULA = "PARAM_ITEM_FOLIO_IDMATRICULA";

    public final static String PARAM_ITEM_FOLIO_ANOTACIONID = "PARAM_ITEM_FOLIO_ANOTACIONID";

    public final static String PARAM_ITEM_THISFOLIO_ANOTACIONID = "PARAM_ITEM_THISFOLIO_ANOTACIONID";

    public final static String PARAM_ITEM_FOLIO_IDMATRICULA_ENGLOBE = "PARAM_ITEM_FOLIO_IDMATRICULA_ENGLOBE";

    public final static String PARAM_ITEM_FOLIO_ANOTACIONID_ENGLOBE = "PARAM_ITEM_FOLIO_ANOTACIONID_ENGLOBE";

    public final static String PARAM_ITEM_THISFOLIO_ANOTACIONID_ENGLOBE = "PARAM_ITEM_THISFOLIO_ANOTACIONID_ENGLOBE";
    ...
    public Evento perform(HttpServletRequest request) throws AccionWebException {
        ...
        } else if (accion.equals(GUARDAR_FOLIO)) {
            request.getSession().setAttribute(GUARDAR_FOLIO, GUARDAR_FOLIO);
    ...
    private Evento
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.VOLVER_EDICION);
    ...
    private Evento
        ...
        // build-message -----------------------------------------------------------------
        Evn_AdminCrearFolioSaveInfoOficio local_Result;
        local_Result = new Evn_AdminCrearFolioSaveInfoOficio(Evn_AdminCrearFolioSaveInfoOficio.ADMINCREARFOLIO_SAVEINFO_STEP2_BACK__EVENT);
...
// ---------------------------------------------------------------------------------------
    ...
    private Evento
        ...
        Evn_AdminCrearFolioSaveInfoOficio local_Result;
        local_Result = new Evn_AdminCrearFolioSaveInfoOficio(Evn_AdminCrearFolioSaveInfoOficio.ADMINCREARFOLIO_SAVEINFO_STEP0_FIND__EVENT);
    ...
    private Evento eliminarDireccion(HttpServletRequest request) {
        ...
        if (direcciones != null && aplicacionNumeroReal + 1 <= direcciones.size()) {
            if (direcciones.get(aplicacionNumeroReal) != null) {
                Direccion dirBorrar = (Direccion) direcciones.get(aplicacionNumeroReal);
                if (dirBorrar.getIdDireccion() != null) {
                    dirBorrar.setToDelete(true);
                } else {
                    direcciones.remove(aplicacionNumeroReal);
                }
            }
        }
...
//	ACCIONES PARA GUARDAR EN LA SESIÓN LAS SALVEDADES DEL FOLIO
    ...
    private Evento crearFolio(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.VALIDAR_MATRICULA_CREACION_FOLIO);
    ...
    private static Object copy(Object orig) {
        ...
        try {
            ...
            Log.getInstance().debug(AWCrearFolioOficio.class, e);
        } catch (ClassNotFoundException cnfe) {
            Log.getInstance().debug(AWCrearFolioOficio.class, cnfe);
        }
    ...
    private Evento agregarVariosCiudadanos(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evento = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.AGREGAR_CIUDADANO_ANOTACION);
     ...
     *
     * @param List ciudadanosOrganizados, exception
     */
    ...
    private Evento agregarAnotacion(HttpServletRequest request) throws AccionWebException {
        ...
        while (ig.hasNext()) {
             ...
             * @actaReq : Acta - Requerimiento No
             * 056_453_Modificiación_de_Naturaleza_Jurídica
             * @change : Se agrega condicion al while para
             */
            while (id.hasNext() && !esta) {
                ...
                if (nat.getIdNaturalezaJuridica().equals(idNaturaleza)) {
                     ...
                     * @actaReq : Acta - Requerimiento No
                     * 056_453_Modificiación_de_Naturaleza_Jurídica
                     * @change : Se agrega condicion al while para que termine
                     * en cuanto se encuentre una coincidencia
                     */
                    natJuridica = nat;
                    esta = true;
                }
        ...
        if (flagCapturarFechaRadiacion == 1) {
            try {
                ...
                Log.getInstance().debug(AWCrearFolioOficio.class, "Error en la captura de la fecha de Radicación");
            }
        }
        ...
        if (buffer.length() > 0) {
            ...
            if(buffer.length() > 0) {
	            ...
	            if (request.getParameter(CDatosAntiguoSistema.DOCUMENTO_FECHA_AS).length() > 0) {
	                ...
	                try {
	                    Date fechaDoc = dateFormat.parse(request.getParameter(CDatosAntiguoSistema.DOCUMENTO_FECHA_AS ));
        ...
        /*anotacionesModifiable.add(anotacion);
		request.getSession().setAttribute(WebKeys.LISTA_ANOTACIONES_FOLIO, anotacionesModifiable);*/
        String vista = (String) request.getSession().getAttribute("ULITIMA_VISTA_TEMPORAL");
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.AGREGAR_ANOTACION);
...
//		 Verificar si se han digitado datos de antiguo sistema. De existir al menos un
        ...
        Log.getInstance().debug(AWCrearFolioOficio.class, "\n\n"
        ...
        if (a.getNaturalezaJuridica() != null) {
            Log.getInstance().debug(AWCrearFolioOficio.class, "idNaturaleza =" + a.getNaturalezaJuridica().getIdNaturalezaJuridica() + "\n"
                    + "nombreNaturaleza =" + a.getNaturalezaJuridica().getNombre());
        } else {
            Log.getInstance().debug(AWCrearFolioOficio.class, "idNaturaleza =" + "" + "\n"
                    + "nombreNaturaleza =" + "" + "\n");
        }
        Log.getInstance().debug(AWCrearFolioOficio.class, "valor =" + Double.toString(a.getValor()) + "\n"
        ...
        Log.getInstance().debug(AWCrearFolioOficio.class, "el # de ciudadanosB =" + ciudadanosB.size());
        Log.getInstance().debug(AWCrearFolioOficio.class, "el # de ciudadanosT =" + ciudadanosT.size());
        ...
        while (cont != finAB) {
            ...
            Log.getInstance().debug(AWCrearFolioOficio.class, "ciudadano cedula =" + ct.getCiudadano().getDocumento() + "toDelete = " + Boolean.toString(ct.isToDelete()));
        ...
        int SL = subList.size();
        Log.getInstance().debug(AWCrearFolioOficio.class, "el tamaño de la Sublista =" + SL);

        ciudadanosA.addAll(subList);
        Log.getInstance().debug(AWCrearFolioOficio.class, "el # de ciudadanos a editar y/o agregar es = " + ciudadanosA.size());
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuario, EvnCrearFolioOficio.GRABAR_ANOTACIONES_TEMPORALMENTE);
        evnCrearFolio.setFolio(folio);
        evnCrearFolio.setUsuario(usuarioAuriga);
    ...
    private Evento terminarFolio(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evento = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CREACION_FOLIO, folio, usuario);
    ...
    private boolean agregoPersona(HttpServletRequest request, int i) {
        ...
        if ((tipoID != null) && (tipoID.equals(CCiudadano.TIPO_DOC_ID_CEDULA) || tipoID.equals(CCiudadano.TIPO_DOC_ID_CEDULA_EXTRANJERIA) || tipoID.equals(CCiudadano.TIPO_DOC_ID_TARJETA))) {
    ...
    private void preservarInfoBasicaAnotacion(HttpServletRequest request) {
        ...
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_TIPO_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_TIPO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.LIBRO_TIPO_AS,
                request.getParameter(CDatosAntiguoSistema.LIBRO_TIPO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.LIBRO_NUMERO_AS,
                request.getParameter(CDatosAntiguoSistema.LIBRO_NUMERO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.LIBRO_PAGINA_AS,
                request.getParameter(CDatosAntiguoSistema.LIBRO_PAGINA_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.LIBRO_ANO_AS,
                request.getParameter(CDatosAntiguoSistema.LIBRO_ANO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.TOMO_NUMERO_AS,
                request.getParameter(CDatosAntiguoSistema.TOMO_NUMERO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.TOMO_PAGINA_AS,
                request.getParameter(CDatosAntiguoSistema.TOMO_PAGINA_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.TOMO_MUNICIPIO_AS,
                request.getParameter(CDatosAntiguoSistema.TOMO_MUNICIPIO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.TOMO_ANO_AS,
                request.getParameter(CDatosAntiguoSistema.TOMO_ANO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_TIPO_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_TIPO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_NUMERO_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_NUMERO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.COMENTARIO_AS,
                request.getParameter(CDatosAntiguoSistema.COMENTARIO_AS));

        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_DEPARTAMENTO_ID_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_DEPARTAMENTO_ID_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_DEPARTAMENTO_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_DEPARTAMENTO_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_MUNICIPIO_ID_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_MUNICIPIO_ID_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_VEREDA_ID_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_VEREDA_ID_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_VEREDA_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_VEREDA_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_NUMERO_ID_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_NUMERO_ID_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_OFICINA_NUMERO_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_OFICINA_NUMERO_AS));

        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_FECHA_AS,
                request.getParameter(CDatosAntiguoSistema.DOCUMENTO_FECHA_AS));
        request.getSession().setAttribute(CDatosAntiguoSistema.DOCUMENTO_COMENTARIO_AS,
...
//	FUNCIONES PARA PRESERVAR LA INFORMACIÓN DE LA ANOTACIÓN
        ...
        if (anotaEdicion.getDocumento().getOficinaOrigen() != null) {
            ...
            if (anotaEdicion.getDocumento().getOficinaOrigen() != null) {
                ...
                /*
                                ...
                                *  @mantis 0013414: Acta - Requerimiento No 069_453_Código_Notaria_NC
                 */
                request.getSession().setAttribute("version", anotaEdicion.getDocumento().getOficinaOrigen().getVersion());
            }
        }
    ...
    private Evento cancelarCreacion(HttpServletRequest request) throws AccionWebException {
        ...
        if (folio != null) {
            ...
            EvnCrearFolioOficio evn = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.ELIMINAR_FOLIO, folio, usuario);
...
//  guarda info folio
    private void doEndProcess_AdminCrearFolio_SaveInfo_Step1(HttpServletRequest request, EvnRespCrearFolioOficio respuesta) {
    ...
    private void
            doEndProcess_AdminCrearFolio_SaveInfo_StepX_LoadState(HttpServletRequest request, EvnResp_AdminCrearFolioSaveInfoOficio respuesta) {
        ...
        process_LoadData:
        {
            ...
            loadData_Folio:
            {
                ...
                session.setAttribute(
                        "NUPRE",
                        local_JxContext.getValue("nupre") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "DETERMINACION_INMUEBLE",
                        local_JxContext.getValue("determinaInm") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

//              session.setAttribute(
//                          "AVALUO"
//                          , local_JxContext.getValue( "avaluo" ) // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
//              ); // DT:double
//              session.setAttribute(
//                  "FECHA_AVALUO"
//                  , local_JxContext.getValue( "format:toString( fechaAvaluo, 'dd/MM/yyyy' )" )
//              ); // DT:date
                session.setAttribute(
                        "DESTINACION_ECONOMICA",
                        local_JxContext.getValue("destEconomica") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "PRIVMETROS",
                        local_JxContext.getValue("privMetros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "PRIVCENTIMETROS",
                        local_JxContext.getValue("privCentimetros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "CONSMETROS",
                        local_JxContext.getValue("consMetros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "CONSCENTIMETROS",
                        local_JxContext.getValue("consCentimetros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "COEFICIENTE",
                        local_JxContext.getValue("coeficiente") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "HECTAREAS",
                        local_JxContext.getValue("hectareas") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "METROS",
                        local_JxContext.getValue("metros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "CENTIMETROS",
                        local_JxContext.getValue("centimetros") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string

                session.setAttribute(
                        "LINDEROS_DEFINIDOS",
                        local_JxContext.getValue("linderosDef") // "zonaRegistral/vereda/municipio/departamento/idDepartamento"
                ); // DT:string
            ...
            loadData_Folio_Documento:
            {
              ...
              session.setAttribute(
                ...
                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_TIPO",
                        local_JxContext.getValue("documento/oficinaOrigen/tipoOficina/nombre")
                ); // DT:string

                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_ID_TIPO",
                        local_JxContext.getValue("documento/oficinaOrigen/tipoOficina/idTipoOficina")
                ); // DT:string
                ...
                *  @mantis 0013414: Acta - Requerimiento No 069_453_Código_Notaria_NC
                ...
                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_NUM",
                        local_JxContext.getValue("documento/oficinaOrigen/nombre")
                ); // DT:string

                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_TIPO_OFICINA",
                        local_JxContext.getValue("documento/oficinaOrigen/tipoOficina/nombre")
                ); // DT:string

                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_ID_TIPO_OFICINA",
                        local_JxContext.getValue("documento/oficinaOrigen/tipoOficina/idTipoOficina")
                ); // DT:string

                session.setAttribute(
                        "ANOTACION_OFICINA_DOCUMENTO_OFICINA_NOMBRE",
                        local_JxContext.getValue("documento/oficinaOrigen/nombre")
                ); // DT:string
...
//  guarda info folio
    private void
            doEndProcess_AdminCrearFolio_SaveInfo_Step0Find(HttpServletRequest request, EvnResp_AdminCrearFolioSaveInfoOficio respuesta) {
    ...
    //
    private void
            doEndProcess_AdminCrearFolio_SaveInfo_Step2Back(HttpServletRequest request, EvnResp_AdminCrearFolioSaveInfoOficio respuesta) {
    ...
    public void doEnd(HttpServletRequest request, EventoRespuesta eventoRespuesta) {
        if (eventoRespuesta != null) {
            if (eventoRespuesta instanceof EvnResp_AdminCrearFolioSaveInfoOficio) {
                EvnResp_AdminCrearFolioSaveInfoOficio respuesta = (EvnResp_AdminCrearFolioSaveInfoOficio) eventoRespuesta;

                String local_TipoEvento;
                local_TipoEvento = (respuesta.getTipoEvento());

                if (EvnResp_AdminCrearFolioSaveInfoOficio.ADMINCREARFOLIO_SAVEINFO_STEP0_FIND__EVENTRESP_OK.equals(local_TipoEvento)) {

                    doEndProcess_AdminCrearFolio_SaveInfo_Step0Find(request, respuesta);

                } // if
                if (EvnResp_AdminCrearFolioSaveInfoOficio.ADMINCREARFOLIO_SAVEINFO_STEP2_BACK__EVENTRESP_OK.equals(local_TipoEvento)) {

                    doEndProcess_AdminCrearFolio_SaveInfo_Step2Back(request, respuesta);

                } // if

            } else if (eventoRespuesta instanceof EvnRespCrearFolioOficio) {
                EvnRespCrearFolioOficio respuesta = (EvnRespCrearFolioOficio) eventoRespuesta;

                String local_TipoEvento;
                local_TipoEvento = (respuesta.getTipoEvento());

                if (EvnRespCrearFolioOficio.VALIDAR_MATRICULA_CREACION_FOLIO_OK.equals(local_TipoEvento)) {

                    doEndProcess_AdminCrearFolio_SaveInfo_Step1(request, respuesta);

                } else if (EvnRespCrearFolioOficio.VALIDAR_MATRICULA_CREACION_FOLIO_UPDATING_OK.equals(local_TipoEvento)) {

                    doEndProcess_AdminCrearFolio_SaveInfo_Step1(request, respuesta);

                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.AGREGAR_ANOTACION_OK)) {
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.CANCELAR_ANOTACIONES_OK)) {
                    eliminarInfoBasicaAnotacion(request);
                    request.getSession().removeAttribute("listanat");
                    request.getSession().setAttribute(WebKeys.FOLIO_EDITADO, respuesta.getPayload());
                    Folio folio = (Folio) request.getSession().getAttribute(WebKeys.FOLIO_EDITADO);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.CREACION_FOLIO)) {
                    eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.AGREGAR_SEGREGACION_ENGLOBE_OK)) {
                    //eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.AGREGAR_DERIVACION_OK)) {
                    //eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.ELIMINAR_DERIVACION_OK)) {
                    //eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.AGREGAR_ENGLOBE_OK)) {
                    //eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.ELIMINAR_ENGLOBE_OK)) {
                    //eliminarAtributosSesion(request);
                ...
                } else if (respuesta.getTipoEvento().equals(EvnRespCrearFolioOficio.VOLVER_AGREGAR_CIUDADANOS)) {
    ...
    private Evento editarAnotacion(HttpServletRequest request) {
        ...
        Log.getInstance().debug(AWCrearFolioOficio.class, "Anotacion a Editar " + ver);
    ...
    private Evento eliminarAnotacionTemporal(HttpServletRequest request) {
        ...
        n--;
        Log.getInstance().debug(AWCrearFolioOficio.class, "Editando anotacion # --> " + n);
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.ELIMINAR_ANOTACION);
        evnCrearFolio.setFolio(folio);
        evnCrearFolio.setUsuario(usuarioAuriga);
        evnCrearFolio.setUsuarioSir(usuarioNeg);
    ...
    private Evento crearCancelacion(HttpServletRequest request) {
        ...
        org.auriga.core.modelo.transferObjects.Usuario usuarioAuriga = (org.auriga.core.modelo.transferObjects.Usuario) request.getSession().getAttribute(SMARTKeys.USUARIO_EN_SESION);
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CREAR_CANCELACION);
    ...
    private Evento agregarSegregacionEnglobe(HttpServletRequest request) {
        ...
        org.auriga.core.modelo.transferObjects.Usuario usuarioAuriga = (org.auriga.core.modelo.transferObjects.Usuario) request.getSession().getAttribute(SMARTKeys.USUARIO_EN_SESION);
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CREAR_SEGREGACION_ENGLOBE);
        evnCrearFolio.setFolio(f);
        return evnCrearFolio;
    ...
    private Evento agregarDerivado(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CREAR_DERIVACION);
    ...
    private Evento eliminarDerivado(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.ELIMINAR_DERIVACION);
        evnCrearFolio.setAnotacionHijo(hijo);
        evnCrearFolio.setAnotacionPadre(padre);
        evnCrearFolio.setFolio(folio);
        evnCrearFolio.setUsuarioSir(usuarioSIR);
    ...
    private Evento agregarEnglobe(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CREAR_ENGLOBE);
    ...
    private Evento eliminarEnglobe(HttpServletRequest request) throws AccionWebException {
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.ELIMINAR_ENGLOBE);
        evnCrearFolio.setAnotacionHijo(hijo);
        evnCrearFolio.setAnotacionPadre(padre);
        evnCrearFolio.setFolio(folio);
        evnCrearFolio.setUsuarioSir(usuarioSIR);
 ...
 /*		String vista=(String)request.getSession().getAttribute(WebKeys.ULTIMA_VISTA_TEMPORAL);
    ...
    private Evento cancelarAnotacion(HttpServletRequest request) throws AccionWebException {
         ...
         * @change: Se valida que sea obligatorio el ingreso de ciudadanos
         * cuando se va a crear una anotación canceladora. Mantis: 4268 Acta -
         * Requerimiento No 116
         */
        else {
            exception.addError("Debe ingresar por lo menos un ciudadano");
        }
        ...
        //			}
        //		}
        //		Log.getInstance().debug(AWCrearFolioOficio.class,  c);
        //		c--;
        //	}
        ...
        EvnCrearFolioOficio evnCrearFolio = new EvnCrearFolioOficio(usuarioAuriga, EvnCrearFolioOficio.CANCELAR_ANOTACIONES);
        evnCrearFolio.setFolio(folio);
        evnCrearFolio.setAnotacion(anotacion);
        evnCrearFolio.setUsuario(usuarioAuriga);
        evnCrearFolio.setUsuarioSir(usuarioNeg);
    ...
    private Evento eliminarCiudadanoCancelacion(HttpServletRequest request) throws AccionWebException {
        ...
        /**
         * @author: Henry Gómez Rocha.
         * @change: Se remueve de la sesión los ciudadanos para evitar crear
         * anotaciones sin ciudadanos asociados. Mantis: 4268 Acta -
         * Requerimiento No 116.
         */
        //request.getSession().setAttribute(WebKeys.LISTA_CIUDADANOS_ANOTACION, ciudadanos);
        request.getSession().removeAttribute(WebKeys.LISTA_CIUDADANOS_ANOTACION);
