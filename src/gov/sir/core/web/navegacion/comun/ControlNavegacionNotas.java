 ...
 */
public class ControlNavegacionNotas implements ControlNavegacion {
	...
	public String procesarNavegacion(HttpServletRequest request) throws ControlNavegacionException {
		...
		if (accion.equals(AWNotas.COLOCAR_DESCRIPCION)) {
			...
			return IMPRIMIR_NOTA_DEVOLUTIVA_DETALLE+ruta;
		} else if (accion.equals(AWNotas.AGREGAR_NOTA_DEVOLUTIVA) || accion.equals(EvnNotas.GUARDA_NOTA_DEVOLUTIVA_ADD)) {
			return RECARGAR_DEVOLUTIVA+ruta;
			...
			String aux = (String)request.getSession().getAttribute(WebKeys.VISTA_ANTERIOR_AUXILIAR);
			if(aux!=null && !aux.equals("")){
				request.getSession().removeAttribute(WebKeys.VISTA_ANTERIOR_AUXILIAR);
				return aux;
			}
