...
import gov.sir.core.web.helpers.comun.*;
 ...
 * @author mmunoz
 */
public class PagoCanalesRecaudoHelper extends Helper {
    ...
    * @descripcion   : Constante donde se almacenan la lista de las formas de pago que tiene asignado cada
     ...
     * banco
     */
    public PagoCanalesRecaudoHelper(HttpServletRequest request, double valorLiquidado,
 ...
 /*listaElementoHelperCanalesRecaudo = this.cargarCanales(AWPago.CANALES_RECAUDO);
        ...
        try {
            ...
            Logger.getLogger(PagoCanalesRecaudoHelper.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    * asociadas.
    ...
    public void drawGUI(HttpServletRequest request, JspWriter out)
       ...
       valorTotalLiquidado = 0;
        ...
        out.write("<tr>");
        out.write("<td background=\"" + request.getContextPath()+ "/jsp/images/tabla_central_bgn001.gif\" class=\"titulotbcentral\">Datos del pago</td>");
        ...
        out.write("<tr>");
        out.write("<td><img src=\"" + request.getContextPath() + "/jsp/images/ico_pago.gif\" width=\"16\" height=\"21\"></td>");
        out.write("</tr>");
        out.write("</table>");
        out.write("</td>");*/
        ...
        if (liquidacionRegistro) {
            ...
            out.write("<td width=\"11\">$</td>");
            out.write("<td width=\"445\" class=\"campositem\">"+ formateador.format(valorLiquidacion) + "</td>");
            out.write("</tr>");
            out.write("</table>");
            /* JAlcazar caso Mantis 05648: Acta - Requerimiento No 006 -Reespecificacion _Tarifas Resolucion_81_2010-imm.doc
        ...
        /*else {
            ...
            out.write("<tr>");
            out.write("<td width=\"20\"><img src=\"" + request.getContextPath()+ "/jsp/images/ico_pago.gif\" width=\"16\" height=\"21\"></td>");
...
//         */
    ...
    * @descripcion   : Pinta interfaz nueva forma de pago.
    ...
    private void pintarNuevaFormaPago(HttpServletRequest request, JspWriter out) throws IOException, HelperException {
        ...
        out.println("<form name=\"FormaPago\" id=\"FormaPago\" method=\"post\" action=\"correccionCanalRecaudo.do\" >");
        request.getSession().setAttribute(AWPago.CORR_CANAL_RECAUDO, true);
        out.println("<tr>");
        out.println("<td valign=\"top\">");
        out.println("<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"2\" class=\"camposform\">"); //1
        ...
        out.println("<tr>");
        //out.println("<td width=\"20\"><img src=\"" + request.getContextPath() + "/jsp/images/ind_vinculo.gif\" width=\"20\" height=\"15\"></td>");
        out.println("<input type=\"hidden\" name=\"ACCION\" value=\"" + AWCorreccionCanalRecaudo.MODIFICAR_FORMA_PAGO + "\">");///
        
        out.println("<td>");
        out.println("<a onclick=\"cerrarpop()\"><input name=\"imageField21\" type=\"image\"  src=\"" + request.getContextPath() + "/jsp/images/btn_regresar.gif\" width=\"150\" height=\"25\" border=\"0\"></a>");
        out.println("</td>");
        out.println("<td>");    
        out.println("<a href=\"javascript:enviarNuevaForma()\" ><img name=\"imageField2\" src=\"" + request.getContextPath() + "/jsp/images/btn_aceptar.gif\" width=\"150\" height=\"25\" border=\"0\"></a>");
        out.println("</td>");  
    ...
    private void pintarCamposCaptura(
        ...
        System.out.println("******* entro a pintar campos captura **********");
        System.out.println("******* entro a pintar campos captura **********");
        System.out.println("******* entro a pintar campos captura **********");
    ...
    private void pintarLabelCamposCaptura(
        ...
        if (camposCaptura.getFormName().equals(WebKeys.CAMPO_BANCO_FRANQUICIA)) {
            ...
            out.println("<td><label id='LABEL_" + camposCaptura.getFormName() + "'>" + camposCaptura.getFormLabel() + "</label></td>");
            out.println("<td></td>");
        } else if (!(camposCaptura.getFormName().equals(AWPago.VLR_LIQUIDADO) || camposCaptura.getFormName().equalsIgnoreCase("VLR_DOC_PAGO"))){
            out.println("<td><label id='LABEL_" + camposCaptura.getFormName() + "'>" + camposCaptura.getFormLabel() + "</label></td>");
        }
    ...
    private void pintarTablaEfectuarCancelarPago(HttpServletRequest request,
        ...
        out.println("</td>");
        out.println("<td width=\"11\" background=\"" + request.getContextPath() + "/jsp/images/tabla_central_bgn008.gif\">&nbsp;</td>");
        out.println("</tr>");
        out.println("<tr>");
        out.println("<td><img name=\"tabla_central_r3_c1\" src=\"" + request.getContextPath() + "/jsp/images/tabla_central_r3_c1.gif\" width=\"7\" height=\"6\" border=\"0\" alt=\"\"></td>");
        out.println("<td background=\"" + request.getContextPath() + "/jsp/images/tabla_central_bgn006.gif\"><img src=\""
                + request.getContextPath()
                + "/jsp/images/spacer.gif\" width=\"15\" height=\"6\"></td>");
        out.println("<td><img name=\"tabla_central_pint_r3_c7\" src=\""
                + request.getContextPath()
