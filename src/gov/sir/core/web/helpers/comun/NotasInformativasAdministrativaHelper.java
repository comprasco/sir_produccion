 ...
 * @author mmunoz
 */
public class NotasInformativasAdministrativaHelper extends Helper{
	...
	public void drawGUI(HttpServletRequest request, JspWriter out) throws IOException, HelperException {
		...
		if(nombreFormulario!=null && !nombreFormulario.equals("")){
			...
			out.write("       		document."+nombreFormulario+".action = 'adminnotas.do';\r\n");
			out.write("       		document."+nombreFormulario+".submit();\r\n");
			out.write("       	}catch(e){\r\n");
			out.write("       		document.NOTAS.action = 'admin.notas.informativas.view';\r\n");		
		...
		out.write("<form action=\"admin.notas.informativas.view\" method=\"post\" name=\"NOTAS\" target=\"_self\" id=\"NOTAS\">");
