 ...
 */
public class DetallesNotaDevolutivaHelper extends Helper {
	...
	public void drawGUI(HttpServletRequest request, JspWriter out) throws IOException, HelperException {
		...
		out.write("<hr class=\"linehorizontal\">");
		out.write("<table width=\"100%\" class=\"camposform\">");
		if(nota.getTiponota().isDevolutiva() && request.getSession().getAttribute("impresionpermitida")!=null && request.getSession().getAttribute("impresionpermitida").equals("1")
				&& !nota.getIdFase().equals(CFase.CAL_CALIFICACION)) {
			out.write("<tr>"); 
			...
			if(nota.getTiponota().isDevolutiva()) {
				out.write("<tr>");
                                out.write("<td ><a href=\"javascript:regresar()\"><img src=\"" + request.getContextPath()+ "/jsp/images/btn_salir.gif\"   width=\"139\" height=\"21\" border=\"0\" ></a></td>");
				//out.write("<td><a href=\"javascript:window.close()\"><img src=\"" + request.getContextPath() + "/jsp/images/btn_cerrar_ventana.gif\" width=\"150\" height=\"21\" border=\"0\"></a></td>");
				out.write("</tr>");
			}
			else {
