...
import gov.sir.core.negocio.acciones.excepciones.RolDrawException;

/**
 * @author Geremias Ortiz Lozano
 */
public class RolDraw {
    ...
    public void render(HttpServletRequest request, JspWriter out) throws RolDrawException, IOException {
        setProperties(request, out);       

    }

    public void drawGUI(HttpServletRequest request, JspWriter out)
            throws RolDrawException, IOException {
        ...
        if (roles.isEmpty()) {
            ...
            while (itRoles.hasNext()) {
                ...
                if ((!rol.getRolId().equals(CRoles.ADMINISTRADOR_NACIONAL))
                         ...
                         * @change : NO se visualiza el rol
                         * SIR_ROL_IMPRESION_FOLIO_ESPECIAL de las listas de
                         * roles-procesos del usuario. Caso Mantis : 0009044:
                         * Acta - Requerimiento No 036_151 - Impresión de Folios
                         */
                        && (!rol.getRolId().equals(CRoles.SIR_ROL_IMPRESION_FOLIO_ESPECIAL))
                        /**
                         * @author : AHERRENO
                         * @change : No se visualiza el rol
                         * SIR_ROL_CONSULTAS_MINUTAS en la lista de
                         * roles-procesos del usuario. REQ 024_453
                         */
                        && (!rol.getRolId().equals(CRoles.SIR_ROL_CONSULTAS_MINUTAS))
                        /**
                         * @author : CTORRES
                         * @change : No se visualiza el rol
                         * SIR_ROL_TRASLADO_MASIVO_FOLIO en la lista de
                         * roles-procesos del usuario. REQ 11309: Acta -
                         * Requerimiento No 023_453 - Traslado_Masivo_Folios
                         */
                        && (!rol.getRolId().equals(CRoles.SIR_ROL_TRASLADO_MASIVO_FOLIO))
                        /**
                         * @author : CTORRES
                         * @change : No se visualiza el rol SIR_ROL_AUDITOR en
                         * la lista de roles-procesos del usuario. REQ 13176:
                         * Acta - Requerimiento No
                         * 061_453_Requerimiento_Auditoria
                         */
    ...
    public void setProperties(HttpServletRequest request, JspWriter out) throws RolDrawException, IOException  {
        ...
        Object Rol =  request.getSession().getAttribute(WebKeys.ROL);
