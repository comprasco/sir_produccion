 ...
 *
 */
public class JDOGenieAuditoriaDAO {
    /**
    ...
    protected void addAuditoria(Enhanced nuevo, Enhanced viejo,
        ...
        CirculoEnhanced circulo = null;
        
        try {
	        UsuarioEnhancedPk usuarioID = new UsuarioEnhancedPk();
	        usuarioID.idUsuario = usuario.getIdUsuario();
	        UsuarioEnhanced usuarioCompleto = (UsuarioEnhanced) pm.getObjectById(usuarioID,true);
	        List circulosUsuario = usuarioCompleto.getUsuarioCirculos();
	        if (circulosUsuario != null && !circulosUsuario.isEmpty())
	        {
	        	UsuarioCirculoEnhanced usCirculoEn = (UsuarioCirculoEnhanced)circulosUsuario.get(0);
	        	circulo = usCirculoEn.getCirculo();
	        }
        }catch (Throwable th)
        {
        	throw new DAOException ("No se pudo consultar el circulo del usuario",th);
        }
        ...
        if (hayAuditoria) {
            ...
            Log.getInstance().info(JDOGenieAuditoriaDAO.class, "Iniciando auditoria de " +
                                ...
                                if (valorAtributo.getClass().getSuperclass()
                                    ...
                                    for (int i = 0; i < metodosNuevo.length;
                                        ...
                                        try {
                                                    ...
                                                    while (itValoresObjetos.hasNext()) {
                                                        ...
                                                        if (((RelAtributoValorMapaJDO) valor.getColumnas()
                                                            ...
                                                            if (all.equals(
                                                                ...
                                                                Log.getInstance().debug(JDOGenieAuditoriaDAO.class, 
                                                                    "Insertando " +
                                                                    relac.getColumna() +
                                                                    " con valor " +
                                                                    resultNuevo);
                                            ...
                                            Log.getInstance().warn(JDOGenieAuditoriaDAO.class, 
                                                "Error en el método " +
                                    ...
                                    mapaValoresAtributos.put(((RelAtributoValorMapaJDO) valor.getColumnas()
                                                                                             .get(0)).getColumna(),
                                        valorAtributo);
                                    Log.getInstance().debug(JDOGenieAuditoriaDAO.class, "Insertando " +
                                        ((RelAtributoValorMapaJDO) valor.getColumnas()
                                                                        .get(0)).getColumna() +
                        ...
                        for (int i = 0; i < metodos.length; i++) {
                            ...
                            if (metodo.getName().equals(getter)) {
                                try {
                                    ...
                                    ExceptionPrinter printer = new ExceptionPrinter(e);
                                    Log.getInstance().warn(JDOGenieAuditoriaDAO.class, "Error en el método " +
            ...
            Log.getInstance().info(JDOGenieAuditoriaDAO.class, "Auditoria de " + guardar.getClass().getName() +
                " terminada");
        }
    }
    ...
    protected long getSecuencial(String nomSecuencia, PersistenceManager pm)throws DAOException{
        ...
        try {
            ...
            Log.getInstance().error(JDOGenieAuditoriaDAO.class, "No se pudo obtener la secuencia:"+ep.toString());
            ...
            try {
                ...
                ExceptionPrinter ep=new ExceptionPrinter(e);
                Log.getInstance().error(JDOGenieAuditoriaDAO.class, ep.toString());
                throw new DAOException(e);
            }
        }
        return secuencia;
...
/*    protected long getSecuencial(String tableName, PersistenceManager pm)
        ...
        if (tableName != null) {
            try {
                ...
                Log.getInstance().error(JDOGenieAuditoriaDAO.class, e.getMessage());
            }
        }
                ...
                try {
                    ...
                    for (int i = 0; i < metodos.length; i++) {
                        try {
                            ...
                            ExceptionPrinter printer = new ExceptionPrinter(e);
                            Log.getInstance().error(JDOGenieAuditoriaDAO.class, "Error en el método " +
                    ...
                    ExceptionPrinter printer = new ExceptionPrinter(e);
                    Log.getInstance().error(JDOGenieAuditoriaDAO.class, "Error clonando la clase " +
                        claseObjeto.getName() + ":" + printer.toString());
                    throw new DAOException(e);
                } catch (IllegalAccessException e) {
                    ExceptionPrinter printer = new ExceptionPrinter(e);
