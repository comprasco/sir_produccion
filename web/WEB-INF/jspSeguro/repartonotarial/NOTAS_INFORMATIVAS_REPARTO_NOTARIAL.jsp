...
function colocarDescripcion(){
	document.NOTAS_INF.ACCION.value='<%=AWRepartoNotarial.COLOCAR_DESCRIPCION%>';
	document.NOTAS_INF.submit();
}
function cancelar(){
    document.NOTAS_INF.ACCION.value='<%=AWRepartoNotarial.CANCELAR_REPARTO_NOTARIAL%>';
	document.NOTAS_INF.submit();
}

function repartir(){
	document.NOTAS_INF.ACCION.value='<%=AWRepartoNotarial.EJECUTAR_REPARTO%>';
	document.NOTAS_INF.submit();
}

function imprimirNotaInformativa(posicion){
	document.NOTAS_INF.ACCION.value='<%=AWRepartoNotarial.IMPRIMIR_NOTA_INFORMATIVA%>';
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
         ...
         <form action="reparto.notarial.nota.informativa.do" method="post" name="NOTAS_INF" id="NOTAS_INF">
         <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWRepartoNotarial.AGREGAR_NOTA%>">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="100%" class="camposform">
				...
				<% 
				try {
					tiposNotaHelper.setFuncion("onChange=\"colocarDescripcion();\"");
              ...
              <table width="100%" class="camposform">
                <tr>
                  <td>
                      <img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" height="15">
                      <input type="image" src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" border="0">
                      <a href='javascript:cancelar();'><img src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif" border="0" ></a>
                      <a href='javascript:repartir();'><img src="<%=request.getContextPath()%>/jsp/images/btn_repartir.gif" border="0"></a>
                  </td>
                </tr>
              </table>
