...
<%
	gov.sir.core.negocio.modelo.Turno turno = (Turno) request.getSession().getAttribute(WebKeys.TURNO);
			...
			<table width="100%" class="camposform">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  ...
                  <td background="<%=request.getContextPath()%>/jsp/images/sub_bgn001.gif" class="bgnsub">Persona natural ó entidad pública</td>
                  <td width="16" class="bgnsub"></td>
                  <td width="15"> <img name="sub_r1_c4" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c4.gif" width="15" height="22" border="0" alt=""></td>
                </tr>
              </table>
              ...
              <table width="100%" class="camposform">
                <tr> 
                  ...
                  <td> 
					<a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.repartonotarial.AWRepartoNotarial.NOTIFICAR_CIUDADANO_EXITO%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0"></a>                  
                  </td>                  
