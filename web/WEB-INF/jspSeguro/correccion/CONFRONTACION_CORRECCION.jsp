    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
            ...
            <form action="confrontacionCorreccion.do" method="post" name="ELIMINAR_MAT" id="ELIMINAR_MAT">
        ...
        <table class="camposform" width="100%">
            <form action="confrontacionCorreccion.do" method="post" name="ASOCIAR_MAT" id="ASOCIAR_MAT">
            ...
            <form action="confrontacionCorreccion.do" method="post" name="ASOCIAR_RAN" id="ASOCIAR_RAN">
            ...
            <form action="confrontacionCorreccion.do" method="post" name="CORRECCION" id="CORRECCION">
		    ...
		    <input type="hidden" name="<%=CFolio.ID_MATRICULA%>" value="">
              ...
              <table width="100%" class="camposform">
                <tr>
                  <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                  <td width="50"><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWConfrontacion.CONFIRMAR%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0"></a></td>
                  <td width="30">&nbsp;</td>
                  <td colspan='2'>&nbsp;</td>
<!--
				  <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWConfrontacion.NEGAR%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif" width="139" height="21" border="0"></a></td>
-->
                </tr>
              </table>
