...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <!-- fwtable fwsrc="SIR_central_pantallasinternas_subsecciones.png" fwbase="sub.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="1" -->
       ...
       <form name="CORRECCION" method="post" action="correccion.do">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
              ...
              <tr align='left'>
			  	...
			  	<td width='150'><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.IMPRIMIR%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_consultar.gif"  alt="Imprimir" width="139" height="21" border="0"></a></td>
              	<td>Haga click en el botón consultar para ver los folios que puede imprimir</td>
				<td>&nbsp;</td>
              </tr>
	          </table>
        </form>
...
%>
    ...
    <!-- fwtable fwsrc="SIR_central_pantallasinternas_subsecciones.png" fwbase="sub.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="1" -->
       ...
       <form name="CORRECCION2" method="post" action="correccion.do">
       <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=gov.sir.core.web.acciones.correccion.AWCorreccion.IMPRIMIR%>">
       <input type="hidden" name="<%=gov.sir.core.negocio.modelo.constantes.CFolio.ID_MATRICULA%>">
        <%
			  try {
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
              ...
              <tr align='left'>
              <td width="20" height="24"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
			  <td width='150'><a href="javascript:cambiarAccion2('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.IMPRIMIR_INDIVIDUAL%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_imprimir.gif"  alt="Imprimir" width="139" height="21" border="0"></a></td>
              <td>&nbsp;</td>
              </tr>
			  <tr>
                <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
...
%>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Avanzar el Turno</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
                <td width="20" align="center" valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
              ...
              <table width="100%" class="camposform">
                <tr>
               <form name="CORRECCION1" method="post" action="correccion.do">
       <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=gov.sir.core.web.acciones.correccion.AWCorreccion.IMPRIMIR%>">

              <td width="20" height="24"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
			  <td width='150'><a href="javascript:cambiarAccion1('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.AVANZAR_IMPRIMIR%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif"  alt="Aceptar" width="139" height="21" border="0"></a></td>
              <td width="20" height="24"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
			  <td><a href="javascript:this.location='turnos.view'"><img src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif"  alt="Regresar" width="139" height="21" border="0"></a></td>
