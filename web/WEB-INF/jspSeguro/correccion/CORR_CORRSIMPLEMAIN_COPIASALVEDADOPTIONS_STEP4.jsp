...
<script type="text/javascript">
   ...
   var CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP4CONFIRM_ACTION  = "<%= AwCorr_CorrSimpleMain_CopiaSalvedadOptions.CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP4CONFIRM_ACTION  %>";
...
<!--<script type="text/javascript" language="javascript" src="<%=request.getContextPath()%>/jsp/plantillas/plugins.js"></script>-->
...
<td>
  ...
  <ul>
    <li><b>[Resultados] Operacion Realizada. </b></li>
  </ul>
        ...
        <%-- ACCIONES --%>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <%-- SOF:BUTTON --%>
                  <td width="50">
                    <a href="javascript:js_OnEvent( 'CORRECCION1', CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP4CONFIRM_ACTION );">
                     <img alt="procesar"   src="<%=request.getContextPath()%>/jsp/images/btn_terminar.gif" width="139" height="21" border="0" />
                    </a>
                  </td>
                  <%-- EOF:BUTTON --%>
