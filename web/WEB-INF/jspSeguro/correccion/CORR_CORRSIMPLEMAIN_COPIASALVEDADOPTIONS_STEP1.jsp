...
<script type="text/javascript">
   ...
   var CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP1CANCEL_ACTION  = "<%= AwCorr_CorrSimpleMain_CopiaSalvedadOptions.CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP1CANCEL_ACTION %>";
   var CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP1NEXT_ACTION    = "<%= AwCorr_CorrSimpleMain_CopiaSalvedadOptions.CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP1NEXT_ACTION   %>";
...
// transfer-objects 2 plain objects
        ...
        final String PARAM__ITEM_FOLIOSINTURNOCONSALVEDADES_SELECTEDIDS   = AwCorr_CorrSimpleMain_CopiaSalvedadOptions.PARAM__ITEM_STEP1FOLIOSINTURNOCONSALVEDADES_SELECTEDIDS ;
...
<%
              ...
              try {
                ...
                local_View_TableHelper.setInputName( PARAM__ITEM_FOLIOSINTURNOCONSALVEDADES_SELECTEDIDS   ); //  WebKeys.LISTA_PARAMETROS_PERMISOS_REVISION
                local_View_TableHelper.setListName(  PARAM__LOCAL_FOLIOSINTURNOCONSALVEDADES_IDVALUES );

                // permite colocar los valores previamente seleccionados
                local_View_TableHelper.setSelectedValues_Enabled( true );
                local_View_TableHelper.setSelectedValues_Ids_Key( PARAM__LOCAL_FOLIOSINTURNOCONSALVEDADES_SELECTEDIDS );
        ...
        <%-- ACCIONES --%>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <%-- SOF:BUTTON --%>
                  <td width="50">
                    <a href="javascript:js_OnEvent( 'CORRECCION1', CORRECCIONSIMPLEMAIN_OPCIONCOPIARSALVEDADTMPFOLIO_BTNSTEP1CANCEL_ACTION );">
