...
<script type="text/javascript">
	...
	var actionField     = "<%= WebKeys.ACCION    %>";
        var parameterField  = "<%= WebKeys.PARAMETRO %>";
        var PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNBACK_ACTION = "<%= AWModificarFolio.PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNBACK_ACTION %>"; // the same
        var PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNNEXT_ACTION = "<%= AWModificarFolio.PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNNEXT_ACTION %>"; // the same
...
<script type="text/javascript">
   ...
   function js_OnEvent( formName, actionValue ) {
     ...
     htmlForm = new LocalForm( formName );
     htmlForm.setValue( actionField, actionValue );
     htmlForm.setValue( 'POSSCROLL', document.getElementById('POSSCROLL').value );     
     htmlForm.submitForm();
...
<%-- --%>
			   ...
			   <%try{
			   			...
			   			mFolio.mostrarAnotacionesCancelacioMultiple(AWModificarFolio.PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNNEXT_ACTION); //AWCalificacion.GUARDAR_ANOTACIONES_TEMPORALES
...
%>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140">
                    <a href="javascript:js_OnEvent_Proxy1( 'CANCELAR', PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNNEXT_ACTION );">
                      <img src="<%=request.getContextPath()%>/jsp/images/btn_seguir.gif" name="Folio" width="139" height="21" border="0" id="Folio" alt="[next]"/>
                    </a>
                  </td>
                  <td>
                    <a href="javascript:js_OnEvent( 'CANCELAR', PAGE_ANOTACIONCANCELADORACREARSTEP1_BTNBACK_ACTION );">
