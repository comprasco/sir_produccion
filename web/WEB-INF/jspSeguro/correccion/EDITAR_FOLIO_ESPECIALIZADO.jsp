...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
 		<%@ include file="CORRECCION_FOLIO_TABS_ESPECIALIZADO.jsp" %> 
    ...
    <table width="100%" class="camposform">
        <tr>
            ...
            <td width="150" align="center"><a href="<%=request.getContextPath()%>/correccion.especializado.view"><img src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" name="Regresar" width="139" height="21" border="0" id="Regresar"></a></td>
            <td>&nbsp;</td>
        </tr>
    </table>
    </td>
