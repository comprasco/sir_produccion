...
<%
	...
	Solicitud solicitud = (Solicitud) turno.getSolicitud();
        ...
        /*
* @author : CTORRES
* @change : se define la variable activo y turnoAnterior
* Caso Mantis : 12291
...
*/  
        ...
        turnoAnterior = solicitud.getTurnoAnterior();
    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"> <table border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Tomar Folios de la Corrección</td>
...
*/  
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.TOMAR_TURNO_TESTAMENTO%>');">
                          <img src="<%=request.getContextPath()%>/jsp/images/btn_tomar_turno.gif" name="Folio" width="150" height="21" border="0" id="Folio"></a>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="12"><img name="sub_r1_c1" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c1.gif" width="12" height="22" border="0" alt=""></td>
                  <td background="<%=request.getContextPath()%>/jsp/images/sub_bgn001.gif" class="bgnsub"> Matr&iacute;culas Asociadas a la corrección </td>
                  <td width="16" class="bgnsub"><img src="<%=request.getContextPath()%>/jsp/images/ico_matriculas.gif" width="16" height="21"></td>
                  <td width="15"><img name="sub_r1_c4" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c4.gif" width="15" height="22" border="0" alt=""></td>
                </tr>
              </table>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td></td>
				  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.TOMAR_FOLIO_CORRECCION%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_tomar_folios.gif" name="Folio" width="150" height="21" border="0" id="Folio"></a></td>                  
                </tr>
              </table>
             <%}%>
            </form>
