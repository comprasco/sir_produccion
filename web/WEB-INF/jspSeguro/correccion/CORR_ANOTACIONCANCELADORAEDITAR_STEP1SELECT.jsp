...
<script type="text/javascript">
	...
	var actionField     = "<%= WebKeys.ACCION    %>";
        ...
        var PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNBACK_ACTION = "<%= AWModificarFolio.PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNBACK_ACTION %>"; // the same
        var PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNNEXT_ACTION = "<%= AWModificarFolio.PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNNEXT_ACTION %>"; // the same
...
<script type="text/javascript">
  ...
  <%
    ...
    boolean local_AnotacionesToBeCanceledSelect_EnabledRegionFlag = false;
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
             ...
             <span class="bgnsub" style="background:" >Escoja la anotaci&oacute;n que desea cancelar</span>
...
<xRegionTemplate:DisplayPoint
  ...
  regionName="anotacion-canceladora - select-items-to-cancel"
  regionDescription="Espacio para escoger las anotaciones que van a ser canceladas"
  debugEnabled="false"
...
<%-- --%>
			   ...
			   <%try{
			   			...
			   			mFolio.setNombreAccionCancelacion("modificacion.do"); //calificacion.do
			   			...
			   			mFolio.mostrarAnotacionesCancelacioMultiple(AWModificarFolio.PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNNEXT_ACTION); //AWCalificacion.GUARDAR_ANOTACIONES_TEMPORALES

                                                // para habilitar bug 5042 -------------------------------------------------------------------------------------------------
...
%>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140">
                    <a href="javascript:js_OnEvent_Proxy1( 'CANCELAR', PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNNEXT_ACTION );">
                      <img src="<%=request.getContextPath()%>/jsp/images/btn_seguir.gif" name="Folio" width="139" height="21" border="0" id="Folio" alt="[next]"/>
                    </a>
                  </td>
                  <td>
                    <a href="javascript:js_OnEvent( 'CANCELAR', PAGE_ANOTACIONCANCELADORAEDITARSTEP1_BTNBACK_ACTION );">
