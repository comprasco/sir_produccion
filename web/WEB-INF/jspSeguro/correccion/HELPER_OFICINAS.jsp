...
<%
    ...
    String oficinaInternacional = (String) session.getAttribute(AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL);
    String tipoOficina = "";
    ...
    if(oficinaInternacional == null || oficinaInternacional.length() == 0){
        ...
        tipoOficina = (String) session.getAttribute(WebKeys.TIPO_OFICINA_I_N);
    }else{
        session.setAttribute(WebKeys.TIPO_OFICINA_I_N,WebKeys.TIPO_OFICINA_INTERNACIONAL);
        tipoOficina = (String) session.getAttribute(WebKeys.TIPO_OFICINA_I_N);
    }
    
    if(tipoOficina.equals(WebKeys.TIPO_OFICINA_NACIONAL)){
        checkedNacional = "checked";
        session.removeAttribute(AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL);
    }
    
    if(tipoOficina.equals(WebKeys.TIPO_OFICINA_INTERNACIONAL)){
        checkedInterNacional = "checked";
    }

    //tipoOficina = tipoOficina == null || tipoOficina.length() == 0 ? AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL : tipoOficina;
...
<script type="text/javascript">
    function showHide(){
        var valor = document.getElementById("uno").checked;
        ...
        if (valor){
            ...
            document.getElementById("dos").checked;
        }
    }
...
<tr>
        ...
        <table width="100%" border="0" class="camposform">
            <tr>
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Internacional
                    <input name="<%=WebKeys.TIPO_OFICINA_I_N%>" id="dos" type="radio"
                           value="<%=WebKeys.TIPO_OFICINA_INTERNACIONAL%>" <%=checkedInterNacional%>
                           onClick="showHide();">
                </td>
            </tr>
        </table>
	<table width="100%" id="Nacional1" class="camposform" style="display:block">
            <tr>
                ...
                <td width="10%">
                    <% if(!read){ %>
                        <a href="javascript:locacion('seleccionar.locacion.do?LOCACIONES_CIRCULO=','ANOTACION_OFICINA_DOCUMENTO','width=790,height=175,menubar=no');">
                            <img src="<%=request.getContextPath()%>/jsp/images/ico_mapcolombia.gif" alt="" width="16" height="21" border="0">
                        </a>
                    <% } %>
                    &nbsp;
                </td>
        ...
        <table width="100%" id="Nacional2" class="camposform" style="display:block">
            <tr>
                ...
                <td width="10%">
                    <% if(!read){ %>
                        <a href="javascript:oficinas('seleccionar.oficina.do','ANOTACION_OFICINA_DOCUMENTO','width=800,height=175,menubar=no')" >
                            <img src="<%=request.getContextPath()%>/jsp/images/ico_tipo_oficina.gif" alt="" width="16" height="21" border="0"/>
                        </a>
                    <% } %>
                    &nbsp;
                </td>
            ...
            <table width="100%" border="0" cellpadding="0" id="Internacional" style="display:none" class="camposform">
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            textHelper.setCssClase(style);
                            textHelper.setNombre(AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL);
                            textHelper.setId(AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL);
                            if(read){
                                textHelper.setReadonly(read);
                            }else{
                                textHelper.setReadonly(false);
                            ...
                            textHelper.render(request, out);
                            //AWModificarFolio.ANOTACION_OFICINA_DOCUMENTO_OFICINA_INTERNACIONAL
                        %>
                    </td>
                </tr>
            </table>
    ...
    <script type="text/javascript" >showHide();</script>
