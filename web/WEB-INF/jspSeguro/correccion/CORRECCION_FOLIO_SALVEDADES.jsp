        ...
        <tr>
		  ...
		  %>	
			...
			<%
                        ...
                        ArrayList salvedadesLista = new ArrayList();
                        /**
                        *@Autor: Edgar Lora
                        *@Mantis: 11599
                        *@Requerimiento: 085_151
                        */
                        for(int i = 0; i < salvedades.size(); i = i + 1){
                            salvedadesLista.add(salvedades.get(i));
                        }
                        Collections.sort(salvedadesLista, new ComparadorSalvedad());
			Iterator is = salvedadesLista.iterator();
			while(is.hasNext()){
		  ...
		  %>	
				...
				while(ia.hasNext()){
					...
					List salvedades = anotacion.getSalvedades();
                                        ...
                                        *@Requerimiento: 085_151
                                        */
                                        for(int j = 0; j < salvedades.size(); j = j + 1){
                                            salvedadesLista.add(salvedades.get(j));
                                        }
                                        Collections.sort(salvedadesLista, new ComparadorSalvedad());
					Iterator is = salvedadesLista.iterator();
					while(is.hasNext()){
