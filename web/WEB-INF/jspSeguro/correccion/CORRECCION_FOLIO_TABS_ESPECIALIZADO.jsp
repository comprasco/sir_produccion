...
<script>
    ...
    <form  action='editar.folio.especializado.view' name='<%=CTabs.FICHAS%>' method='post'>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%")">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_ESPECIALIZADO_PRINCIPAL.jsp"%></td>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB2)){%>      
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_CONSULTAS.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
	...
	%>        
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_PADRES_HIJOS.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
