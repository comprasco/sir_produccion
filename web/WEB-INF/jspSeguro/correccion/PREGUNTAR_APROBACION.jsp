...
%>
<SCRIPT>
function avanzar(delegar) {
    document.CORRECCION.<%=gov.sir.core.web.acciones.correccion.AWCorreccion.DELEGAR_CASO%>.value = delegar;
    document.CORRECCION.action = 'correccion.cargar.notainformativa.view';    
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"> 
		    ...
		    <input type="hidden" name="<%=CFolio.ID_MATRICULA%>" value="">				    
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="12"><img name="sub_r1_c1" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c1.gif" width="12" height="22" border="0" alt=""></td>
                  <td class="bgnsub">Enviar Caso </td>
                  <td width="16" class="bgnsub"><img src="<%=request.getContextPath()%>/jsp/images/ico_datosuser.gif" width="16" height="21"></td>
                  <td width="15"><img name="sub_r1_c4" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c4.gif" width="15" height="22" border="0" alt=""></td>
                </tr>
                </table>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="50"><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.FORZAR_APROBACION%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_aprobar_guardar.gif" width="180" height="21" border="0"></a></td>                                    
                  <td width="30">&nbsp;</td>
                  <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.REDIRECCIONAR_CASO%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_pago_mayor_valor.gif" width="180" height="21" border="0"></a></td>
                </tr>
              </table>              
