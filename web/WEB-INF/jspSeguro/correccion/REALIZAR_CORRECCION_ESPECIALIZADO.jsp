...
<%
    ...
    MatriculaEditHelper matEditHelper = new MatriculaEditHelper(gov.sir.core.web.acciones.correccion.AWModificarFolio.CARGAR_FOLIO_ESPECIALIZADO);    
    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"> <table border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Realizar Correcci&oacute;n - Usuario Especializado</td>
		    ...
		    <input type="hidden" name="<%=CFolio.ID_MATRICULA%>" value="">				    
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="50"><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.APROBAR_ESPECIALIZADO%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_aprobar_guardar.gif" width="180" height="21" border="0"></a></td>                                    
                  <td width="30">&nbsp;</td>
                  <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.NEGAR_ESPECIALIZADO%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_negar.gif" width="139" height="21" border="0"></a></td>                  
                </tr>
              </table>              
