...
<%
        ...
        gov.sir.core.web.helpers.correccion.region.model.RegionManager localRegionManager = null;

        // recuperar valores de regionManager de la sesion
        localRegionManager = (gov.sir.core.web.helpers.correccion.region.model.RegionManager)session.getAttribute( "param_RegionManager" );

%>
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>

    <form  action='editar.folio.correccion.view' name='<%=CTabs.FICHAS%>' method='post'>
    	<input type='hidden' name='<%=CTabs.TAB%>'>
		<%
			String tab;

                        tab = request.getParameter(CTabs.TAB);

                        // solo cuando el tab es nulo, observa en sesion el tab.
                        // esto, para que permita dejar seleccionado un tab determinado.

                        if( ( null == tab )
                           ||( "".equalsIgnoreCase( tab.trim() )) ) {

                            tab = (String)session.getAttribute( CTabs.TAB );
                        }
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%")">
          ...
          <table border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB1%>')">
                  <tr>
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Correcci&oacute;n</td>
                ...
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB2%>')">
                    <tr>
                      ...
                      <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_002.gif" class="titulotbcentral_tabs"><a href="#">Consultas </a><a href="#"> </a></td>
                ...
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB5%>')">
                    <tr>
                      <td valign="top"><img name="tabla_central_r1_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_001.gif" width="7" height="29" border="0" alt=""></td>
                      <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_002.gif" class="titulotbcentral_tabs"><a href="#">Notas Inf. </a><a href="#"></a></td>
                      <td width="12" valign="top"><img name="tabla_central_r1_c5" src="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_003.gif" width="12" height="29" border="0" alt=""></td>
                      <td valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
        ...
        <tr>
          ...
          <%-- TabbedPane Page1 Inclusion --%>
          <%@ include file="CORRECCION_FOLIO_CORRECCION_PRINCIPAL.jsp"%>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB2)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB1%>')">
                    <tr>
                      <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_002.gif" class="titulotbcentral_tabs"><a href="#">Correcci&oacute;n</a><a href="#"> </a></td>
                      <td width="12" valign="top"><img name="tabla_central_r1_c5" src="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_003.gif" width="12" height="29" border="0" alt=""></td>
                      <td valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_inactiva_002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><img src="<%=request.getContextPath()%>/jsp/images/ico_estandar.gif" width="16" height="21"></td>
                ...
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB2%>')">
                  <tr>
                    ...
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Consultas </td>
                    <td><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
                    <td valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><img src="<%=request.getContextPath()%>/jsp/images/ico_consulta.gif" width="16" height="21"></td>
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
           <%-- TabbedPane Page2 Inclusion --%>
            <%@ include file="CORRECCION_FOLIO_CONSULTAS.jsp"%>
          </td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB3)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
             <%-- TabbedPane Page3 Inclusion --%>
            <%@ include file="CORRECCION_FOLIO_PADRES_HIJOS.jsp"%>
          </td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB4)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_GRAVAMENES.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB5)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0" >
              <tr>
                ...
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('<%=CTabs.TAB5%>')">
                  <tr>
                    <td width="7"><img name="tabla_central_r1_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_tabs_activa_000.gif" width="7" height="29" border="0" alt=""></td>
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Notas Inf. </td>
                    <td><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
                    <td valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><img src="<%=request.getContextPath()%>/jsp/images/ico_notas.gif" width="16" height="21"></td>
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_NOTAS_INFORMATIVAS.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB6)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_SALVEDADES.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
	...
	<%}if(tab!=null&&tab.equals(CTabs.TAB7)){%>
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="7" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><%@ include file="CORRECCION_FOLIO_CANCELACIONES.jsp"%></td>
          <td width="11" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        </tr>
        <tr>
          <td><img name="tabla_central_r3_c1" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r3_c1.gif" width="7" height="6" border="0" alt=""></td>
