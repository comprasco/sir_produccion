<%@page import="gov.sir.core.web.acciones.correccion.AWNaturalezaJuridica"%>
<%@page import="gov.sir.core.negocio.modelo.constantes.CDocumento"%>
<%@page import="org.auriga.smart.SMARTKeys"%>
<%@page import="org.auriga.core.web.*,
gov.sir.core.web.acciones.correccion.AWModificarFolio,
...
gov.sir.core.web.helpers.registro.AnotacionCancelacionHelper,
gov.sir.core.web.acciones.comun.AWPaginadorAnotaciones,
gov.sir.core.negocio.modelo.constantes.CTipoMostrarFolioHelper,
...
<%
	...
	request.getSession().setAttribute("paramVistaAnterior","ANOTACION_CANCELACION_CORRECIONES");
...
<%-- Bug 3562 --%>
<%-- Despliegue temporal de anotaciones seleccionadas --%>
<%--

              <hr class="linehorizontal" />
              <span class="bgnsub" style="background:" >Anotaciones seleccionadas:</span>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140">
                    ...
                    final String PAGE_ANOTACIONCANCELADORACREARSTEP1__PARAM_SELECTEDANOTACIONES = MostrarFolioHelper.LISTA_ANOTACIONES_MULT_CANCELACION;

                    java.lang.String[] local_SelectedItems = null;

                    local_SelectedItems = (java.lang.String[])session.getAttribute( PAGE_ANOTACIONCANCELADORACREARSTEP1__PARAM_SELECTEDANOTACIONES );
                    if( null == local_SelectedItems ){
                      local_SelectedItems = new java.lang.String[0];
                    }

                    StringBuffer local_SelectedItems_CsvRepresentation = new StringBuffer (1024) ;
                    String local_SelectedElement;
                    // for ( String element : local_SelectedItems )
                    for( int iterator = 0; iterator < local_SelectedItems.length; iterator ++ ){
                      local_SelectedElement = local_SelectedItems[iterator];//(String)iterator.next();
                      local_SelectedItems_CsvRepresentation.append( " " + local_SelectedElement );
                    } // for

                    %>

                    <%= local_SelectedItems_CsvRepresentation.toString() %>
...
--%>
	...
	<%try {
							   ...
							   Date fechaPago=liq.getPago().getFecha();
                              	...
                              	anotacionesModificacionHelper.setAddFechaNumRadicacion(true);
                                /*
                                 * @author      :   Julio Alcázar Rivas
                                 * @change      :   Set de la solitud del turno para verificar en el helper si es de tipo SolicitudCorreccion
                                 * Caso Mantis  :   02359
                                 */
                                anotacionesModificacionHelper.setSolicitud(turno.getSolicitud());
