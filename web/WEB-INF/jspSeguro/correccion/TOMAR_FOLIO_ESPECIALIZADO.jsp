		    ...
		    <input type="hidden" name="<%=WebKeys.ACCION%>" value="TOMAR_FOLIO">		                
              ...
              <table width="100%" class="camposform">
                <tr>
				  ...
				  <td><a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.correccion.AWCorreccion.TOMAR_FOLIO_ESPECIALIZADO%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_tomar_folios.gif" name="Folio" width="150" height="21" border="0" id="Folio"></a></td>                                    
                </tr>
              </table>              
            </form>
