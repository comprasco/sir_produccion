...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
        ...
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
            <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Microfilmaci&oacute;n</td>
    ...
    <br>
	        ...
	        <table width="100%" class="camposform">
	          ...
	          <form name="ENTREGA" method="post" action="correccion.do">
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCorreccion.APROBAR_MICROFILMACION%>">
	          ...
	          <form name="ENTREGA" method="post" action="correccion.do">
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCorreccion.NEGAR_MICROFILMACION%>">            
              <td width="150" align="center"><p>
