...
<script type="text/javascript">
   ...
   var REPORTE_25__SEND_ACTION       = "<%= AWReportes.REPORTE_25__SEND_ACTION %>";
   var REPORTE_25__BACK_ACTION       = "<%= AWReportes.REPORTE_25__BACK_ACTION %>"; // the same

   var REPORTE_25_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_25_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_25_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 25</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe recaudos del d&iacute;a (tiracaja)</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_25__SEND_ACTION%>">

<%--           <table width="100%" class="camposform">
            <tr>
              <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                <td align="left" width="500"><div align="left" >Informe mayores valores ingresados del día xx al día yy</div></td>
                <td width="200">
...
---%>
           ...
           <table width="100%" class="camposform">
           		...
           		<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Pago:</div></td>
                    <td width="200" align="left">
                    <% try {

                      if( null == session.getAttribute( AWReportes.REPORTE_25__PARAM_PAGOFECHA ) ) {
                        session.setAttribute( AWReportes.REPORTE_25__PARAM_PAGOFECHA, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                    textHelper.setNombre(AWReportes.REPORTE_25__PARAM_PAGOFECHA);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(AWReportes.REPORTE_25__PARAM_PAGOFECHA);
			  ...
			  %>
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_25__PARAM_PAGOFECHA%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                ...
                <tr>
                    ...
                    <td width="200" align="left">
			  <% try {
                    circuloHelper.setNombre(AWReportes.REPORTE_25__PARAM_CIRCULONOMBRE);
                  	circuloHelper.setCssClase("camposformtext");
                  	circuloHelper.setId(AWReportes.REPORTE_25__PARAM_CIRCULONOMBRE);
                  	circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.REPORTE_25_LOADUSUARIOSCAJEROSBYCIRCULO+"')\"");
			  ...
			  %>
           		...
           		<tr>
                    ...
                    <% try {
                    	/*TextHelper textHelper = new TextHelper();
                    	textHelper.setNombre(AWReportes.REPORTE_25__PARAM_USUARIONOMBRE);
                  		textHelper.setCssClase("camposformtext");
                  		textHelper.setId(AWReportes.REPORTE_25__PARAM_USUARIONOMBRE);
						textHelper.render(request,out);*/
                    	...
                    	listaHelper.setNombre(AWReportes.REPORTE_25__PARAM_USUARIONOMBRE);
                    	listaHelper.setId(AWReportes.REPORTE_25__PARAM_USUARIONOMBRE);
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_25__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_25__SEND_ACTION );">
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_25__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_25__PARAM_USUARIOLOG%>"
