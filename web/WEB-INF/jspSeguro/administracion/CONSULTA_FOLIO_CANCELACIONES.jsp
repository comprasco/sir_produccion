        ...
        <tr>
		  ...
		  %>	
				...
				while(ia.hasNext()){
					...
					while(ic.hasNext()){
						...
						Anotacion cancelada = cancelacion.getCancelada();
                                                 String orden = "&nbsp;";
                                                if(cancelada.getOrden() == null){
                                                    validacionesSIR.getAnotacionNtcnOrden(cancelada.getIdAnotacion(), cancelada.getIdMatricula());
                                                }else{
                                                    orden = cancelada.getOrden();
                                                }
				...
				%>	
					...
					<td width="50%" class="campositem"><%=orden%></td>
					</tr>
				<%
					}
				}
