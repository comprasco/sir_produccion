...
<script type="text/javascript">
   ...
   var REPORTE_154__SEND_ACTION       = "<%= AWReportes.REPORTE_154__SEND_ACTION %>";
   var REPORTE_154__BACK_ACTION       = "<%= AWReportes.REPORTE_154__BACK_ACTION %>"; // the same

   var REPORTE_154_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_154_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_154_LOADCIRCULOSBYUSUARIO );
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 154</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe de restituci&oacute;n de turnos</td>
           ...
           <table width="100%" class="camposform">
            <tr>
              <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                <td align="left" width="500"><div align="left" >Radicador de minutas por fecha y categoria</div></td>
                <td width="200">
        	...
        	<table width="100%" class="camposform">
               ...
               try {
                    deptoHelper.setNombre(CDepartamento.ID_DEPARTAMENTO);
                  	...
                  	deptoHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.SELECCIONA_ZONA_REGISTRAL_OFICINA_ORIGEN_DTO_154+"')\"");
                 ...
                 <%
                   try {
                    municipioHelper.setNombre(CMunicipio.ID_MUNICIPIO);
                  	...
                  	municipioHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.CONSULTA_OFICINA_ORIGEN_BY_MUNICIPIO__ACTION154+"')\"");
...
<%--                  <tr>
                ...
                try {
                    veredaHelper.setNombre(CVereda.ID_VEREDA);
                  	...
                  	veredaHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.CONSULTA_OFICINA_ORIGEN_POR_VDA_154+"')\"");
           ...
           <table width="100%" class="camposform">
           		<tr>
                    ...
                    try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_154__PARAM_PFECHAINI ) ) {
                        session.setAttribute( AWReportes.REPORTE_154__PARAM_PFECHAINI, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_154__PARAM_PFECHAINI );
	                    textHelper.setNombre( AWReportes.REPORTE_154__PARAM_PFECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_154__PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_154__PARAM_PFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_154__PARAM_PFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_154__PARAM_PFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_154__PARAM_PFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_154__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_154__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_154__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    <td width="155">
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_154__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_154__SEND_ACTION );">
