...
<script type="text/javascript">
   ...
   var REPORTE_131__SEND_ACTION       = "<%= AWReportes.REPORTE_131__SEND_ACTION %>";
   var REPORTE_131__BACK_ACTION       = "<%= AWReportes.REPORTE_XX__BACK_ACTION %>"; // the same
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 131</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_131__SEND_ACTION%>">
 ...
 <table width="100%" class="camposform">
  <tr>
                    ...
                    <td align="left" width="350" colspan="2"><div align="left" >Relacion de documentos correcciones</div>
           ...
           <table width="100%" class="camposform">
           		<tr>
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_131__PARAM_PFECHAINI );
	                    textHelper.setNombre( AWReportes.REPORTE_131__PARAM_PFECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_131__PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_131__PARAM_PFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_131__PARAM_PFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_131__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_131__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_131__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_131__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_131__SEND_ACTION );">
