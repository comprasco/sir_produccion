...
List tipos = (List)application.getAttribute(WebKeys.LISTA_EJES_DIRECCION);
%>
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Administraci&oacute;n de Ejes</td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Agregar Eje </td>
       ...
       <form action="administracionForseti.do" method="POST" name="BUSCAR" id="BUSCAR">
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWAdministracionForseti.ADICIONA_EJE %>" value="<%= AWAdministracionForseti.ADICIONA_EJE  %>">
                 <table width="100%" class="camposform">
                 
                 <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td width="150">C&oacute;digo Del Eje </td>
                    <td>
                    <% try {
                    textHelper.setNombre(CEje.ID_EJE);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CEje.ID_EJE);
			  ...
			  %>
                  ...
                  <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td width="180">Nombre del Eje </td>
                    <td>
                    <% try {
                    textHelper.setNombre(CEje.NOMBRE_EJE);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CEje.NOMBRE_EJE);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionForseti.ADICIONA_EJE%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0">
                    </td>
                    <td width="155">
       ...
       <% 
            ...
            %>          
                <tr>
                  <td>&nbsp;</td>
                  <td class="campositem"><%= dato.getId()+"-"+dato.getValor() %></td>
                  <form action="administracionForseti.do" method="post" name="ELIMINAREJE<%=idEje%>" id="ELIMINAREJE<%=idEje%>">
                  <td align="center">
        				<input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWAdministracionForseti.ELIMINA_EJE %>" value="<%= AWAdministracionForseti.ELIMINA_EJE %>">
	                	<input  type="hidden" name="<%= CEje.ID_EJE %>" id="<%= dato.getId() %>" value="<%= dato.getId() %>">
                  		<a href="javascript:validarEliminacion('<%=idEje%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_mini_eliminar.gif" width="35" height="13" border="0"></a>
                  	</td>
                  	</form>
                </tr>
        <% 
...
function validarEliminacion(nombre) {
    ...
    alert ('Va a eliminar un eje');
	if (confirm('Esta seguro que desea eliminar el eje'))
	{
     
      eval('document.ELIMINAREJE' +nombre + '.submit()');
	}
}
</script>