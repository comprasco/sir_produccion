...
/*	List circulos = (List)application.getAttribute(WebKeys.LISTA_CIRCULOS_REGISTRALES);
	...
	circuloHelper.setTipos(elementos);
        ...
        // ----------------------------------------------------
        // Lista Estatica SubProcesos-Correcciones

        // helper
        ListaElementoHelper local_ListaSubprocesosCorreccionesHelper;
        local_ListaSubprocesosCorreccionesHelper = new ListaElementoHelper();


        // lista de elementos del helper
        java.util.List local_ListaSubprocesosCorrecciones;
        local_ListaSubprocesosCorrecciones = new java.util.ArrayList();

        // crear y adicionar los elementos a una lista temporal

        ElementoLista local_ElementoLista;

        local_ElementoLista = new ElementoLista( "PAGO_MAYOR_VALOR", "PAGO MAYOR VALOR" );
        local_ListaSubprocesosCorrecciones.add( local_ElementoLista );

        local_ElementoLista = new ElementoLista( "ANTIGUO_SISTEMA", "ANTIGUO SISTEMA" );
        local_ListaSubprocesosCorrecciones.add( local_ElementoLista );

        local_ElementoLista = new ElementoLista( "ACTUACIONES_ADMINISTRATIVAS", "ACTUACIONES ADMINISTRATIVAS" );
        local_ListaSubprocesosCorrecciones.add( local_ElementoLista );

        local_ElementoLista = new ElementoLista( "TODOS", "TODOS" );
        local_ListaSubprocesosCorrecciones.add( local_ElementoLista );

        // fijar la lista al helper
        local_ListaSubprocesosCorreccionesHelper.setTipos( local_ListaSubprocesosCorrecciones );
...
<script type="text/javascript">
   ...
   var REPORTE_87__SEND_ACTION       = "<%= AWReportes.REPORTE_87__SEND_ACTION %>";
   var REPORTE_87__BACK_ACTION       = "<%= AWReportes.REPORTE_87__BACK_ACTION %>"; // the same

   var REPORTE_87_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_87_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_87_LOADCIRCULOSBYUSUARIO );
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 87</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Diario de documentos a operativa por correcci&oacute;n (correcciones enviadas a otras dependencias)</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_87__SEND_ACTION%>">
           ...
           <table width="100%" class="camposform">
           	...
           	<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Turno:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_87__PARAM_PFECHA) ) {
                        session.setAttribute( AWReportes.REPORTE_87__PARAM_PFECHA, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_87__PARAM_PFECHA );
	                    textHelper.setNombre( AWReportes.REPORTE_87__PARAM_PFECHA );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_87__PARAM_PFECHA%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
           	...
           	<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Subproceso:</div></td>
                    <td width="250">
                    <%
                    ...
                    try {
                      ...
                      local_ListaSubprocesosCorreccionesHelper.setId( AWReportes.REPORTE_87__PARAM_PESTADO );
                      local_ListaSubprocesosCorreccionesHelper.setNombre( AWReportes.REPORTE_87__PARAM_PESTADO );
	              local_ListaSubprocesosCorreccionesHelper.setCssClase("camposformtext");
	              local_ListaSubprocesosCorreccionesHelper.render(request,out);
			...
			out.println("ERROR " + re.getMessage());
                ...
                <tr>
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_87__PARAM_PNUMPAGINA );
	                    textHelper.setNombre( AWReportes.REPORTE_87__PARAM_PNUMPAGINA );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_87__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_87__SEND_ACTION );">
