    ...
    <td valign="top" bgcolor="#79849B" class="tdtablacentral">
	    <table width="100%" class="camposform">
	      <tr>
            ...
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= WebKeys.ACCION %>" value="<%=  gov.sir.core.web.acciones.administracion.AWConsultaFolio.REGRESAR_INICIO %>">	        
	        <input  type="hidden" name="<%= WebKeys.NOMBRE_PAGINADOR %>" id="<%= WebKeys.NOMBRE_PAGINADOR %>" value="<%= nombrePaginador %>">
	        <input  type="hidden" name="<%= WebKeys.NOMBRE_RESULTADOS_PAGINADOR %>" id="<%= WebKeys.NOMBRE_RESULTADOS_PAGINADOR %>" value="<%= nombreResultado %>">
	        <td>
