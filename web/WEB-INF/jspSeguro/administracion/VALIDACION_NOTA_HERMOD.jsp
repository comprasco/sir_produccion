...
List tipos = (List)application.getAttribute(WebKeys.LISTA_VALIDACIONES_NOTA);
if(tipos == null){
	tipos = new ArrayList();
}
...
List fasesDelProceso = (List)session.getAttribute(AWAdministracionHermod.LISTA_FASES_DE_PROCESO);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Validaci&oacute;n de Notas Informativas </td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=AWAdministracionHermod.ADICIONA_VALIDACION_NOTA%>" value="<%=  AWAdministracionHermod.ADICIONA_VALIDACION_NOTA %>">
			  ...
			  <% try {
                    procesoHelper.setNombre(CProceso.PROCESO_ID);
                  	...
                  	procesoHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWAdministracionHermod.CONSULTA_FASE_PROCESO+"')\"");
			  ...
			  %>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>Identificador de la Respuesta</td>
                    <td>
                    	<% try {
                    textHelper.setNombre(CValidacionNota.VALIDACION_NOTA_RESPUESTA);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CValidacionNota.VALIDACION_NOTA_RESPUESTA);
			  ...
			  %>
                  ...
                  <tr>
                    ...
                    <td width="155">
                    	<input name="imageField" type="image" onClick="cambiarAccion('<%=  AWAdministracionHermod.ADICIONA_VALIDACION_NOTA %>');"   src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0">
                    	</td>
                    <td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
                ...
                for(Iterator iter = tipos.iterator(); iter.hasNext();){
                	ValidacionNota dato = (ValidacionNota)iter.next();
                %>
                <tr>
                  <td>&nbsp;</td>
                  <td class="camposformtext_noCase"><%= dato.getProceso().getNombre()%></td>
                  <td class="campositem"><%=  dato.getIdFase()%></td>
                  <td class="campositem"><%=  dato.getIdRespuesta()%></td>
                  <form action="administracionHermod.do" method="post" name="ELIMINAR" id="ELIMINAR">
                  <td align="center">
        				<input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWAdministracionHermod.ELIMINA_VALIDACION_NOTA %>" value="<%= AWAdministracionHermod.ELIMINA_VALIDACION_NOTA %>">
	                	<input  type="hidden" name="<%= CProceso.PROCESO_ID %>" id="<%= dato.getIdProceso() %>" value="<%= dato.getIdProceso()  %>">
	                	<input  type="hidden" name="<%= CFaseProceso.FASE_PROCESO_ID %>" id="<%= dato.getIdFase() %>" value="<%= dato.getIdFase()  %>">
	                	<input  type="hidden" name="<%= CValidacionNota.VALIDACION_NOTA_RESPUESTA %>" id="<%= dato.getIdRespuesta() %>" value="<%= dato.getIdRespuesta()  %>">
