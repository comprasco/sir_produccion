...
<script type="text/javascript">
	...
	var REPORTE_178__SEND_ACTION = "<%= AWReportes.REPORTE_178__SEND_ACTION%>";
	var REPORTE_178__BACK_ACTION = "<%= AWReportes.REPORTE_178__BACK_ACTION%>";
	var REPORTE_178_LOADCIRCULOS = "<%= AWReportes.REPORTE_178_LOADCIRCULOSBYUSUARIO%>";
</script>
<script type="text/javascript">
...
%>
<script type="text/javascript">
	js_OnEvent("INITIAL_TIME_LOAD", REPORTE_178_LOADCIRCULOS);
</script>
<%
	}
%>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="101%">
				...
				<tr>
					...
					<td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 178</td>
					...
					<td valign="top" bgcolor="#79849B" class="tdtablacentral">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td class="bgnsub">Informe de Turnos Corrección Encabezado</td>
						...
						<form action="reportes.do" method="POST" name="BUSCAR" id="BUSCAR">
							<input type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION%>" value="">
							<input type="hidden" name="<%=AWReportes.REPORTE_178__PARAM_USUARIOLOG%>" id="<%=AWReportes.REPORTE_178__PARAM_USUARIOLOG%>" value="<%=String.valueOf(param_UsuarioSir.getUsername())%>">
							<table width="100%" class="camposform">
								<tr>
									...
									<td width="200">
										<%
										try {
											if (null == session.getAttribute(AWReportes.REPORTE_178__PARAM_PFECHAINI)) {
												session.setAttribute(AWReportes.REPORTE_178__PARAM_PFECHAINI, fechaAct);
											}
											TextHelper textHelper = new TextHelper();
											textHelper.setId(AWReportes.REPORTE_178__PARAM_PFECHAINI);
											textHelper.setNombre(AWReportes.REPORTE_178__PARAM_PFECHAINI);
										...
										%>
										<a href="javascript:NewCal('<%=AWReportes.REPORTE_178__PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
									</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									...
									<td width="200">
										<%
											try {
												if (null == session.getAttribute(AWReportes.REPORTE_178__PARAM_PFECHAFIN)) {
													session.setAttribute(AWReportes.REPORTE_178__PARAM_PFECHAFIN, fechaAct);
												}
												TextHelper textHelper = new TextHelper();
												textHelper.setId(AWReportes.REPORTE_178__PARAM_PFECHAFIN);
												textHelper.setNombre(AWReportes.REPORTE_178__PARAM_PFECHAFIN);
												textHelper.setCssClase("camposformtext");
												textHelper.render(request, out);
											} catch (HelperException re) {
												out.println("ERROR " + re.getMessage());
										...
										%>
										<a href="javascript:NewCal('<%=AWReportes.REPORTE_178__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
									</td>
									<td>&nbsp;</td>
								</tr>
								<tr>
									...
									<td width="200">
										...
										try {
											...
											circuloHelper.setId(AWReportes.REPORTE_178__PARAM_IDCIRCULO);
											circuloHelper.setNombre(AWReportes.REPORTE_178__PARAM_IDCIRCULO);
											circuloHelper.setCssClase("camposformtext");
											circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('" + AWReportes.REPORTE_178_LOADUSUARIOSBYCIRCULO + "')\"");
								...
								<tr>
									...
									<td width="200" align="left">
										...
										try {
											...
											listaHelper.setNombre(AWReportes.REPORTE_178__PARAM_IDUSUARIO);
											listaHelper.setId(AWReportes.REPORTE_178__PARAM_IDUSUARIO);
						...
						<table width="100%" class="camposform">
							<tr>
								<td width="155">
									<a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_178__BACK_ACTION );">
										<img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
									</a>
								</td>
								<td>
									<a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_178__SEND_ACTION );">
