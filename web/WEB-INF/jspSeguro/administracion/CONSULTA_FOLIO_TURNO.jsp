...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
		<%@ include file="CONSULTA_FOLIO_TURNO_TABS.jsp" %> 
    ...
    <td valign="top" bgcolor="#79849B" class="tdtablacentral">
	    <table width="100%" class="camposform">
	      <tr>
            ...
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= WebKeys.ACCION %>" value="<%= gov.sir.core.web.acciones.administracion.AWTrasladoTurno.TERMINA_CONSULTA_MATRICULA %>">	        
	        <td>
