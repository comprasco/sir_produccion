...
List tipos = (List)application.getAttribute(WebKeys.LISTA_TIPOS_TARIFA); 
%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Configuraci&oacute;n Tipo Tarifa HERMOD </td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Agregar Tipo Tarifa </td>
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWAdministracionHermod.ADICIONA_TIPO_TARIFA %>" value="<%= AWAdministracionHermod.ADICIONA_TIPO_TARIFA %>">
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td>
                    	<% try { 
                    textHelper.setNombre(CTipoTarifa.ID_TIPO_TARIFA);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CTipoTarifa.ID_TIPO_TARIFA);
			  ...
			  %>
                 ...
                 <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionHermod.ADICIONA_TIPO_TARIFA%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0">
                    </td>
                    <td>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td class="titulotbcentral">Codigo Tipo de Tarifa</td>
                  <td align="center" class="titulotbcentral"><p>Tipo<br>
                    Tarifas</p>
                  </td>
                  <td align="center" class="titulotbcentral">Tarifas</td>
                </tr>
                
          <% 
                int idTipoTarifa =0;
                for(Iterator iter = tipos.iterator(); iter.hasNext();){
                	TipoTarifa dato = (TipoTarifa)iter.next();
                %>        
                <tr>
                  <td>&nbsp;</td>
                  <td class="campositem"><%=  dato.getIdTipo() %></td>
                  <form action="administracionHermod.do" method="post" name="ELIMINARTIPOTARIFA<%=idTipoTarifa%>" id="ELIMINARTIPOTARIFA<%=idTipoTarifa%>">
                  <td align="center">
        				<input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWAdministracionHermod.ELIMINA_TIPO_TARIFA %>" value="<%= AWAdministracionHermod.ELIMINA_TIPO_TARIFA %>">
	                	<input  type="hidden" name="<%= CTipoTarifa.ID_TIPO_TARIFA %>" id="<%= dato.getIdTipo() %>" value="<%= dato.getIdTipo() %>">
                  		<a href="javascript:validarEliminacion('<%=idTipoTarifa%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_mini_eliminar.gif" width="35" height="13" border="0"></a>
                  </td>
                  </form>
                  <form action="administracionHermod.do" method="post" name="ELIMINAR" id="ELIMINAR">
                  <td align="center">
        				<input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWAdministracionHermod.SELECCIONA_TIPO_TARIFA %>" value="<%= AWAdministracionHermod.SELECCIONA_TIPO_TARIFA %>">
	                	<input  type="hidden" name="<%= CTipoTarifa.ID_TIPO_TARIFA %>" id="<%= dato.getIdTipo() %>" value="<%= dato.getIdTipo() %>">
...
function validarEliminacion(nombre) {
    ...
    alert ('Va a eliminar un Tipo de Tarifa');
	if (confirm('Esta seguro que desea eliminar el Tipo de Tarifa'))
	{
     
      eval('document.ELIMINARTIPOTARIFA' +nombre + '.submit()');
	}
}
</script>