...
<script type="text/javascript">
   ...
   var REPORTE_G03__SEND_ACTION       = "<%= AWReportes.REPORTE_G03__SEND_ACTION %>";
   var REPORTE_G03__BACK_ACTION       = "<%= AWReportes.REPORTE_G03__BACK_ACTION %>"; // the same
   var REPORTE_G03_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_G03_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_G03_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte G03</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe de Turnos en Registro por Fases</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_G03__SEND_ACTION%>">
           ...
           <table width="100%" class="camposform">
			  ...
			  <% try {
                        circuloHelper.setNombre(AWReportes.REPORTE_G03__PARAM_IDCIRCULO);
                  	circuloHelper.setCssClase("camposformtext");
                  	circuloHelper.setId(AWReportes.REPORTE_G03__PARAM_IDCIRCULO);
                  	circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.REPORTE_G03_LOADUSUARIOSBYCIRCULO+"')\"");
			...
			ListaElementoHelper listaHelper = new ListaElementoHelper();
                    	...
                    	listaHelper.setNombre(AWReportes.REPORTE_G03__PARAM_IDUSUARIO);
                    	listaHelper.setId(AWReportes.REPORTE_G03__PARAM_IDUSUARIO);
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_G03__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_G03__PARAM_USUARIOLOG%>"
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_G03__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_G03__SEND_ACTION );">
