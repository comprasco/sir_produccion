...
<%@page import="gov.sir.core.web.helpers.comun.ListarNotasPasadas" %>
...
<%
	...
	if(session.getAttribute(AWAdministracionHermod.LISTA_TURNOS_STRING) != null ||
        	session.getAttribute(AWAdministracionHermod.LISTA_TURNOS) != null)
    	carga = false;
	
	//Boolean t = (Boolean)request.getSession().getAttribute("CARGA_SOLICITAR_AJUSTE");
	//request.getSession().removeAttribute("CARGA_SOLICITAR_AJUSTE");

	//if(request.getSession().getAttribute(WebKeys.EXCEPCION) != null)
    //	carga = false;
	
	//if(t!=null){ 
	//	if(!t.booleanValue()){
	//		carga=t.booleanValue();
	//	}
	//}
...
function cargaInicial() {
	document.BUSCAR.<%= WebKeys.ACCION %>.value = '<%= AWAdministracionHermod.CONSULTA_TURNOS_CALIFICACION%>';
	document.BUSCAR.submit();
}

function submitform(){
	document.BUSCAR.ACCION.value='<%=AWAdministracionHermod.COLOCAR_DESCRIPCION_NOTA_INF%>';
	document.BUSCAR.submit();
}
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Solicitud
            correci&oacute;n calificaci&oacute;n
            </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Lista de turnos calificados</td>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <% try {
	                      ...
	                      tablaHelper.setColCount(4);
	                      tablaHelper.setListName(AWAdministracionHermod.LISTA_TURNOS_STRING);
                          tablaHelper.setContenidoCelda(TablaMatriculaHelper.CELDA_RADIO);//radio button es necesario
	             ...
	             <td>
	                <table width="100%" class="camposform">
	                  ...
	                  <tr>
	                    ...
	                    <td width="15">
	                    	<input name="imageField" type="image" onClick="cambiarAccion('<%= AWAdministracionHermod.SOLICITAR_CORRECCION_CALIFICACION %>');"   src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0">
	                    </td>
	                    <td>
