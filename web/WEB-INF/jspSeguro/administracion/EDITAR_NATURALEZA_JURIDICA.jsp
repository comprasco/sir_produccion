...
List grupos = (List)application.getAttribute(WebKeys.LISTA_GRUPOS_NATURALEZAS_JURIDICAS);
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0"> 
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Editar Tipo Naturaleza Jur&iacute;dica de Anotaciones </td>
                   ...
                   <tr>
                    ...
                    <td>
                    	<%
                         ...
                         String habilCalificacion = (String) session.getAttribute(CNaturalezaJuridica.HABILIDATO_CALIFICACION); %>
					 	 <input type="checkbox" name="<%= CNaturalezaJuridica.HABILIDATO_CALIFICACION %>"  value="checkbox"  <%=habilCalificacion%> >                    		
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                     ...
                     <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionForseti.EDITA_DETALLES_NATURALEZA_JURIDICA%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_guardar_cambios.gif" width="180" height="21" border="0">
                    
                     </td>
                     
                     <td><input  name= "imageField" type="image" onClick="cambiarAccion('<%= AWAdministracionForseti.TERMINA_EDICION_NATURALEZA  %>');"  src="<%=request.getContextPath()%>/jsp/images/btn_volver.gif" width="139" height="21" border="0"></td>
                  </tr>
                </table>
            </form>
            </td>
