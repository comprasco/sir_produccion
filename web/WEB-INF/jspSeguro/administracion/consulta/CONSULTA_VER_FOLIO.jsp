		...
		<tr> 
			...
			<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> 
				<table border="0" cellpadding="0" cellspacing="0">
					<tr> 
					  <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Folios</td>
  ...
  <tr> 
	...
	<br>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
		  ...
		  <td class="campositem">
		  <%= ((folio.getFechaApertura()==null)?"":FechaConFormato.formatear(folio.getFechaApertura(), "dd/MM/yyyy")) %>
		  </td>
		  <td>Radicacion:</td>
		  <td class="campositem">
		  <%  
	  ...
	  <%
		  ...
		  <td class="campositem"> <%= ((folio.getFechaApertura()==null)?"":FechaConFormato.formatear(folio.getFechaApertura(), "dd/MM/yyyy")) %> </td>
		  ...
		  <td>Fecha:</td>
		  <td class="campositem"> <%= (documentoFolio==null)?"&nbsp;&nbsp;&nbsp;&nbsp;":FechaConFormato.formatear(documentoFolio.getFecha(), "dd/MM/yyyy")  %> </td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  </tr>
		  </table>
	...
	<hr class="linehorizontal">
	  ...
	  <%Iterator itAnotacion = folio.getAnotaciones().iterator();
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
				  <tr>
					  ...
					  <td width="211" class="campositem"><%= anotacion.getFechaRadicacion()!=null?FechaConFormato.formatear(anotacion.getFechaRadicacion())+ ", dd/MM/yyyy":"" %></td>
				  ...
				  <%
					...
					String nombreVeredaAnotacion="&nbsp;";
			        String oficinaDocumento="&nbsp;";	        
			        String numeroOficinaOrigen = "&nbsp;";
			        
			        if(documento!=null){
			        	if(documento.getOficinaOrigen()!=null){

			        		oficinaDocumento = (documento.getOficinaOrigen().getNombre()==null)?"&nbsp;":documento.getOficinaOrigen().getNombre();
						    numeroOficinaOrigen = (documento.getOficinaOrigen()==null)?"&nbsp;":documento.getOficinaOrigen().getNumero();
			        		...
			        		if(anotacion.getDocumento().getOficinaOrigen().getVereda()!=null){
			        			if(anotacion.getDocumento().getOficinaOrigen().getVereda().getNombre()!=null){
			        				nombreVeredaAnotacion=anotacion.getDocumento().getOficinaOrigen().getVereda().getNombre();
			        			}
			        		}
			        	}else if(documento.getOficinaInternacional()!=null){
							nombreVeredaAnotacion = documento.getOficinaInternacional();
							...
							if(comentario.indexOf("-")!=-1){
								...
								oficinaDocumento = token.nextToken();
							}else{
								nombreVeredaAnotacion = comentario;
							}
					  	}
			        }
				  ...
				  <tr>
					  ...
					  <td class="campositem"> <%= oficinaDocumento %>  de <%= nombreVeredaAnotacion  %></td>
		...
		<%}%>			
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr> 
			  ...
			  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"> <table border="0" cellpadding="0" cellspacing="0">
				  <tr> 
					<td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">NOTAS</td>
					<td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
  	...
  	<form action="consultas.do" method="post" name="RESULTADO_CONSULTA" id="RESULTADO_CONSULTA">
  		<input type="hidden" name="<%= WebKeys.ACCION  %>" id="<%= AWConsulta.ACCION_SIGUIENTE %>" value="<%= AWConsulta.ACCION_SIGUIENTE %>">
		<input name="back" type="image" onClick="<%=vistaAnterior%>" src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0">
	</form>
						  </td>
							<td width="686">&nbsp;</td>
						</tr>
