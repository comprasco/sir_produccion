...
<%
List tipos = (List)application.getAttribute(WebKeys.LISTA_RESPONSABILIDADES);
TextHelper textHelper = new TextHelper();

ListaElementoHelper rolesHelper = new ListaElementoHelper();
rolesHelper.setTipoMultiple(true); 

ListaElementoHelper gruposRolHelper = new ListaElementoHelper();
...
gruposRolHelper.setTipos(tiposPredios);
*/
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Crear Responsabilidades </td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWAdministracionFenrir.RESPONSABILIDAD_CREAR %>" value="<%= AWAdministracionFenrir.RESPONSABILIDAD_CREAR  %>">
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td>
                    	<% try {
                    textHelper.setNombre(CResponsabilidad.RESPONSABILIDAD_ID );
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CResponsabilidad.RESPONSABILIDAD_ID);
			  ...
			  %>
                  ...
                  <tr>
                    ...
                    <td>
                    	<% try {
                    textHelper.setNombre(CResponsabilidad.RESPONSABILIDAD_NOMBRE );
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CResponsabilidad.RESPONSABILIDAD_NOMBRE);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
                ...
                <tr>
                    ...
                    <td>
                    	<% try {
                    textHelper.setNombre(CResponsabilidad.RESPONSABILIDAD_DESCRIPCION );
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CResponsabilidad.RESPONSABILIDAD_DESCRIPCION);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td>Roles para la Responsabilidad </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
			  ...
			  %> 
               ...
               <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionFenrir.RESPONSABILIDAD_CREAR%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0">
                    </td>
                    <td>
        ...
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn009.gif">&nbsp;</td>
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td class="titulotbcentral">Nombre de la Responsabilidad </td>
                 </tr> 
              <%  
