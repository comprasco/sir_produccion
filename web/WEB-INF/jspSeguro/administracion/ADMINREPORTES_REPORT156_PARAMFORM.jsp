...
<script type="text/javascript">
   ...
   var REPORTE_156__SEND_ACTION       = "<%= AWReportes.REPORTE_156__SEND_ACTION %>";
   var REPORTE_156__BACK_ACTION       = "<%= AWReportes.REPORTE_156__BACK_ACTION %>"; // the same

   var REPORTE_156_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_156_LOADCIRCULOSBYUSUARIO %>"; // the same
</script>
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_156_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 156</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Reporte Turnos Anulados</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_156__SEND_ACTION%>">
           ...
           <table width="100%" class="camposform">
       		...
       		<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Inicio:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_156__PARAM_PTURNOFECHAINICIO ) ) {
                        session.setAttribute( AWReportes.REPORTE_156__PARAM_PTURNOFECHAINICIO, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_156__PARAM_PTURNOFECHAINICIO );
	                    textHelper.setNombre( AWReportes.REPORTE_156__PARAM_PTURNOFECHAINICIO );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_156__PARAM_PTURNOFECHAINICIO%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                ...
                <tr>
                    ...
                    try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_156__PARAM_PTURNOFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_156__PARAM_PTURNOFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_156__PARAM_PTURNOFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_156__PARAM_PTURNOFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_156__PARAM_PTURNOFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_156__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_156__PARAM_PCIRCULONOMBRE );
                ...
                <%/*AHERRENO 19/09/2013
                   *REQ 008_589
                   *SE CAPTURA VALOR PARA EL PARAMETRO REPORTE_156__PARAM_USUARIOLOG PARA ENVIAR AL JASPER*/
                        Usuario usuario = (Usuario)request.getSession().getAttribute(WebKeys.USUARIO);
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_156__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_156__PARAM_USUARIOLOG%>"
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="156">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_156__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_156__SEND_ACTION );">
