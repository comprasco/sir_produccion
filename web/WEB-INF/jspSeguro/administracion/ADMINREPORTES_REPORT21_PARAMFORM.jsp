...
<script type="text/javascript">
   ...
   var REPORTE_21__SEND_ACTION       = "<%= AWReportes.REPORTE_21__SEND_ACTION %>";
   var REPORTE_21__BACK_ACTION       = "<%= AWReportes.REPORTE_21__BACK_ACTION %>"; // the same

   var REPORTE_21_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_21_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_21_LOADCIRCULOSBYUSUARIO );
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 21</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe de devoluciones ingresadas del d&iacute;a xx al d&iacute;a yy</td>
          ...
          <table width="100%" class="camposform">
            <tr>
              <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                <td align="left" width="500"><div align="left" >Informe de devoluciones ingresadas del día xx al yy</div></td>
                <td width="200">
           ...
           <table width="100%" class="camposform">
           		<tr>
                    ...
                    try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAINI ) ) {
                        session.setAttribute( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAINI, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAINI );
	                    textHelper.setNombre( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_21__PARAM_PLIQUIDACIONFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_21__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_21__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_21__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_21__SEND_ACTION );">
