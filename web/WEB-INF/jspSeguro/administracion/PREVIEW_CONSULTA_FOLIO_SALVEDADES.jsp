...
<%
		...
		Folio folio = (Folio) session.getAttribute(WebKeys.FOLIO_AUXILIAR);
		
		if(folio==null){
			folio = new Folio();
		}
		
		List salvAnotacion = (List)session.getAttribute(WebKeys.LISTA_SALVEDADES_ANOTACIONES_PREVIEW);
