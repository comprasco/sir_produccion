...
<%
	...
	variosCiudadanosHelper.setPropertiesHandly(numFilas,tiposIDNatural,tiposPersona,tiposSexo,tiposIDJuridica,gov.sir.core.web.acciones.administracion.AWCrearFolioOficio.AGREGAR_1_REGISTRO_TABLA_CIUDADANOS_EDICION,
																AWCrearFolioOficio.REMOVER_1_REGISTRO_TABLA_CIUDADANOS_EDICION,
																AWCrearFolioOficio.AGREGAR_VARIOS_CIUDADANOS_EDICION,
																AWCrearFolioOficio.ELIMINAR_CIUDADANO_EDICION,
																lciudadanos, AWCrearFolioOficio.VALIDAR_CIUDADANO_EDICION, "ANOTACION");

	//NUMERO DE LA SIGUIENTE ANOTACION
	String pos = (String) session.getAttribute(AWCrearFolioOficio.NUM_ANOTACION_TEMPORAL);
	if(pos == null)
		pos = "1";
...
function eliminarSalvedadAnotacion(text) {
	...
	document.ANOTACION.<%= WebKeys.ACCION %>.value ='<%=AWCrearFolioOficio.ELIMINAR_SALVEDAD_ANOTACION_EDICION%>';
	document.ANOTACION.submit();
}
...
<script type="text/javascript">
   ...
   var ADMINCREARFOLIO_SAVEINFO_STEP2_BACK_ACTION  = "<%= AWCrearFolioOficio.ADMINCREARFOLIO_SAVEINFO_STEP2_BACK_ACTION %>";
   var ADMINCREARFOLIO_SAVEINFO_STEP2_BACK_ACTION_EDIT  = "<%= AWCrearFolioOficio.ADMINCREARFOLIO_SAVEINFO_STEP2_BACK_ACTION_EDIT %>";
  	...
  	<tr>
    	...
    	<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif">
    		<table border="0" cellpadding="0" cellspacing="0">
        		<tr>
          			<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">ADMINISTRACIÓN - CREACIÓN FOLIO - EDICIÓN ANOTACIONES</td>
