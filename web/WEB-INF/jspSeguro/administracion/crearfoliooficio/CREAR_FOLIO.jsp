...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td
					...
					class="titulotbgral">ADMINISTRACIÓN - CREAR FOLIO</td>
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<form action="crearfolioadministracionoficio.do" name="CREAR" id="CREAR" method="post"><input
...
<!-- 					XXXXX  -->
			...
			<tr>
				...
				<td
					background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"></td>
	...
	<!-- Mostrar el campo número de matrícula para agregar la primera vez.	No se muestra si el sistema la genera -->
               <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <li>El campo de matrícula, se usa solo para cargar un folio que fué temporalmente guardado por ésta misma pantalla.
			      <br>
				  <li>Luego de que ingrese los datos del folio, el aplicativo genera el número de matrícula automáticamente.
				  </td>
				  <td>
				  </td>
                </tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="bgnsub">Carga de Folio</td>
					<td width="16" class="bgnsub"><img src="<%=request.getContextPath()%>/jsp/images/ico_matriculas.gif"
					width="16" height="21"></td>
							...
							<tr>
								<td><% try {
										...
										fechaApertura.setFuncion(" onkeypress=\"return valideDate(event,'"+CSolicitudRegistro.CALENDAR_APERTURA+"');\" "
                                                                                        + " onChange=\"fixDate('"+CSolicitudRegistro.CALENDAR_APERTURA+"')\""
							...
							<tr>
								<td><% try {
										...
										fechaRadicacionSalvedad.setFuncion(" onkeypress=\"return valideDate(event,'"+CSalvedadFolio.CALENDAR_RADICACION+"');\" "
                                                                                        + " onChange=\"fixDate('"+CSalvedadFolio.CALENDAR_RADICACION+"')\"  "
                                                                                        + " onBlur=\"javascript:validarFecha()\"" );
