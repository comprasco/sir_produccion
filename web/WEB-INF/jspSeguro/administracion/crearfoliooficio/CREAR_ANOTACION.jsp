...
<%
	...
	variosCiudadanosHelper.setPropertiesHandly(numFilas,tiposIDNatural,tiposPersona,tiposSexo,tiposIDJuridica,gov.sir.core.web.acciones.administracion.AWCrearFolio.AGREGAR_1_REGISTRO_TABLA_CIUDADANOS,
...
function eliminarAnotacionTemporal(text){
	if(confirm("Esta seguro que desea eliminar la anotación")){
		document.getElementById("NUM_A_TEMPORAL").value = text;
		cambiarAccion('ELIMINAR_ANOTACION_TEMPORAL');
	}
}
...
function eliminarSalvedadAnotacion(text) {
	...
	document.ANOTACION.<%= WebKeys.ACCION %>.value ='<%=AWCrearFolio.ELIMINAR_SALVEDAD_ANOTACION%>';
	document.ANOTACION.submit();
}
  	...
  	<tr>
    	...
    	<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif">
    		<table border="0" cellpadding="0" cellspacing="0">
        		<tr>
          			<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">ADMINISTRACIÓN - CREACIÓN FOLIO - INGRESO ANOTACIONES </td>
				...
				<tr>
      				...
      				<td>
						...
						<%
							...
							String msg_EliminarAnotacion;
                            msg_EliminarAnotacion = "Eliminar anotaci&oacute;n";
						...
						%>
							<tr>
								...
								<td width="40" align="center"><a href="admin.crear.anotacion.oficio.view"><img onClick="verAnotacion('ver.anotacion.view?<%=CAnotacion.POSICION%>=<%=i%>','Anotacion','width=900,height=450,scrollbars=yes','<%=i%>')" src="<%=request.getContextPath()%>/jsp/images/btn_mini_verdetalles.gif" border="0" width="35" height="13"></a></td>
								<td width="40" align="center"><a href="javascript:editarAnotacion('<%=i + 1%>')"> <img src="<%=request.getContextPath()%>/jsp/images/btn_mini_editar.gif" border="0" alt="<%=msg_EditAnotacion%>"></a></td>
								<td width="40" align="center"><a href="javascript:eliminarAnotacionTemporal('<%=i + 1%>')"> <img src="<%=request.getContextPath()%>/jsp/images/btn_mini_eliminar.gif" border="0" alt="<%=msg_EliminarAnotacion%>"></a></td>
							</tr>
						<%
								i++;
							}
...
<tr>
            ...
            %></td>
            <td>
            <table  border="0" class="camposform"><tr align="left"><td>Agregar</td></tr><tr align="right"><td><a href="javascript:cambiarAccion('AGREGAR_SALVEDAD_ANOTACION')"><img src="<%=request.getContextPath()%>/jsp/images/btn_short_anadir.gif" name="Folio" width="35" height="25" border="0"></a></td></tr></table>
            </td>
	</tr>
	<tr>
	<td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td class="camposformtext_noCase"><%= salvedadAnotacion.getDescripcion() %></td>


                  <td>
	                	<input  type="hidden" name="<%= CSalvedadAnotacion.ID_SALVEDAD_ANOTACION%>" id="<%= CSalvedadAnotacion.ID_SALVEDAD_ANOTACION %>" value="<%= salvedadAnotacion.getIdSalvedad() %>">
        			...
        			<td valign="top" bgcolor="#79849B" class="tdtablacentral">
        				<table width="100%" class="camposform">
          					<tr>
            					...
            					<td width="150">
                                                  <%--
                                                  <a href="javascript:cambiarAccion('CREAR_CANCELACION')">
                                                    <img src="<%=request.getContextPath()%>/jsp/images/btn_crear_cancelacion.gif" width="159" height="21" border="0" />
                                                  </a>
                                                  --%>

                                                  <%-- SOF:BUTTON --%>

                                                    <a href="javascript:js_OnEvent( 'ANOTACION', ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP0_NEXT_ACTION );">
                                                     <img alt="[execute]"   src="<%=request.getContextPath()%>/jsp/images/btn_crear_cancelacion.gif" width="159" height="21" border="0" />
                                                    </a>
                                                  <%-- EOF:BUTTON --%>
	...
	<tr>
    	...
    	<td class="tdtablaanexa02">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <td width="50">
                    <a href="javascript:js_OnEvent( 'ANOTACION', ADMINCREARFOLIO_SAVEINFO_STEP2_BACK_ACTION );">
                  ...
                  <%-- EOF:BUTTON --%>
            					...
            					<td width="140"><a href="javascript:cambiarAccion('<%=AWCrearFolioOficio.GUARDAR_FOLIO%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_guardar.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>
            					...
            					<td width="140"><a href="javascript:cambiarAccion('<%=AWCrearFolio.IMPRIMIR_HOJA_DE_RUTA%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_imprimir.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>
            					<td width="140"><a href="javascript:cambiarAccion( '<%=gov.sir.core.web.acciones.administracion.AWCrearFolio.CANCELAR_CREACION%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_eliminar.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>
            					<td>&nbsp;</td>
          					</tr>
        				</table>
        			</td>
