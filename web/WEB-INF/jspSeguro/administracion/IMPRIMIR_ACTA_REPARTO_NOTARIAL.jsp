...
<%
	...
	String matricula = "";
	if(session.getAttribute(AWImpresionRepartoNotarial.IMPRESION_ACTA_EJECUTADA) != null){ 
		impresionOK = true;
		matricula = (String)session.getAttribute(CTurno.ID_TURNO);
		session.removeAttribute(CTurno.ID_TURNO);
		session.removeAttribute(AWImpresionRepartoNotarial.IMPRESION_ACTA_EJECUTADA);
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        ...
        <input type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWImpresionRepartoNotarial.IMPRIMIR_ACTA%>" value="<%= AWImpresionRepartoNotarial.IMPRIMIR_ACTA %>">
         ...
         <%
            ...
            %>  
              <tr>
               <td width="20"></td>
               <td >Se realizó satisfactoriamente la impresión del acta.</td>
             </tr>
            <%
            }
            %>         
        ...
        <table width="100%" class="camposform">
           		<tr>
                    ...
                    <td allign="left" width="250">N&uacute;mero del Reparto:</td>
                  <td width="80">
                    <% try {
      ...
      -->	   
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWImpresionRepartoNotarial.IMPRIMIR_ACTA%>');"  src="<%=request.getContextPath()%>/jsp/images/btn_reimprimir.gif" width="150" height="21" border="0">
                    </td>
                    <td>
...
<%if(recarga){%>
	<script>
		cambiarAccionSubmit('<%=AWImpresionRepartoNotarial.OBTENER_IMPRESORAS_CIRCULO_ACTA_REPARTO%>');
	</script>
<%}%>
