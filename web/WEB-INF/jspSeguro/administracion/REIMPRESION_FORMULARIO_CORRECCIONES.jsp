  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Reimpresi&oacute;n del Formulario de Correcciones</td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reimpresi&oacute;n del Formulario de Correciones</td>
           ...
           <table width="100%" class="camposform">
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionHermod.IMPRESION_FORMULARIOS_CORRECCIONES%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_reimprimir.gif" width="150" height="21" border="0">
                    </td>
                   	 <td>
...
<%if(recarga){%>
	<script>
		cambiarAccionSubmit('<%=AWAdministracionHermod.OBTENER_IMPRESORAS_CIRCULO_CORRECCIONES%>');
	</script>
<%}%>
