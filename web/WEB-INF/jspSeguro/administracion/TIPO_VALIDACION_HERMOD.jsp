...
<%@page import="gov.sir.core.negocio.modelo.constantes.CValidacion" %>
<%@page import="org.auriga.core.web.HelperException" %>


<%
TextHelper textHelper = new TextHelper();
List tipos = (List)application.getAttribute(WebKeys.LISTA_VALIDACIONES);
%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Administraci&oacute;n Tipos de Validaci&oacute;n </td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Agregar Tipo de Validaci&oacute;n </td>
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWAdministracionHermod.ADICIONA_TIPO_VALIDACION %>" value="<%= AWAdministracionHermod.ADICIONA_TIPO_VALIDACION %>">
                <table width="100%" class="camposform">
                  <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td width="120">Identificador</td>
                    <td>
                    	<% try {
                    textHelper.setNombre(CValidacion.VALIDACION_ID);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CValidacion.VALIDACION_ID);
			  ...
			  %>
                  ...
                  <tr>
                    ...
                    <td>
                    	<% try {
                    textHelper.setNombre(CValidacion.VALIDACION_NOMBRE);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(CValidacion.VALIDACION_NOMBRE);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionHermod.ADICIONA_TIPO_VALIDACION%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0">
                    </td>
                    <td>
