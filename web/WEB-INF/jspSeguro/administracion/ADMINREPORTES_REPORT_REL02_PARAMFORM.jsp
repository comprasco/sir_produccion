...
<%@page import="gov.sir.core.negocio.modelo.constantes.CFaseProceso" %>
...
/*	if(session.getAttribute(AWAdministracionForseti.LISTA_CIRCULOS_ELEMENTO)==null){
		...
		for (Iterator iter = circulos.iterator(); iter.hasNext();) {
			Circulo circulo = (Circulo) iter.next();
			listaCirculos.add(new ElementoLista(circulo.getIdCirculo(), circulo.getNombre()));
		}
	...
	List usuarioPorCirculoRol = (List)session.getAttribute(AWReportes.USUARIOS_CONSULTAR_POR_CIRCULO);

	if(usuarioPorCirculoRol == null){
		usuarioPorCirculoRol = new ArrayList();
	}

	ListaElementoHelper usuariosCirculoHelper = new ListaElementoHelper();
	usuariosCirculoHelper.setTipos( usuarioPorCirculoRol );
...
<script type="text/javascript">
   ...
   var REPORTE_REL02__SEND_ACTION       = "<%= AWReportes.REPORTE_REL02__SEND_ACTION %>";
   var REPORTE_REL02__BACK_ACTION       = "<%= AWReportes.REPORTE_REL02__BACK_ACTION %>"; // the same

   var REPORTE_REL02_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_REL02_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_REL02_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte Rel 02</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Relaciones creadas por usuario y por fecha</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_REL02__SEND_ACTION%>">
           <table width="100%" class="camposform">
                <tr>
					...
					try {
                    	circuloHelper.setNombre(CCirculo.ID_CIRCULO);
                  		...
                  		circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.USUARIOS_CONSULTAR_POR_CIRCULO_REL02+"')\"");
                  ...
                  <tr>
                    ...
                    <%
                    try {
                    	usuariosCirculoHelper.setNombre(CUsuario.ID_USUARIO);
                  		usuariosCirculoHelper.setCssClase("camposformtext");
                  		usuariosCirculoHelper.setId(CUsuario.ID_USUARIO);
						usuariosCirculoHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
					}
                  ...
                  <tr>
                    ...
                    <% try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_REL02__PARAM_PAGOFECHAINI ) ) {
                        session.setAttribute( AWReportes.REPORTE_REL02__PARAM_PAGOFECHAINI, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                    textHelper.setNombre(AWReportes.REPORTE_REL02__PARAM_PAGOFECHAINI);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(AWReportes.REPORTE_REL02__PARAM_PAGOFECHAINI);
			  ...
			  %>
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_REL02__PARAM_PAGOFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                ...
                <tr>
                    ...
                    <% try {
                      ...
                      if( null == session.getAttribute( AWReportes.REPORTE_REL02__PARAM_PAGOFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_REL02__PARAM_PAGOFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                    textHelper.setNombre(AWReportes.REPORTE_REL02__PARAM_PAGOFECHAFIN);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(AWReportes.REPORTE_REL02__PARAM_PAGOFECHAFIN);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_REL02__PARAM_PAGOFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
            ...
            <table width="100%" class="camposform">
              <tr>
                <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                    <td width="155">
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_REL02__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_REL02__SEND_ACTION );">
