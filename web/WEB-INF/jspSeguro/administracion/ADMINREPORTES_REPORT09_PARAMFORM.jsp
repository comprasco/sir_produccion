...
<script type="text/javascript">
   ...
   var REPORTE_09__SEND_ACTION       = "<%= AWReportes.REPORTE_09__SEND_ACTION %>";
   var REPORTE_09__BACK_ACTION       = "<%= AWReportes.REPORTE_09__BACK_ACTION %>"; // the same

   var REPORTE_09_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_09_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_09_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 09</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Diario radicador de documentos del d&iacute;a xx</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_09__SEND_ACTION%>">

<%--
  <table width="100%" class="camposform">
   <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                    <td align="left" width="150"><div align="left" >Diario radicador de documentos del d&iacute;a xx</div></td>
                    <td width="200">
                    </td>
                  <td>&nbsp;</td>
   </tr>
...
--%>
           ...
           <table width="100%" class="camposform">
           		...
           		<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Radicaci&oacute;n:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_09__PARAM_PTURNOFECHA ) ) {
                        session.setAttribute( AWReportes.REPORTE_09__PARAM_PTURNOFECHA, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_09__PARAM_PTURNOFECHA );
	                    textHelper.setNombre( AWReportes.REPORTE_09__PARAM_PTURNOFECHA );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_09__PARAM_PTURNOFECHA%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
...
<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >No. de Página:</div></td>
                    <td width="200">
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_09__PARAM_PNUMPAGINA );
	                    textHelper.setNombre( AWReportes.REPORTE_09__PARAM_PNUMPAGINA );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_09__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_09__PARAM_PCIRCULONOMBRE );
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_09__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_09__PARAM_USUARIOLOG%>"
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_09__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_09__SEND_ACTION );">
