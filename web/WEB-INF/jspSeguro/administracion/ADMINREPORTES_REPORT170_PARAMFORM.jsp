...
<script type="text/javascript">
    ...
    var REPORTE_170_SEND_ACTION       = "<%= AWReportes.REPORTE_170_SEND_ACTION %>";
    var REPORTE_170_BACK_ACTION       = "<%= AWReportes.REPORTE_170_BACK_ACTION %>"; // the same
    var REPORTE_170_LOADCIRCULOS = "<%= AWReportes.REPORTE_170_LOADCIRCULOS %>"; // the same
...
%>
<script type="text/javascript">
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_170_LOADCIRCULOS );
</script>
<%
  }
%>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 170</td>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Turnos de Reparto Notarial en un Rango de Fecha</td>
                  ...
                  <form action="reportes.do" method="POST" name="BUSCAR" id="BUSCAR">
                      <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="">
                      <input  type="hidden" name="<%=AWReportes.REPORTE_170_PARAM_USUARIOLOG %>" id="<%=AWReportes.REPORTE_170_PARAM_USUARIOLOG %>" value="<%=String.valueOf(param_UsuarioSir.getUsername()) %>">
                      ...
                      <table width="100%" class="camposform">
                            <tr>
                                ...
                                <td width="200">
                                    <%
                                        try {
                                            if( null == session.getAttribute( AWReportes.REPORTE_170_PARAM_PFECHAINI ) ) {
                                                session.setAttribute( AWReportes.REPORTE_170_PARAM_PFECHAINI, fechaAct );
                                            }
                                            TextHelper textHelper = new TextHelper();
                                            textHelper.setId( AWReportes.REPORTE_170_PARAM_PFECHAINI );
                                            textHelper.setNombre( AWReportes.REPORTE_170_PARAM_PFECHAINI );
                                    ...
                                    %>
                                    <a href="javascript:NewCal('<%=AWReportes.REPORTE_170_PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td width="200">
                                    <%
                                        try {
                                            if( null == session.getAttribute( AWReportes.REPORTE_170_PARAM_PFECHAFIN ) ) {
                                                session.setAttribute( AWReportes.REPORTE_170_PARAM_PFECHAFIN, fechaAct );
                                            }
                                            TextHelper textHelper = new TextHelper();
                                            textHelper.setId( AWReportes.REPORTE_170_PARAM_PFECHAFIN );
                                            textHelper.setNombre( AWReportes.REPORTE_170_PARAM_PFECHAFIN );
                                            textHelper.setCssClase("camposformtext");
                                            textHelper.render(request,out);
                                        }catch(HelperException re){
                                            out.println("ERROR " + re.getMessage());
                                    ...
                                    %>
                                    <a href="javascript:NewCal('<%=AWReportes.REPORTE_170_PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td width="200">
                                    <%
                                        try {
                                            ...
                                            circuloHelper.setId( AWReportes.REPORTE_170_PARAM_IDCIRCULO );
                                            circuloHelper.setNombre( AWReportes.REPORTE_170_PARAM_IDCIRCULO );
                                            ...
                                            circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.REPORTE_170_LOADCIRCULOS+"')\"");
                ...
                <table width="100%" class="camposform">
                    <tr>
                        <td width="155">
                            <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_170_BACK_ACTION );">
                                <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
                            </a>
                        </td>
                        <td>
                            <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_170_SEND_ACTION );">
