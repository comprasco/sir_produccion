        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Administración de Causales de Restituci&oacute;n de Reparto Notarial</td>
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=   AWAdministracionHermod.ADICIONA_CAUSAL_RESTITUCION %>" value="<%= AWAdministracionHermod.ADICIONA_CAUSAL_RESTITUCION %>">
			  ...
			  %>
                  ...
                  <tr>
                     <td>    </td>
                     <td>    </td>
                     <td width="300"> El sistema generará el código automáticamente </td> 
                  </tr>
                  <tr>
...
function validarEliminacion(nombre) {
    ...
    if (confirm('Esta seguro que desea activar / desactivar el Causal de Restitución'))
	{
