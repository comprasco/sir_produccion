          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td background="<%= request.getContextPath()%>/jsp/images/sub_bgn001.gif" class="bgnsub"> Turno Devolución</td>
              ...
              <table width="100%" class="camposform">
                ...
                <tr>
                    <td>&nbsp;</td>
                     <td>Turno con el que se radicó la Solicitud de Devolución</td>
                     <td> 
                     <% try {
