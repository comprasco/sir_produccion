...
<script type="text/javascript">
   ...
   var REPORTE_93__SEND_ACTION       = "<%= AWReportes.REPORTE_93__SEND_ACTION %>";
   var REPORTE_93__BACK_ACTION       = "<%= AWReportes.REPORTE_93__BACK_ACTION %>"; // the same

   var REPORTE_93_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_93_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_93_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 93</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe de documentos pendientes (por usuario)</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_93__SEND_ACTION%>">
                ...
                <tr>
					...
					try {
                    	circuloHelper.setNombre(CCirculo.ID_CIRCULO);
                  		...
                  		circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.USUARIOS_CONSULTAR_POR_CIRCULO_ROL+"')\"");
            ...
            <table width="100%" class="camposform">
              <tr>
                <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                    <td width="155">
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_93__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_93__SEND_ACTION );">
