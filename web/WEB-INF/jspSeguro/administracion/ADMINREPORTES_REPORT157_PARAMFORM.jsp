...
<script type="text/javascript">
   ...
   var REPORTE_157__SEND_ACTION       = "<%= AWReportes.REPORTE_157__SEND_ACTION %>";
   var REPORTE_157__BACK_ACTION       = "<%= AWReportes.REPORTE_157__BACK_ACTION %>";

   var REPORTE_157_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_157_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_157_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 157</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Diario desanotador de certificados del d&iacute;a OTRAS ORIPS</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_157__SEND_ACTION%>">
          <table width="100%" class="camposform">
           	<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha :</div></td>
                    <td width="200">
                    <%
                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_157__PARAM_PTURNOFECHA ) ) {
                        session.setAttribute( AWReportes.REPORTE_157__PARAM_PTURNOFECHA, fechaAct );
                      }
                    	TextHelper textHelper = new TextHelper();
                        textHelper.setId( AWReportes.REPORTE_157__PARAM_PTURNOFECHA );
	                    textHelper.setNombre( AWReportes.REPORTE_157__PARAM_PTURNOFECHA );
			  		...
			  		%>
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_157__PARAM_PTURNOFECHA%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				  </td>
                  <td>&nbsp;</td>
            </tr>
           		...
           		<tr>
                    ...
                    <%
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_157__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_157__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_157__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_157__SEND_ACTION );">
                ...
                <%/*AHERRENO 28/08/2012
                   *REQ 020_453
                   *SE CAPTURA VALOR PARA EL PARAMETRO REPORTE_157__PARAM_USUARIOLOG PARA ENVIAR AL JASPER*/
                        Usuario usuario = (Usuario)request.getSession().getAttribute(WebKeys.USUARIO);
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_157__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_157__PARAM_USUARIOLOG%>"
