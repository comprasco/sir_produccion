...
function confirmar(text) {
	if(confirm('¿Esta seguro que desea anular el turno?')){
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Anulación de Turnos</td>
    ...
    <td class="tdtablaanexa02">
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" value="<%=  AWTrasladoTurno.ANULAR_TURNO%>">
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td>
               		...
               		<% 
	               		try {
	               			anulacionHelper.setNombre(CTurno.OBSERVACIONES_ANULACION);
	               			anulacionHelper.setId(CTurno.OBSERVACIONES_ANULACION);
                ...
                <table width="100%" class="camposform">
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td class="campostip04">Cuando Termine de Anular los Turnos haga click en <b>Volver</b>.</td>
                  </tr>
                </table>
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
						<a href="javascript:confirmar('<%=  AWTrasladoTurno.ANULAR_TURNO%>')">                    
                      		<img src="<%=request.getContextPath()%>/jsp/images/btn_anular.gif" width="139" height="21" border="0" id="banular"/>
                    	</a>
                    	</td>
                    <td>
