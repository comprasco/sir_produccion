...
<script type="text/javascript">
   ...
   var REPORTE_04__SEND_ACTION       = "<%= AWReportes.REPORTE_04__SEND_ACTION %>";
   var REPORTE_04__BACK_ACTION       = "<%= AWReportes.REPORTE_04__BACK_ACTION %>";

   var REPORTE_04_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_04_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_04_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_04__SEND_ACTION%>">
  ...
  --%>
           ...
           <table width="100%" class="camposform">
           	<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Desanotaci&oacute;n Inicio:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACION ) ) {
                        session.setAttribute( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACION, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                          textHelper.setId( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACION );
	                  textHelper.setNombre( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACION );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_04__PARAM_PFECHADESANOTACION%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				  </td>
                  <td>&nbsp;</td>

                </tr>
                <!--AHERRENO 11/04/2011
                    Se agrega campo Fecha desanotacion Fin-->
           	<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Desanotaci&oacute;n Fin:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACIONFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACIONFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                          textHelper.setId( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACIONFIN );
	                  textHelper.setNombre( AWReportes.REPORTE_04__PARAM_PFECHADESANOTACIONFIN );
	                    textHelper.setCssClase("camposformtext");
                            textHelper.render(request,out);
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_04__PARAM_PFECHADESANOTACIONFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				  </td>
                  <td>&nbsp;</td>
                 ...
                 <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >P&aacute;gina:</div></td>
                    <td width="200">
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_04__PARAM_PNUMPAGINA );
	                    textHelper.setNombre( AWReportes.REPORTE_04__PARAM_PNUMPAGINA );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_04__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_04__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_04__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_04__SEND_ACTION );">
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_04__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_04__PARAM_USUARIOLOG%>"
