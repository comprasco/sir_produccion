...
<%
	Rol rol=(Rol)request.getSession().getAttribute(AWAdministracionFenrir.CONSULTAR_ROL_EDITAR);
	if (rol!=null){
		request.getSession().setAttribute(CRol.ID_ROL, rol.getRolId());
		request.getSession().setAttribute(CRol.ROL_NOMBRE, rol.getNombre());
		request.getSession().setAttribute(CRol.ROL_DESCRIPCION, rol.getDescripcion());
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWAdministracionFenrir.EDITAR_ROL  %>" value="<%= AWAdministracionFenrir.EDITAR_ROL   %>">
			  ...
			  %>
               ...
               <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionFenrir.EDITAR_ROL%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_guardar_cambios.gif" width="180" height="21" border="0">
                    </td>
                    <td>
                    	<input name="imageField" type="image" onClick="cambiarAccion('<%=AWAdministracionFenrir.VOLVER_EDITAR_ROL %>');"  src="<%=request.getContextPath()%>/jsp/images/btn_volver.gif" width="139" height="21" border="0">
                    </td>
                  </tr>
                </table>
             </FORM>   
