...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reimpresi&oacute;n
                  	de Certificados de Pertenencia</td>
        ...
        <input type="hidden" name="<%= WebKeys.ACCION %>" id="<%=  AWImpresionFolio.IMPRIMIR_CERTIFICADO_PERTENENCIA%>" value="<%= AWImpresionFolio.IMPRIMIR_CERTIFICADO_PERTENENCIA %>">
         ...
         <%
            ...
            %>  
              <tr>
               <td width="20"></td>
               <td >Se realizó satisfactoriamente la impresión del certificado de pertenencia <%= matricula %></td>
             </tr>
            <%
            }
            %>         
			 ...
			 <td width="80">
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    <input name="imageField" type="image" onClick="cambiarAccion('<%=AWImpresionFolio.IMPRIMIR_CERTIFICADO_PERTENENCIA%>');"  src="<%=request.getContextPath()%>/jsp/images/btn_reimprimir.gif" width="150" height="21" border="0">
                    </td>
                    <td>
...
<%if(recarga){%>
	<script>
		cambiarAccionSubmit('<%=AWImpresionFolio.OBTENER_IMPRESORAS_CIRCULO_CERTIFICADO_PERTENENCIA%>');
	</script>
<%}%>
</body>
