...
List tipos = (List)session.getAttribute(CCertificado.CERTIFICADO_LISTA_ENTREGAR_MASIVO);
if(tipos == null){
	tipos = new ArrayList();
}
...
function cambiarSeleccion() {
    if(document.ELIMINAR.seleccionado.checked == true){
	    setAllCheckBoxes('ELIMINAR', 'PRUEBA', true);
    }
    if(document.ELIMINAR.seleccionado.checked == false){
    	setAllCheckBoxes('ELIMINAR', 'PRUEBA', false);
    }
}

function alertar() {
	var elem=document.ELIMINAR.PRUEBA
	var selec=0
	...
	var conf=confirm("Usted ha seleccionado "+selec+" certificados")
	if (conf==true){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Entrega Masiva de Certificados</td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Entrega Masiva de Certificados</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Tipos de Notas</td>
        ...
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%=AWAdministracionHermod.CONSULTA_TURNOS_CER_ENTREGA_POR_FECHA %>" value="<%=  AWAdministracionHermod.CONSULTA_TURNOS_CER_ENTREGA_POR_FECHA %>">
                <table width="100%" class="camposform">
                  <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td width="220">Fecha de los Turnos a Entregar</td>
                    <td>
               <% try {
				...
				%>
                      <a href="javascript:NewCal('calendar','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="16" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>')"></a>               
                    </td>
                  </tr>
                </table>
                <table width="100%" class="camposform">
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td class="campostip04">Cuando termine de hacer la entrega masiva de certificados haga click en aceptar. </td>
                  </tr>
                </table>
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    	<input name="imageField" type="image" onClick="cambiarAccion('<%=  AWAdministracionHermod.CONSULTA_TURNOS_CER_ENTREGA_POR_FECHA%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_buscar.gif" width="139" height="21" border="0">
                    	</td>
                    <td>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
                ...
                <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWAdministracionHermod.ENTREGA_MASIVA_CERTIFICADOS %>" value="<%= AWAdministracionHermod.ENTREGA_MASIVA_CERTIFICADOS %>">
                <tr>
                ...
                <tr>
	              <td>&nbsp;</td>
                  <td class="titulotbcentral">Turno</td>
                  <td width="50" align="center">Seleccionar</td>
                </tr>
                 <% 
                ...
                <tr>
                  ...
                  <td class="campositem"><input name="<%= CTurno.ID_TURNO %>" value="<%= dato.getIdWorkflow()%>"  type="checkbox" id="PRUEBA"   >
                  </td>
                </tr>
                <% 
                 }
                 ...
                 <td>&nbsp;</td>
                  ...
                  <td align='right'>Todos: <input type="checkbox" name="seleccionado" onclick='cambiarSeleccion()'></td> 
                 </tr>
                 <tr>
                 <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td width="50" align="center"><a href="javascript:alertar();"><img src="<%=request.getContextPath()%>/jsp/images/btn_entregar.gif" width="139" height="21" border="0"></a></td>
                </tr>
                 </form>
            </table>
            </td>
