...
<%
	...
	List fasesDelProceso = (List)session.getAttribute(AWReportes.LISTA_FASES_DE_PROCESO);
	if(fasesDelProceso == null){
		fasesDelProceso = new ArrayList();
	}
	ListaElementoHelper fasesProcesoHelper = new ListaElementoHelper();
	fasesProcesoHelper.setTipos(fasesDelProceso);
...
<script type="text/javascript">
   ...
   var REPORTE_81__SEND_ACTION       = "<%= AWReportes.REPORTE_81__SEND_ACTION %>";
   var REPORTE_81__BACK_ACTION       = "<%= AWReportes.REPORTE_XX__BACK_ACTION %>"; // the same
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 81</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Reporte Generico de Relaci&oacute;n</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_81__SEND_ACTION%>">
           <table width="100%" class="camposform">
                <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Proceso: </div></td>
                    <td width="200">
			  		<%
					try {
                    	procesoHelper.setNombre(CProceso.PROCESO_ID);
                  		...
                  		procesoHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.CONSULTA_FASE_PROCESO+"')\"");
                  ...
                  <tr>
                    ...
                    <%
                    try {
                    	fasesProcesoHelper.setNombre(CFaseProceso.FASE_PROCESO_ID);
                  		fasesProcesoHelper.setCssClase("camposformtext");
                  		fasesProcesoHelper.setId(CFaseProceso.FASE_PROCESO_ID);
						fasesProcesoHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
					}
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_81__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_81__PARAM_PCIRCULONOMBRE );
           		...
           		<tr>
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_81__PARAM_PFECHAINI );
	                    textHelper.setNombre( AWReportes.REPORTE_81__PARAM_PFECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_81__PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Fin:</div></td>
                    <td width="200">
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_81__PARAM_PFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_81__PARAM_PFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_81__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
						<input name="imageField" type="image" onClick="cambiarAccion('<%=AWReportes.TERMINA2  %>');"  src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0">
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_81__SEND_ACTION );">
