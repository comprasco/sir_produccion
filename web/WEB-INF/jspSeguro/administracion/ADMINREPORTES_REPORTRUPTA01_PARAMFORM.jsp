...
<meta name="Author" content="ADA S.A" />
...
<script type="text/javascript">
    ...
    var REPORTE_RUPTA01__SEND_ACTION       = "<%= AWReportes.REPORTE_RUPTA01__SEND_ACTION%>";
    var REPORTE_RUPTA01__BACK_ACTION       = "<%= AWReportes.REPORTE_RUPTA01__BACK_ACTION%>";

    var REPORTE_RUPTA01_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_RUPTA01_LOADCIRCULOSBYUSUARIO%>"; // the same
...
<script type="text/javascript">
    ...
    js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_RUPTA01_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="101%">
                ...
                <tr>
                    ...
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <!-- AHERRENO -->
                                <!-- Se actualizo esta línea ya que cuando se hacia el llamado del reporte RUPTA01 se desplegaba en el encabezado Reporte 04 -->
                                <!--td background="<!--%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 04</td-->
                                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">RUPTA01</td>
                ...
                <tr>
                    ...
                    <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <!-- AHERRENO -->
                                <!-- Se actualizo esta línea ya que cuando se hacia el llamado del reporte RUPTA01 se desplegaba en el encabezado Diario desanotador de documentos del día -->
                                <!--td class="bgnsub">Diario desanotador de documentos del d&iacute;a</td-->
                                <td class="bgnsub">Informe Estadistico RUPTA01</td>
                        ...
                        <form action="reportes.do" method="POST" name="BUSCAR" id="BUSCAR">
                            <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION%>" value="<%=AWReportes.REPORTE_RUPTA01__SEND_ACTION%>">
  ...
  <tr>
                    ...
                    <td align="left" width="150"><div align="left" >Diario desanotador de documentos del d&iacute;a</div></td>
                    <td width="200">
                                    ...
                                    <td width="200">
                                        <%
                                            ...
                                            try {
                                                ...
                                                if (null == session.getAttribute(AWReportes.REPORTE_RUPTA01__PARAM_PFECHA)) {
                                                    session.setAttribute(AWReportes.REPORTE_RUPTA01__PARAM_PFECHA, fechaAct);
                                                }

                                                TextHelper textHelper = new TextHelper();
                                                textHelper.setId(AWReportes.REPORTE_RUPTA01__PARAM_PFECHA);
                                                textHelper.setNombre(AWReportes.REPORTE_RUPTA01__PARAM_PFECHA);
                                        ...
                                        <a href="javascript:NewCal('<%=AWReportes.REPORTE_RUPTA01__PARAM_PFECHA%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                                    </td>
                                    <td>&nbsp;</td>

                                </tr>
<!-- AHERRENO 03/05/2010
    Se agrega Condición de busqueda Fecha Fin de Radicación
-->
                <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Final Radicaci&oacute;n:</div></td>
                    <td width="200" align="left">
                    <% try {

                      if( null == session.getAttribute( AWReportes.REPORTE_RUPTA01__PARAM_PFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_RUPTA01__PARAM_PFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
                    textHelper.setNombre(AWReportes.REPORTE_RUPTA01__PARAM_PFECHAFIN);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(AWReportes.REPORTE_RUPTA01__PARAM_PFECHAFIN);
					textHelper.render(request,out);
					}
					catch(HelperException re){
						out.println("ERROR " + re.getMessage());
			  ...
			  %>
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_RUPTA01__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				  ...
				  <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td width="200">
                                        ...
                                        try {
                                            circuloHelper.setId(AWReportes.REPORTE_RUPTA01__PARAM_PCIRCULONOMBRE);
                                            circuloHelper.setNombre(AWReportes.REPORTE_RUPTA01__PARAM_PCIRCULONOMBRE);
                            ...
                            <table width="100%" class="camposform">
                                <tr>
                                    ...
                                    <td width="155">
                                        ...
                                        <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_RUPTA01__BACK_ACTION );">
                                            <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
                                        </a>
                                    </td>
                                    <td>

                                        <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_RUPTA01__SEND_ACTION );">
