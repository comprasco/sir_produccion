...
<script type="text/javascript">
   ...
   var REPORTE_155__SEND_ACTION       = "<%= AWReportes.REPORTE_155__SEND_ACTION %>";
   var REPORTE_155__BACK_ACTION       = "<%= AWReportes.REPORTE_155__BACK_ACTION %>"; // the same

   var REPORTE_155_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_155_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_155_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 155</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Reparto a Calificaci&oacute;n</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_155__SEND_ACTION%>">
           ...
           <table width="100%" class="camposform">
      		...
      		<tr>
                    ...
                    <td align="left" width="150"><div align="right" >No. Reparto:</div></td>
                    <td width="200" align="left">
                    <% try {
                    	TextHelper textHelper = new TextHelper();
                    textHelper.setNombre(AWReportes.REPORTE_155__PARAM_PROCESOREPARTO);
                  	textHelper.setCssClase("camposformtext");
                  	textHelper.setId(AWReportes.REPORTE_155__PARAM_PROCESOREPARTO);
                ...
                <tr>
                    ...
                    <td width="200" align="left">
			  <% try {
                    circuloHelper.setNombre(AWReportes.REPORTE_155__PARAM_CIRCULONOMBRE);
                  	circuloHelper.setCssClase("camposformtext");
                  	circuloHelper.setId(AWReportes.REPORTE_155__PARAM_CIRCULONOMBRE);
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_155__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_155__SEND_ACTION );">
