...
<script type="text/javascript">
   ...
   var REPORTE_15__SEND_ACTION       = "<%= AWReportes.REPORTE_15__SEND_ACTION %>";
   var REPORTE_15__BACK_ACTION       = "<%= AWReportes.REPORTE_15__BACK_ACTION %>"; // the same

   var REPORTE_15_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_15_LOADCIRCULOSBYUSUARIO %>"; // the same
</script>
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_15_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 15</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe cuentas por pagar devoluciones (d&iacute;a xx al d&iacute;a yy)</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_15__SEND_ACTION%>">
<%--
          <table width="100%" class="camposform">
            <tr>
              <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                <td align="left" width="500"><div align="left" >Informe cuentas por pagar devoluciones (del d&iacute;a xx al d&iacute;a yy)</div></td>
                <td width="200">
...
--%>
           ...
           <table width="100%" class="camposform">
           		<tr>
                    ...
                    <td align="left" width="150"><div align="right" >Fecha Inicial de aprobaci&oacuten pago:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAINI ) ) {
                        session.setAttribute( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAINI, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                textHelper.setId( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAINI );
	                textHelper.setNombre( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Final de aprobaci&oacuten pago:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_15__PARAM_PLIQUIDFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_15__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_15__PARAM_PCIRCULONOMBRE );
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_15__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_15__PARAM_USUARIOLOG%>"
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_15__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_15__SEND_ACTION );">
