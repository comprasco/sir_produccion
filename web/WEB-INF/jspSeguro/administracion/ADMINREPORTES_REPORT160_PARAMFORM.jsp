...
<script type="text/javascript">
   ...
   var REPORTE_160__SEND_ACTION         = "<%= AWReportes.REPORTE_160__SEND_ACTION %>";
   var REPORTE_160__BACK_ACTION          = "<%= AWReportes.REPORTE_160__BACK_ACTION %>"; // the same
   var REPORTE_160_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_160_LOADCIRCULOSBYUSUARIO %>"; // the same
</script>
...
%>
	<script type="text/javascript">
	  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_160_LOADCIRCULOSBYUSUARIO );
	</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 160</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Turnos calificados</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_160__SEND_ACTION%>">
           ...
           <table width="100%" class="camposform">
           		<tr>
                    ...
                    <%try {
                    		if( null == session.getAttribute( AWReportes.REPORTE_160__PARAM_PTURNOFECHA_INI ) )
                            	session.setAttribute( AWReportes.REPORTE_160__PARAM_PTURNOFECHA_INI, fechaAct );
		                    TextHelper textHelper = new TextHelper();
		                    textHelper.setNombre(AWReportes.REPORTE_160__PARAM_PTURNOFECHA_INI);
		                  	textHelper.setCssClase("camposformtext");
		                  	textHelper.setId(AWReportes.REPORTE_160__PARAM_PTURNOFECHA_INI);
							textHelper.render(request,out);
					}catch(HelperException re){
						out.println("ERROR " + re.getMessage());
					}%>
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_160__PARAM_PTURNOFECHA_INI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha Ini" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				    </td>
				    <td>&nbsp;</td>
                </tr>
           		...
           		<tr>
                    ...
                    <td width="200" align="left">
                    <%try {
                    		if( null == session.getAttribute( AWReportes.REPORTE_160__PARAM_PTURNOFECHA_FIN ) )
                            	session.setAttribute( AWReportes.REPORTE_160__PARAM_PTURNOFECHA_FIN, fechaAct );
		                    TextHelper textHelper = new TextHelper();
		                    textHelper.setNombre(AWReportes.REPORTE_160__PARAM_PTURNOFECHA_FIN);
		                  	textHelper.setCssClase("camposformtext");
		                  	textHelper.setId(AWReportes.REPORTE_160__PARAM_PTURNOFECHA_FIN);
							textHelper.render(request,out);
					}catch(HelperException re){
						out.println("ERROR " + re.getMessage());
					}%>
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_160__PARAM_PTURNOFECHA_FIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha Fin" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
				    </td>
				    <td>&nbsp;</td>
                </tr>                
                ...
                <tr>
                    ...
                    <td width="200" align="left">
			  <% try {
                    circuloHelper.setNombre(AWReportes.REPORTE_160__PARAM_PCIRCULONOMBRE);
                  	circuloHelper.setCssClase("camposformtext");
                  	circuloHelper.setId(AWReportes.REPORTE_160__PARAM_PCIRCULONOMBRE);
                  	circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.REPORTE_160_LOADUSUARIOSCAJEROSBYCIRCULO+"')\"");
			  ...
			  %>
           		...
           		<tr>
                    ...
                    <% try {
        	            	...
        	            	listaHelper.setNombre(AWReportes.REPORTE_160__PARAM_PUSUARIO_CALIFICADOR);
            	        	listaHelper.setId(AWReportes.REPORTE_160__PARAM_PUSUARIO_CALIFICADOR);
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_160__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_160__SEND_ACTION );">
