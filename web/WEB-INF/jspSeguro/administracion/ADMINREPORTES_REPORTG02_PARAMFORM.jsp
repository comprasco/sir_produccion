...
<script type="text/javascript">
   ...
   var REPORTE_G02__SEND_ACTION       = "<%= AWReportes.REPORTE_G02__SEND_ACTION %>";
   var REPORTE_G02__BACK_ACTION       = "<%= AWReportes.REPORTE_G02__BACK_ACTION %>"; // the same

   var REPORTE_G02_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_G02_LOADCIRCULOSBYUSUARIO %>"; // the same
...
<script type="text/javascript">
  ...
  js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_G02_LOADCIRCULOSBYUSUARIO );
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="tdtablaanexa02">
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte G02</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Informe de Turnos por Calificador</td>
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_G02__SEND_ACTION%>">

           <table width="100%" class="camposform">
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Inicial Reparto:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_G02__PARAM_FECHAINI ) ) {
                        session.setAttribute( AWReportes.REPORTE_G02__PARAM_FECHAINI, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_G02__PARAM_FECHAINI );
	                    textHelper.setNombre( AWReportes.REPORTE_G02__PARAM_FECHAINI );
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_G02__PARAM_FECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Fecha Final Reparto:</div></td>
                    <td width="200">
                    <%

                    try {

                      if( null == session.getAttribute( AWReportes.REPORTE_G02__PARAM_FECHAFIN ) ) {
                        session.setAttribute( AWReportes.REPORTE_G02__PARAM_FECHAFIN, fechaAct );
                      }

                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_G02__PARAM_FECHAFIN );
	                    textHelper.setNombre( AWReportes.REPORTE_G02__PARAM_FECHAFIN );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
					...
					<a href="javascript:NewCal('<%=AWReportes.REPORTE_G02__PARAM_FECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
			  ...
			  <% try {
                        circuloHelper.setNombre(AWReportes.REPORTE_G02__PARAM_IDCIRCULO);
                  	circuloHelper.setCssClase("camposformtext");
                  	circuloHelper.setId(AWReportes.REPORTE_G02__PARAM_IDCIRCULO);
                  	/**
                        * @Autor: Santiago Vásquez
                        * @Change: 2028.AJUSTE REPORTES 166, 167 y G02
                        * Eliminar la opción de usuario
                        */
                        //circuloHelper.setFuncion("onChange=\"cambiarAccionAndSend('"+AWReportes.REPORTE_G02_LOADUSUARIOSBYCIRCULO+"')\"");
			  ...
			  %>
                 ...
                 */
           		<tr>
                    ...
                    <td width="200" align="left">
                         <%//if(request.getSession().getAttribute(AWReportes.USUARIOS_CONSULTAR_POR_CIRCULO)!=null){
                     %>
                    <% /*try {

			ListaElementoHelper listaHelper = new ListaElementoHelper();
                    	listaHelper.setTipos((List)request.getSession().getAttribute(AWReportes.USUARIOS_CONSULTAR_POR_CIRCULO));
                    	listaHelper.setNombre(AWReportes.REPORTE_G02__PARAM_IDUSUARIO);
                    	listaHelper.setId(AWReportes.REPORTE_G02__PARAM_IDUSUARIO);
                ...
                %>
                	<input  type="hidden" name="<%=AWReportes.REPORTE_G02__PARAM_USUARIOLOG%>"
                	id="<%=AWReportes.REPORTE_G02__PARAM_USUARIOLOG%>"
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_G02__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_G02__SEND_ACTION );">
