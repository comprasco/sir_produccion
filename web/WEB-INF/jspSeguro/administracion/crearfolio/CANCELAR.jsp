...
<%
	...
	String checkAnotaciones = (String) request.getSession().getAttribute(WebKeys.CHECK_ANOTACION_TEMPORAL_MOSTRAR_FOLIO_HELPER);
	if (checkAnotaciones != null  && checkAnotaciones.equals("true"))
	{
	...
	String vistaActual;
        ...
        // Bug 05165
	String nomFormaCancelacion = LOCAL_CHECKBOXCONTROLLER_CONTROLEDFIELD_TARGET0_FORMID;
...
<script type="text/javascript">
	...
	var actionField     = "<%= WebKeys.ACCION    %>";
        ...
        var ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_BACK_ACTION = "<%= AWCrearFolio.ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_BACK_ACTION %>"; // the same
        var ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_NEXT_ACTION = "<%= AWCrearFolio.ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_NEXT_ACTION %>"; // the same
        // @see guardar() ???
...
<%-- --%>
			   ...
			   <%try{
			   			...
			   			mFolio.setNombreAccionFolio("crearfolioadministracion.do");
			   			mFolio.setNombreAccionPaginador("paginadorAnotaciones.do");
			   			mFolio.setNombreAncla("ancla");

                                                // bug 05165 ---------------
			   			mFolio.setNombreForma( LOCAL_CHECKBOXCONTROLLER_CONTROLEDFIELD_TARGET1_FORMID );
			   			...
			   			mFolio.setNombreAccionCancelacion("crearfolioadministracion.do");
			   			...
			   			mFolio.NoMostrarEncabezado();
                                                ...
                                                // bug 05165 -----------
			   			mFolio.mostrarAnotacionesCancelacioMultiple(AWCrearFolio.ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_NEXT_ACTION ); // AWCalificacion.GUARDAR_ANOTACIONES_TEMPORALES
			   			// mFolio.mostrarAnotacionesCancelacioMultiple(AWCalificacion.GUARDAR_ANOTACIONES_TEMPORALES);
                                                // -----------------------


                                                // para habilitar bug 05165 -------------------------------------------------------------------------------------------------
                ...
                <form action="crearfolioadministracion.do" method="post" name="CANCELAR" id="CANCELAR">
...
--%>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140">
                    <a href="javascript:js_OnEvent_Proxy1( 'CANCELAR', ADMINCREARFOLIO_SAVEINFO_ANOTACIONCANCELADORACREARSTEP1_BACK_ACTION );">
                      <img src="<%=request.getContextPath()%>/jsp/images/btn_seguir.gif" name="Folio" width="139" height="21" border="0" id="Folio" alt="[next]"/>
                    </a>
                  </td>
                  <td>
                    <a href="javascript:cambiarAccion('CANCELAR_CANCELACION');">
                      <img src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif" name="Folio" width="139" height="21" border="0" id="Folio" alt="[back]"/>
                    </a>
                  </td>
...
<script type="text/javascript">
  ...
  if( !( ( undefined == window.local_CheckBoxControllerEnabled )
	...
	local_CheckBoxController.onLoad( LOCAL_CHECKBOXCONTROLLER_CUMULATEDVALUES, true);
        ...
        // alert( 'ckeckboxctl' + local_CheckBoxController );
