  ...
  <tr>
   ...
   <tr>
    ...
    <td valign="top" bgcolor="#79849B" class="tdtablacentral">
	    <form action="crearfolioadministracion.do" method="POST" name="BUSCAR" id="BUSCAR">
	    <table width="100%" class="camposform">
	       ...
	       <tr>
                ...
                <td width="30">&nbsp;</td>
                <td >&nbsp;</td>
                <td class="titulotbcentral">EL FOLIO <%=folio!=null?folio.getIdMatricula():"NO"%> HA SIDO GRABADO </td>
		         <td>
