...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<form action="crearfolioadministracion.do" method="post" name="ANOTACION" id="ANOTACION">
  	...
  	<tr>
    	...
    	<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif">
    		<table border="0" cellpadding="0" cellspacing="0">
        		<tr>
          			<td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">ADMINISTRACIÓN - GRABACIÓN FOLIO - INGRESO ANOTACIONES </td>
      				...
      				<td>
						...
						%>
							<tr>
								...
								<td width="40" align="center"><a href="admin.crear.anotacion.view"><img onClick="verAnotacion('ver.anotacion.view?<%=CAnotacion.POSICION%>=<%=i%>','Anotacion','width=900,height=450,scrollbars=yes','<%=i%>')" src="<%=request.getContextPath()%>/jsp/images/btn_mini_verdetalles.gif" border="0" width="35" height="13"></a></td>
    	...
    	<td class="tdtablaanexa02">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <%-- EOF:BUTTON --%>
            					...
            					<td width="140">&nbsp;</td>
            					<td width="140"><a href="javascript:cambiarAccion( '<%=gov.sir.core.web.acciones.administracion.AWCrearFolio.CANCELAR_CREACION%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>
            					<td>&nbsp;</td>
          					</tr>
        				</table>
        			</td>
