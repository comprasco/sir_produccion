...
<%
    /*AHERRENO 09/04/2013
      ...
      SE RELIZA CAMBIO DEL CARGUE DEL LISTADO DE CIRCULOS*/
...
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>
<%-- para manejo de formularios a traves de js    (2005-09-15)   --%>
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>
...
<script type="text/javascript">
   ...
   LocalForm.prototype.setFormTarget = function( formTarget ) {
	 formObject = findObj( this.formName );
     formObject.target = formTarget;
   }
...
<script type="text/javascript">
   ...
   var REPORTE_01__SEND_ACTION       = "<%= AWReportes.REPORTE_01__SEND_ACTION %>";
   var REPORTE_01__BACK_ACTION       = "<%= AWReportes.REPORTE_01__BACK_ACTION %>";
   var REPORTE_01_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_01_LOADCIRCULOSBYUSUARIO %>";
</script>
<%-- + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + --%>
...
<script type="text/javascript">
   ...
   function js_OnEvent_TargetBlank( formName, actionValue ) {

     var htmlForm;
     htmlForm = new LocalForm( formName );
     htmlForm.setFormTarget( '_blank' );
     htmlForm.setValue( actionField, actionValue );
     htmlForm.submitForm();
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="101%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reporte 01</td>
          ...
          <tr>
            ...
            <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="bgnsub">Acta de reparto notarial</td>
...
>
  <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="" />
        ...
        <script type="text/javascript">
          ...
          js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_01_LOADCIRCULOSBYUSUARIO );
        ...
        <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION %>" value="<%=AWReportes.REPORTE_01__SEND_ACTION%>">

           <table width="100%" class="camposform">
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Id-Reparto Notarial:</div></td>
                    <td width="40">
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_01__PARAM_IDREPARTONOTARIAL);
	                    textHelper.setNombre( AWReportes.REPORTE_01__PARAM_IDREPARTONOTARIAL );
                  ...
                  <td>&nbsp;</td>
           		...
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Nombre Coordinador:</div></td>
                    <td width="40">
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_01__PARAM_VNOMBRECOORD );
	                    textHelper.setNombre( AWReportes.REPORTE_01__PARAM_VNOMBRECOORD );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
           		...
           		<tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td align="left" width="150"><div align="right" >Ciudad:</div></td>
                    <td width="40" >
                    <%
                    ...
                    try {
                    	...
                    	TextHelper textHelper = new TextHelper();
	                  	textHelper.setId( AWReportes.REPORTE_01__PARAM_VCIUDAD );
	                    textHelper.setNombre( AWReportes.REPORTE_01__PARAM_VCIUDAD );
	                  	textHelper.setCssClase("camposformtext");
						textHelper.render(request,out);
					}
					catch(HelperException re){
                ...
                <tr>
                    ...
                    try {
	                  	circuloHelper.setId( AWReportes.REPORTE_01__PARAM_PCIRCULONOMBRE );
	                    circuloHelper.setNombre( AWReportes.REPORTE_01__PARAM_PCIRCULONOMBRE );
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
	                    ...
	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_01__BACK_ACTION );">
	                     <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
	                    </a>
                    </td>
                    <td>

	                    <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_01__SEND_ACTION );">
