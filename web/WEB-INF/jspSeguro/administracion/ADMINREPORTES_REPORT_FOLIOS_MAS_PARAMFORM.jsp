...
<script type="text/javascript">
    ...
    var REPORTE_FOLIOS_MAS__SEND_ACTION       = "<%= AWReportes.REPORTE_FOLIOS_MAS__SEND_ACTION%>";
    var REPORTE_FOLIOS_MAS__BACK_ACTION       = "<%= AWReportes.REPORTE_FOLIOS_MAS__BACK_ACTION%>"; // the same

    var REPORTE_FOLIOS_MAS_LOADCIRCULOSBYUSUARIO = "<%= AWReportes.REPORTE_FOLIOS_MAS_LOADCIRCULOSBYUSUARIO%>"; // the same
...
<script type="text/javascript">
    ...
    js_OnEvent( "INITIAL_TIME_LOAD", REPORTE_FOLIOS_MAS_LOADCIRCULOSBYUSUARIO );
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="101%">
                ...
                <tr>
                    ...
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Radicador Matriculas Masivas Antiguo Sistema</td>
                ...
                <tr>
                    ...
                    <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="bgnsub">Radicador Matriculas Masivas Antiguo Sistema</td>
                        ...
                        <form action="reportes.do" method="POST" name="BUSCAR" id="BUSCAR">
                            <input  type="hidden" name="<%=WebKeys.ACCION%>" id="<%=WebKeys.ACCION%>" value="<%=AWReportes.REPORTE_FOLIOS_MAS__SEND_ACTION%>">

                            <%---
<table width="100%" class="camposform">
  <tr>
                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15" alt="[]" /></td>
                    <td align="left" width="150"><div align="left" >Diario Radicador de Matriculas</div></td>
                    <td width="200">
                  ...
                  <td>&nbsp;</td>
                            ...
                            <table width="100%" class="camposform">
                                <tr>
                                    ...
                                    <td align="left" width="160"><div align="right" >Fecha Inicio Creaci&oacute;n Folio:</div></td>
                                    <td width="200">
                                        <%

        try {

            if (null == session.getAttribute(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAINI)) {
                session.setAttribute(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAINI, fechaAct);
            }

            TextHelper textHelper = new TextHelper();
            textHelper.setId(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAINI);
            textHelper.setNombre(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAINI);
            ...
            out.println("ERROR " + re.getMessage());
                                        ...
                                        <a href="javascript:NewCal('<%=AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAINI%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha Inicial" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                                ...
                                <tr>
                                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                                    <td align="left" width="160"><div align="right" >Fecha Fin Creaci&oacute;n Folio:</div></td>
                                    <td width="200">
                                        <%

        try {

            if (null == session.getAttribute(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAFIN)) {
                session.setAttribute(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAFIN, fechaAct);
            }

            TextHelper textHelper = new TextHelper();
            textHelper.setId(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAFIN);
            textHelper.setNombre(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAFIN);
            textHelper.setCssClase("camposformtext");
            textHelper.render(request, out);
        } catch (HelperException re) {
            out.println("ERROR " + re.getMessage());
                                        ...
                                        <a href="javascript:NewCal('<%=AWReportes.REPORTE_FOLIOS_MAS__PARAM_PFECHAFIN%>','ddmmmyyyy',true,24)"><img src="<%=request.getContextPath()%>/jsp/images/ico_calendario.gif" alt="Fecha Final" width="15" height="21" border="0" onClick="javascript:Valores('<%=request.getContextPath()%>/')"></a>
                                ...
                                <tr>
                                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                                    <td align="left" width="160"><div align="right" >P&aacute;gina:</div></td>
                                    <td width="200">
                                        <%
        ...
        try {
            ...
            TextHelper textHelper = new TextHelper();
            textHelper.setId(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PPAGINA);
            textHelper.setNombre(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PPAGINA);
            textHelper.setCssClase("camposformtext");
            textHelper.render(request, out);
        } catch (HelperException re) {
            out.println("ERROR " + re.getMessage());
                                ...
                                <tr>
                                    <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                                    <td align="left" width="160"><div align="right" >C&iacute;rculo Registral:</div></td>
                                    <td width="200">
                                        <%

        try {
            circuloHelper.setId(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PCIRCULONOMBRE);
            circuloHelper.setNombre(AWReportes.REPORTE_FOLIOS_MAS__PARAM_PCIRCULONOMBRE);
                            ...
                            <table width="100%" class="camposform">
                                <tr>
                                    ...
                                    <td width="155">
                                        ...
                                        <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_FOLIOS_MAS__BACK_ACTION );">
                                            <img alt="regresar"   src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" width="139" height="21" border="0" />
                                        </a>
                                    </td>
                                    <td>

                                        <a href="javascript:js_OnEvent( 'BUSCAR', REPORTE_FOLIOS_MAS__SEND_ACTION );">
