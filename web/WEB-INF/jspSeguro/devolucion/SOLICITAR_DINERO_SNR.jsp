...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">SOLICITUD DINEROS SNR</td>
    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%= request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"> <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%= request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Confirmar Dinero Disponible</td>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
				   ...
				   if (solAnterior instanceof SolicitudRegistro)
				    {
				       ...
				       if (listaLiqsAnt != null)
				       {
				          ...
				          if (liqAnterior != null)
				          {
				               valorDerechos = liqAnterior.getValorDerechos()+"";
				               valorImpuestos = liqAnterior.getValorImpuestos()+"";
				               valorTotal = liqAnterior.getValor()+"";
				          }
				       }
				    %>
                      <tr>
				...
				<%if (solAnterior instanceof SolicitudCertificado)
				    {
				       ...
				       if (listaLiqsAnt != null)
				       {
				          ...
				          if (liqAnterior != null)
				          {
				               valorTotal = liqCertAnt.getValor()+"";
				          }
				       }
				    %>
                  <tr>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140"><input name="imageField" type="image" src="<%= request.getContextPath()%>/jsp/images/btn_aprobar.gif" width="139" height="21" border="0"></td>
				  </form>
				  <td>&nbsp;</td>
                </tr>
              </table>
