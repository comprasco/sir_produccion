    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Apelaci&oacute;n</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
            ...
            <form action="devolucion.do" method="post" name="RESULTADO_CONSULTA" id="RESULTADO_CONSULTA">
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWDevolucion.APELACION_CONFIRMAR %>" value="<%= AWDevolucion.APELACION_CONFIRMAR %>">
            ...
            <form action="devolucion.do" method="post" name="RESULTADO_CONSULTA" id="RESULTADO_CONSULTA">
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWDevolucion.APELACION_NEGAR %>" value="<%= AWDevolucion.APELACION_NEGAR %>">
