    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Reposici&oacute;n</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" class="camposform">
            <tr>
                                           ...
                                           <form action="devolucion.do" method="post" name="kk" id="kk">
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWDevolucion.REPOSICION_CONFIRMAR %>" value="<%= AWDevolucion.REPOSICION_CONFIRMAR %>">
                <td width="150" align="center"><p>
                   <input name="imageField" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="150" height="21" border="0">
                 </td>
             </form>


                             <form action="devolucion.do" method="post" name="kk" id="kk">
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWDevolucion.REPOSICION_NEGAR %>" value="<%= AWDevolucion.REPOSICION_NEGAR %>">
                <td width="150" align="center"><p>
