...
function cambiarAccion(text) {
	...
	if(text == "<%=AWDevolucion.DEVOLVER_SIN_RECURSOS%>"){
		op = confirm("Desea realizar devolución sin Recurso.\nDesea continuar?");
	}
	if(text == "<%=AWDevolucion.FINALIZAR_SIN_RECURSOS%>"){
		op = confirm("Desea finalizar sin recurso.\nDesea continuar?");
	}
	
	if(text == "<%=AWDevolucion.ESPERAR_INTERPONER_RECURSOS %>"){
		op = confirm("Desea realizar la espera de recursos .\nDesea continuar?");
	}
	if(op){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Notificar Ciudadano</td>
    ...
    <td class="tdtablaanexa02">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"> <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Datos Resoluci&oacute;n</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
                <td width="20" align="center" valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn002.gif">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
        ...
        <tr>
		  ...
		  <form name="ENTREGA" method="post" action="devolucion.do">
              <table width="100%" class="camposform">
                <tr>
                  <td width="20"><img src="<%= request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                  <td>Actualizar Número</td>
                  <td>&nbsp;</td>
                </tr>
                <tr>

                  <td>&nbsp;</td>
                  <td>N&uacute;mero de la resolución:</td>

                  	<td>
                 	<% try {

                          TextHelper textHelper = new TextHelper();
                				textHelper.setNombre(AWDevolucion.RESOLUCION_NUMERO);
                  			   	textHelper.setCssClase("camposformtext");
                  			   	textHelper.setId(AWDevolucion.RESOLUCION_NUMERO);
              ...
              <table width="100%" class="camposform">
                <tr> 
				  ...
				  <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWDevolucion.ESPERAR_INTERPONER_RECURSOS%>">
                  
		          <a href="javascript:cambiarAccion('<%=AWDevolucion.ESPERAR_INTERPONER_RECURSOS%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_espera_recursos.gif" width="185" height="21" border="0"/></a>
		          <a href="javascript:cambiarAccion('<%=AWDevolucion.DEVOLVER_SIN_RECURSOS%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_devolver_sin_recurso.gif" width="185" height="21" border="0"/></a>		                  				 
		          <a href="javascript:cambiarAccion('<%=AWDevolucion.FINALIZAR_SIN_RECURSOS%>');"><img  src="<%=request.getContextPath()%>/jsp/images/btn_finalizar_sin_recurso.gif"  width="185" height="21" border="0"/></a>		                  
