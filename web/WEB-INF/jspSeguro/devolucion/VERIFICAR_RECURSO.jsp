...
lista.setId(WebKeys.ACCION);
lista.setNombre(WebKeys.ACCION);
List posibilidades = new Vector();
posibilidades.add(new ElementoLista(AWDevolucion.APELACION_RECURSO,"Recurso de Apelación"));
posibilidades.add(new ElementoLista(AWDevolucion.REPOSICION_RECURSO,"Recurso de Reposición"));
posibilidades.add(new ElementoLista(AWDevolucion.NO_RECURSO,"No existe recurso"));
lista.setTipos(posibilidades);


// TurnoHistoria actual
        ...
        while (iter.hasNext()) {
            ...
            if (tH.getFase().equals(faseActual)) {
                activo = tH;
                break;
            }
        }
...
Date fechaNotificacion = activo.getFecha();
    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Notificaci&oacute;n al ciudadano</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
            ...
            <tr>
              ...
              <table width="100%" class="camposform">
                <tr>
                  <td width="20"><img src="<%= request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                  <td>&iquest; Cuando se notificó al ciudadano ?</td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>El ciudadano fue notificado el día </td>
                            ...
                            fechaH.setDate(fechaNotificacion);
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Interposici&oacute;n de recurso</td>
                <td width="9"><img name="tabla_central_r1_c3" src="<%=request.getContextPath()%>/jsp/images/tabla_central_r1_c3.gif" width="9" height="29" border="0" alt=""></td>
                <td width="20" align="center" valign="top" background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn002.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="<%=request.getContextPath()%>/jsp/images/ico_reimpresion.gif" width="16" height="21"></td>
        ...
        <tr>
		  ...
		  <form name="ENTREGA" method="post" action="devolucion.do">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="12"><img name="sub_r1_c1" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c1.gif" width="12" height="22" border="0" alt=""></td>
                  <td background="<%=request.getContextPath()%>/jsp/images/sub_bgn001.gif" class="bgnsub"> Recurso </td>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140"><input name="imageField" type="image" src="<%= request.getContextPath()%>/jsp/images/btn_enviar_caso.gif" width="139" height="21" border="0"></td>
