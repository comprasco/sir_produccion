...
<script type="text/javascript" >
   ...
   function js_ConfirmMessage( message ) {
	...
	function js_CambiarAccionConfirm( actionKey, confirmMessage ) {
		if( js_ConfirmMessage( confirmMessage ) ) {
			cambiarAccion( actionKey );
		}
	}
...
<!-- REGION:BLOCK (EOF) -->
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
                ...
                <tr>
                  <!--
                     ...
                     Cambio del texto "Valor Total Liquidado" por "Valor Total Liquidado Ajustado a la Centena por Actos"
                  -->
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="150">
                  	<a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.fotocopia.AWPagoFotocopia.ACEPTAR%>');">
                  		<img src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" 
                  			width="139" height="21" border="0" />
                  	</a>
                  </td>
                  ...
                  <td>&nbsp;</td>
                  <td width="50">
                  	<a href="javascript:js_CambiarAccionConfirm('<%=gov.sir.core.web.acciones.fotocopia.AWPagoFotocopia.CANCELAR%>', 'Est\u00e1 seguro que desea cancelar el turno?' );">
                  		<img src="<%=request.getContextPath()%>/jsp/images/btn_negar.gif" width="139" height="21" border="0" />
                  	</a>
                  </td>
                  <!-- 
                  <td colspan="2"></td>
