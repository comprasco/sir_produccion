<%@page import="org.auriga.core.web.*,gov.sir.core.web.helpers.comun.EstacionesHelper" %>
<% EstacionesHelper estacionesHelper = new EstacionesHelper(); %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td background="<%= request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Selecci&oacute;n de Estacion para <%=((org.auriga.core.modelo.transferObjects.Rol)session.getAttribute(gov.sir.core.web.WebKeys.ROL)).getNombre()%></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablas">
              ...
              <tr>
                <td><img src="<%= request.getContextPath()%>/jsp/images/img_estacion_02.jpg" width="450" height="150"></td>
              </tr>
            </table>
