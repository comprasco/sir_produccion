...
<%@page import = "gov.sir.core.web.acciones.comun.AWAdminNotas"%>
<%
...
function submitform(){
	document.NOTAS_INF.ACCION.value='<%=AWAdminNotas.COLOCAR_DESCRIPCION%>';
	document.NOTAS_INF.submit();
}
function regresar(){
	document.NOTAS_INF.ACCION.value='<%=AWAdminNotas.REGRESAR%>';
	document.NOTAS_INF.submit();
}
function imprimirNotaInformativa(posicion){
	document.NOTAS_INF.ACCION.value='<%=AWAdminNotas.IMPRIMIR_NOTA_INFORMATIVA%>';
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
         ...
         <form action="adminnotas.do" method="post" name="NOTAS_INF" id="NOTAS_INF">
         <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=gov.sir.core.web.acciones.comun.AWAdminNotas.AGREGAR_NOTA%>">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="100%" class="camposform">
                <tr> 
    			  ...
    			  <td ><a href='javascript:regresar();'><img name="imageField" src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif"   width="139" height="21" border="0" ></a></td>
