...
<meta name="Keywords" content="inicio, sesion, login, password, clave, usuario, user">
    ...
    <%
        Integer numFases = (Integer)request.getAttribute(WebKeys.NUM_FASES);
        request.removeAttribute(WebKeys.NUM_FASES);
        
    %>
    <script>
	
    <%
        if(numFases!=null && numFases.intValue()==1){
    %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tdAnexo02">
        <tr>
        <td width="450"><img src="<%= request.getContextPath()%>/jsp/images/img_fase.jpg" height="150"></td>
