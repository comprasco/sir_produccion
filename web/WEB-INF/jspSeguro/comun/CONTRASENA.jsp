...
<form >
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	 ...
	 <tr> 
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Mesa de Ayuda</td>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Informaci&oacute;n</td>
    ...
    <table width="100%" class="camposform">
		 ...
		 <tr>
                    ...
                    <td width="120"><span class="Estilo7"><%= dato.getCodigo() %>:</span></td>
					 
                    <td><span class="Estilo6"><%=dato.getValor()%></span></td>
                </tr>
				  <%}%>
    </table>
    </td>
  ...
  <tr>
	  <td colspan="4">
	    <div align="right"><a href="javascript:cerrarVentana()"><img src="<%=request.getContextPath()%>/jsp/images/btn_cerrar_ventana.gif" width="150" height="21" border="0"></a></div></td>
    </tr>
  </table>
</form>