...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
        ...
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
            <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Impresión de Folios Extensos</td>
  ...
  <br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
              <tr>
              <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Opciones de impresion especial</td>
...
<!--
    ...
    <%
        List anotaciones = folio.getAnotaciones(); 
      	if(!((Anotacion) anotaciones.get(0)).getAnotacionesPadre().isEmpty()){
          ...
          <tr>
              ...
              <%if (folioD!=null && folioD.getPadre()!=null)
              {
                ...
                try
                {
                  numRad=folioD.getPadre().getNumRadicacion();
                }
                catch(Throwable t)
                {
                  t.printStackTrace();
        ...
        <%}
      	...
      	else if(!((Anotacion)folio.getAnotaciones().get(anotaciones.size()-1)).getAnotacionesHijos().isEmpty()){
          	
          	Anotacion anota =(Anotacion)anotaciones.get(anotaciones.size()-1);
          	
          	Iterator itHijos = anota.getAnotacionesHijos().iterator();
 ...
 <table width="100%" class="camposform">
	          ...
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.CONFIRMAR_MAYOR_EXT%>">
	          <td width="150" align="center"><p>
	          <input name="imageField52" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_imprimir.gif" width="139" height="21" border="0">
	          </p></td>
	          </form>
              <%} else {%>
	              <td width="150" align="center"><p>
              ...
              <%}%>	          
	          <form name="ENTREGA" method="post" action="certificado.do">
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.NEGAR_MAYOR_EXT%>">
              <input type="hidden" name="<%=WebKeys.OCULTAR_TURNO%>" value="TRUE">
              <input type="hidden" name="<%=WebKeys.OCULTAR_FOLIO%>" value="TRUE">   
              <!--
              /**
                * @author      :  Diana Lora
                * @change      :  Revision: Eliminar botón Enviar Caso.
                * Caso Mantis  :  0009253: Acta - Requerimiento No 037_151 - Rol Usuario Operativo Certificados - Botón Enviar Caso
                */
              <td width="150" align="center"><p>
              <input name="imageField52" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_enviar_caso.gif" width="139" height="21" border="0">
              </p></td>
              -->
              </form>
