...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
        ...
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
            <tr> 
                <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Folio Definitivo</td>
    ...
    <table width="100%" class="camposform">
					...
					if(!solFolios.isEmpty()){
						while(itSolFolios.hasNext()){
							 solFolio = (SolicitudFolio)itSolFolios.next();%>
        <tr>
        <td width="20"><img src="<%= request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
        <td>N&uacute;mero de Matr&iacute;cula</td>
        <td class="campositem"><%=(((Folio)solFolio.getFolio()).getIdMatricula()!=null?((Folio)solFolio.getFolio()).getIdMatricula():blanco)%>&nbsp;</td>
        </tr>
...
%>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        ...
        <td class="campositem" colspan="7"><%=folio!=null?folio.getIdMatricula():"SIN NÚMERO DE MATRÍCULA"%>&nbsp;</td>
        </tr>
        ...
        <td class="campositem"><%= (folio.getZonaRegistral().getCirculo().getNombre()!=null?folio.getZonaRegistral().getCirculo().getNombre():blanco)%>&nbsp;</td>
        <td>Depto:</td>
        <td class="campositem"><%= (folio.getZonaRegistral().getVereda().getMunicipio().getDepartamento().getNombre()!=null?folio.getZonaRegistral().getVereda().getMunicipio().getDepartamento().getNombre():blanco)%>&nbsp;</td>
        <td>Municipio:</td>
        <td class="campositem"><%= (folio.getZonaRegistral().getVereda().getMunicipio().getNombre()!=null?folio.getZonaRegistral().getVereda().getMunicipio().getDepartamento().getNombre():blanco)%>&nbsp;</td>
        <td>Vereda:</td>
        <td class="campositem"><%= (folio.getZonaRegistral().getVereda().getNombre()!=null?folio.getZonaRegistral().getVereda().getNombre():blanco)%>&nbsp;</td>
        </tr>
        <tr>
...
<!--        <td class="campositem"><%= (folio.getDocumento().getTipoDocumento().getNombre()!=null?folio.getDocumento().getTipoDocumento().getNombre():blanco)%> de: <%=(folio.getDocumento().getNumero()!=null?folio.getDocumento().getNumero():blanco)%>&nbsp;</td>        -->
        <td class="campositem"><%= folio.getDocumento().getTipoDocumento().getNombre()%>&nbsp;</td>
        <%} else {%>
        <td class="campositem">No hay documento asociado</td>
        <%}%>
        <td>Cod Catastral : </td>
        <td class="campositem"><%=(folio.getCodCatastral()!=null?folio.getCodCatastral():blanco)%>&nbsp;</td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        ...
        <td class="campositem">&nbsp;<strong><% 
                  if(folio.getEstado() != null){
                  		if(folio.getEstado().getNombre() != null){
...
%>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        <tr>
            <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
            <td class="campositem"><%=(folio.getLindero()!=null?folio.getLindero():blanco)%>&nbsp;</td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        <tr>
            <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
            <td class="campositem"><%=(folio.getComplementacion().getComplementacion()!=null?folio.getComplementacion().getComplementacion():blanco)%></td>
        </tr>
     </table>
        <br>
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
        <td width="12"><img name="sub_r1_c1" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c1.gif" width="12" height="22" border="0" alt=""></td>
        <td background="<%=request.getContextPath()%>/jsp/images/sub_bgn001.gif" class="bgnsub">Direcci&oacute;n del inmueble</td>
        <td width="16" class="bgnsub"><img src="<%=request.getContextPath()%>/jsp/images/ico_matriculas.gif" width="16" height="21"></td>
        <td width="15"><img name="sub_r1_c4" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c4.gif" width="15" height="22" border="0" alt=""></td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        <tr>
            ...
            <td class="campositem"><%= (folio.getTipoPredio().getNombre()!=null?folio.getTipoPredio().getNombre():blanco)%>&nbsp;</td>
        </tr>
    </table>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
      <%
          ...
          <tr>
              ...
              <td class="campositem"><%=(folioD.getPadre().getNumRadicacion()!=null?folioD.getPadre().getNumRadicacion():blanco)%></td>
              <%}%>
          </tr>
          	<%}
      	%>
          ...
          <tr>
              <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
              <td class="campositem"><%=(folioD.getHijo().getNumRadicacion()!=null?folioD.getHijo().getNumRadicacion():blanco)%></td>
          </tr>
          	<%	}
          	}
      	} %><%else {
...
%>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        <tr>
            ...
            <%}else{%>
            <td width="212" class="campositem"><%=idwf!=null?idwf:""%>&nbsp;</td>
            <%}%>            
        </tr>
        <tr>
            <td><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
            <td>Doc</td>
            <td class="campositem"><%=(anotacion.getDocumento().getTipoDocumento().getNombre()!=null?anotacion.getDocumento().getTipoDocumento().getNombre():blanco)%> <%=(anotacion.getDocumento().getNumero()!=null?anotacion.getDocumento().getNumero():blanco)%>&nbsp;</td>
            <td>Del</td>
            <td class="campositem">
	        <%
    ...
    <td class="campositem"><span class="titresaltados"><%=(anCiudadano.getStringMarcaPropietario()!=null?anCiudadano.getStringMarcaPropietario():blanco)%></span>&nbsp;</td>
    </tr>
				<%}%>
    </table>
				<%}%>
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
            ...
            <tr>
				...
				<td width="150" align="center"><a href="confirmacion.view"><img name="imageField" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0"></a></td>
              	</form>
