...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Generar Oficio </td>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"> 
                  ...
                  <td align="left">
                   <form name="ENTREGA" method="post" action="certificado.do">
						...
						try{
							textArea.setRows("20");
							textArea.setCols("60");
							textArea.setId(AWCertificado.OFICIO_PERTENENCIA);
							textArea.setNombre(AWCertificado.OFICIO_PERTENENCIA);
         	...
         	<table width="100%" class="camposform">
              <tr>
			      ...
			      <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.OFICIO_PERTENENCIA_CONFIRMAR%>">
    	          ...
    	          <form name="ENTREGA" method="post" action="turnos.view">   
