    ...
    <hr class="linehorizontal">
       <%}%>
	        ...
	        <table width="100%" class="camposform">
	          ...
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.ANT_SISTEMA_REVISION_INICIAL_CONFIRMAR%>">
	          ...
	          <form name="ENTREGA" method="post" action="certificado.do">
	          <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.ANT_SISTEMA_REVISION_INICIAL_NEGAR%>">
              <td width="150" align="center"><p>
