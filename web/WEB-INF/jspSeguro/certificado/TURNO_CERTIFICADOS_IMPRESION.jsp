...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <br>
    <%
      ZonaRegistral zona = folio.getZonaRegistral();
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        ...
        <td><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
	        ...
	        <td>Con:</td>
	        <% 
	          Documento folioDocumento = folio.getDocumento(); 
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        ...
        <td class="campositem"><strong><% 
                  EstadoFolio estado=folio.getEstado();
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="2" class="camposform">
        <tr>
            ...
            <%
              ...
              Complementacion comp = folio.getComplementacion();
              if (comp!=null)
              {
        ...
        if (anotacionesHijas==null)
      	...
      	if(!anotacionesPadre.isEmpty())
      	{
          	...
          	while( itPadres.hasNext() )
          	{
          	  ...
          	  Anotacion anotaPadre=folioD.getPadre();
          	  String numRad = "&nbsp;";
      	...
      	else if(!anotacionesHijas.isEmpty())
      	{
          	...
          	while(itHijos.hasNext())
          	{
	            ...
	            Anotacion anotaHija=folioD.getHijo();
          	    String numRad = "&nbsp;";
    ...
    <hr class="linehorizontal">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
              ...
              <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWCertificado.IMPRIMIR_CONFIRMAR%>">
              ...
              <input type="hidden" name="<%=WebKeys.OCULTAR_TURNO%>" value="FALSE">
	          <input type="hidden" name="<%=WebKeys.OCULTAR_FOLIO%>" value="FALSE">    
			  <input type="hidden" name="<%=AWCertificado.PRINTESPECIAL%>" value="FALSE">
