...
<%@page import="gov.sir.core.negocio.acciones.excepciones.CopiaAnotacionHTException"%>
...
<% 	
	...
	CopiaAnotacionHTException exception = (CopiaAnotacionHTException)session.getAttribute(WebKeys.EXCEPCION_COPIA_ANOTACION);
	
	List foliosACopiarBad = new ArrayList(); 
	
	if(exception!=null){ 
		Hashtable ht =  exception.getHashErrores();
		
		Iterator itRevision = foliosACopiar.iterator();
		while(itRevision.hasNext()){
			Folio folio = (Folio)itRevision.next();
			Object obj = ht.get(folio.getIdMatricula());
			if(obj==null){
				copiaAnotacion.getFoliosACopiarOk().add(folio);
			}else{
				foliosACopiarBad.add(folio);
			}
		}
	}
	
	foliosACopiar = foliosACopiarBad;
	copiaAnotacion.setFoliosACopiar(foliosACopiarBad);

	session.setAttribute(WebKeys.COPIA_ANOTACION,copiaAnotacion);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn002.gif"> <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">COPIA ANOTACIÓN - CORREGIR ANOTACIONES A CANCELAR <%=extra%></td>
    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"> 
            ...
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= WebKeys.ACCION%>" value="<%= gov.sir.core.web.acciones.registro.AWCopiaAnotacion.CORREGIR_CANCELADA%>">
			  ...
			  <%
			  	List folios = copiaAnotacion.getFoliosACopiar();
			  	int a=1;
			  ...
			  %>
                ...
                <tr> 
                  ...
                  <td class="contenido" width="40%"><input name="<%= gov.sir.core.negocio.modelo.constantes.CAnotacion.ORDEN_ANOTACION + folio.getIdMatricula()%>" type="text" class="camposformtext" value="<%=temp!=null?temp:""%>"></td>                </tr>
