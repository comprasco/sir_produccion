...
<%
    ...
    List listaNotasInformativas = (List)session.getAttribute(WebKeys.LISTA_TIPOS_NOTAS_DEVOLUTIVAS);
...
function submitform(){
	document.NOTAS_INF.ACCION.value='<%=AWTestamentos.COLOCAR_DESCRIPCION%>';
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
         ...
         <form action="testamentos.do" method="post" name="NOTAS_INF" id="NOTAS_INF">
         <input type="hidden" name="<%=WebKeys.ACCION%>" value="<%=AWTestamentos.DEVOLVER%>">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
		 ...
		 <table width="100%" class="camposform">
    			...
    			<td ><a href='registro.testamentos.view'><img name="imageField" src="<%=request.getContextPath()%>/jsp/images/btn_cancelar.gif"   width="139" height="21" border="0" ></a></td>
