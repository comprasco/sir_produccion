...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"><table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<%
			GrupoNaturalezaJuridicaHelper helper = new GrupoNaturalezaJuridicaHelper(WebKeys.LISTA_ANOTACIONES_GRAVAMEN,"Gravamen");
        ...
        <tr>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<%
			GrupoNaturalezaJuridicaHelper helpermc = new GrupoNaturalezaJuridicaHelper(WebKeys.LISTA_ANOTACIONES_MEDIDAS_CAUTELARES,"Medidas Cautelares");
