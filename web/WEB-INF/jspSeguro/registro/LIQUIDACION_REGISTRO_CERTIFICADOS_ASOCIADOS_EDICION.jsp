...
<% 
	...
	//SE CARGA LA LISTA DE MATRICULAS O CERTIFICADOS ASOCIADOS, POR DEFECTO SE COLOCAN LAS MATRÍCULAS ASOCIADAS
...
<SCRIPT>
	...
	function eliminarMatriculas(){
		cambiarAccion('<%=AWLiquidacionRegistro.ELIMINAR_MATRICULA_CERTIFICADO_ASOCIADO_EDICION%>')
	}
	
	function cerrarVentana(){
		//window.opener.location.reload();
		window.opener.location.href = 'turno.registro.editar.liquidacion.view';
		window.close();
	}	
    ...
    <td colspan="4">
        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td id="TAB1ACTIVO" style="display:block" valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('1')">
                  <tr>
                ...
                <td id="TAB1INACTIVO" style="display:none" valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('1')">
                    <tr>
               ...
               <td id="TAB3ACTIVO" style="display:none" valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('3')">
                  <tr>
                ...
                <td id="TAB3INACTIVO" style="display:block" valign="top"><table border="0" cellpadding="0" cellspacing="0" onclick="cambiarTab('3')">
                    <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
			            ...
			            <%}%>
						 ...
						 <tr>  
							 ...
							 <td><%=idCirculo%><input name="<%=CFolio.ID_MATRICULA%>" id="<%=CFolio.ID_MATRICULA%>" type="text" value=""  onFocus="campoactual('<%=CFolio.ID_MATRICULA%>');" class="camposformtext">
						 ...
						 <td width="30%"> <a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.registro.AWLiquidacionRegistro.AGREGAR_MATRICULA_CERTIFICADO_ASOCIADO_EDICION%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_short_anadir.gif" width="35" height="25" border="0" ></a>
						 </td>  	
			                  <td width="20">&nbsp;</td>			                  
			                  <td  colspan='2' width="50%">&nbsp;</td>								 					 
						 </tr>  
        ...
        <tr id="TAB3" style="display:none">
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
        					...
        					<table width="100%" class="camposform">
			                  ...
			                  Eliminar certificados asociados sin matrícula
			                  </td>
			                  <td width="15%" valign='middle' align='left'>
								<a href="javascript:cambiarAccion('<%=AWLiquidacionRegistro.ELIMINAR_CERTIFICADO_ASOCIADO_SEGREGACION_EDICION%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_short_eliminar.gif" width="35" height="25" alt="Eliminar certificados asociados de segregación" border="0"  /></a>			                  
			                  </td>
			                  </tr>
			                </table>          
			    			...
			    			<td >
			    			<a href="javascript:cambiarAccion('<%=gov.sir.core.web.acciones.registro.AWLiquidacionRegistro.AGREGAR_CERTIFICADO_ASOCIADO_SEGREGACION_EDICION%>')">
