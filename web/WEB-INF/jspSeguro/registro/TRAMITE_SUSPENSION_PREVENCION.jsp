...
%>
<script>
    function cambiarAccionTramiteSuspensionPrev(text) {
        if (confirm('Esta seguro de agregar la respuesta: ')){        
            document.AGREGAR_RESPUESTA_PREV.<%=WebKeys.ACCION%>.value = text;
            document.AGREGAR_RESPUESTA_PREV.submit();        
        }
    }

    function avanzar() {
        if (confirm('Está seguro que desea enviar la respuesta y avanzar el turno: ')) {
            document.AGREGAR_RESPUESTA_PREV.ACCION.value = '<%=AWTramiteSuspension.AVANZAR%>';
            document.AGREGAR_RESPUESTA_PREV.submit();
        }
    }
    ...
    function cancelar() {
        if (confirm('Está seguro que desea cancelar el proceso: ')) {
            document.AGREGAR_RESPUESTA_PREV.ACCION.value = '<%=AWTramiteSuspension.CANCELAR_TRAMITE_SUSP_PREV%>';
            document.AGREGAR_RESPUESTA_PREV.submit();
        }
    }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td class="tdtablaanexa02">
            <form action="tramiteSuspension.do" method="post" name="AGREGAR_RESPUESTA_PREV" id="AGREGAR_RESPUESTA" enctype="multipart/form-data">
            <input  type="hidden" name="<%= WebKeys.ACCION%>" id="<%= AWTramiteSuspension.AGREGAR_RESPUESTA_PREV%>" value="<%= AWTramiteSuspension.AGREGAR_RESPUESTA_PREV%>">
                ...
                <tr>
                    ...
                    <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Tramite suspensión a Prevención</td>
                    ...
                    <td valign="top" bgcolor="#79849B" class="tdtablacentral">
                        ...
                        <table width="100%" class="camposform">
                            <tr>
                                ...
                                <td width="140">
                                    <a href="javascript:cambiarAccionTramiteSuspensionPrev('<%=AWTramiteSuspension.AGREGAR_RESPUESTA_PREV%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_agregar.gif" width="139" height="21" border="0"></a>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>                        
