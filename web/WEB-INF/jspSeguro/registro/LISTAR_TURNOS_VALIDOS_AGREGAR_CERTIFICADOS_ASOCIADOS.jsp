...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <form action="turnoLiquidacionRegistro.do" method="POST" name="BUSCAR" id="BUSCAR">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            ...
            <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn003.gif"><table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Lista de turnos validos</td>
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <% try {
	                      ...
	                      tablaHelper.setListName(AWLiquidacionRegistro.LISTA_ELEMENTOS_REGISTRO_VALIDOS_PARA_AGREGAR_CERTIFICADOS_ASOCIADOS);
	             ...
	             <td>
	                <table width="100%" class="camposform">
	                  ...
	                  <tr>
	                    ...
	                    <td width="15">
	                    	<input name="imageField" type="image" onClick="cambiarAccion('<%= AWLiquidacionRegistro.SOLICITAR_AGREGAR_CERTIFICADOS_ASOCIADOS%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0">
	                    </td>
	                    <td>
	                    	<input name="imageField" type="image" onClick="cambiarAccion('<%= AWLiquidacionRegistro.REGRESAR_LIQUIDACION %>');"  src="<%=request.getContextPath()%>/jsp/images/btn_volver.gif" width="139" height="21" border="0">
	                    </td>
	                  </tr>
	                </table>
	             </td>
