...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">Regresar aprobar ajuste. </td>
    ...
    <form action="aprobarAjuste.do" method="POST" name="REVISAR" id="REVISAR">
