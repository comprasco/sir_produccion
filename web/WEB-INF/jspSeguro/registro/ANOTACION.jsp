...
try{
	...
	variosCiudadanosHelper.setPropertiesHandly(numFilas,tiposIDNatural,tiposPersona,tiposSexo,tiposIDJuridica,AWCalificacion.AGREGAR_1_REGISTRO_TABLA_CIUDADANOS,
																AWCalificacion.REMOVER_1_REGISTRO_TABLA_CIUDADANOS,
																AWCalificacion.AGREGAR_VARIOS_CIUDADANOS,
																AWCalificacion.ELIMINAR_CIUDADANO_ANOTACION,
																lciudadanos, AWCalificacion.VALIDAR_CIUDADANO, "ANOTACION");
	...
	request.getSession().setAttribute("paramVistaAnterior","ANOTACION_REGISTRO");
...
function juridica(nombre,valor,dimensiones)
{
	...
	document.getElementById('natjuridica_nom').value=valor+"_NOM";
                ...
                * @Descripcion: Se asigna valor a las variables del formulario
                */
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn001.gif" class="titulotbcentral">CREAR ANOTACIONES</td>
...
<!--											<td width="40" align="center"><a href="javascript:quitar('<%=i%>','<%=AWFolio.ELIMINAR_ANOTACION%>')"><img src="<%=request.getContextPath()%>/jsp/images/btn_mini_eliminar.gif" width="35" height="13" border="0"></a></td>-->
											<td width="40" align="center"><a href="registro.anotacion.view"><img onClick="verAnotacion('ver.anotacion.view?<%=CAnotacion.POSICION%>=<%=i%>','Anotacion','width=900,height=450,scrollbars=yes','<%=i%>')" src="<%=request.getContextPath()%>/jsp/images/btn_mini_verdetalles.gif" border="0" width="35" height="13"></a></td>
											</tr>
											<%i++;			
										}%>
										</table>
              ...
              <table width="100%" class="camposform">
				  ...
				  <tr>  
					...
					<td width="40"><%try { 
							...
							textHelper.setFuncion("onBlur=\"cambiarAccionAndSendTipoTarifa('"+AWCalificacion.CARGAR_DESCRIPCION_NATURALEZA+"')\" onChange=\"verificarModalidad()\"");
...
<!--            <td width="150"><a href="javascript:cambiarAccion('GRABAR_ANOTACIONES_TEMPORAL_FOLIO')"><img src="<%=request.getContextPath()%>/jsp/images/btn_grabartmp.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>  -->
            <td><a href="calificar.folio.view?POSSCROLL=<%=request.getParameter("POSSCROLL")%>"><img src="<%=request.getContextPath()%>/jsp/images/btn_regresar.gif" name="Folio" width="139" height="21" border="0" id="Folio"></a></td>
          </tr>
        </table></td>
        <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
      </tr>
