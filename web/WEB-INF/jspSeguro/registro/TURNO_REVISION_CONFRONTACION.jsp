...
function cambiarAccion(text) {
	...
	document.REVISOR_CONFRONTACION.ACCION.value = text;
    	document.REVISOR_CONFRONTACION.submit();
}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <table border="0" align="right" cellpadding="0" cellspacing="2">
        ...
        <form action="turno.revision.confrontacion.correctiva.view" method="post" type="submit">
   ...
   %>  
    ...
    <hr class="linehorizontal">
        ...
        <tr>
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral">
          <table width="100%" class="camposform">
              <form name="REVISOR_CONFRONTACION" method="post" action="calificacion.do">
                     ...
                     <td align="center">
                         <table class="camposformnoborder">
                             <%
                                 ...
                                 Iterator itLiq = addedLiquidador.iterator();
                                 while(itLiq.hasNext()){
                                 String matLiq = (String) itLiq.next(); 
                             %>
                             <tr>
              ...
              <tr>
                  ...
                  <td><a href="javascript:cambiarAccion('REVISOR_CONFRONTACION_CONFIRMAR')"><img src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" border="0"></a> </td>
                  <td><a href="javascript:cambiarAccion('REVISOR_CONFRONTACION_DEVOLVER')"><img src="<%=request.getContextPath()%>/jsp/images/btn_enviar_confrontacion.gif" border="0"></a> </td>
              </tr> 
          </table>
          </td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_central_bgn008.gif">&nbsp;</td>
        ...
        <tr>
          ...
          <td><img name="tabla_central_pint_r3_c7" src="<%=request.getContextPath()%>/jsp/images/tabla_central_pint_r3_c7.gif" width="11" height="6" border="0" alt=""></td>
             ...
             <%
		try{
                    helper.setNombreFormulario("REVISOR_CONFRONTACION");
...
<%if(carga){%>
<script>cambiarAccion('<%=AWCalificacion.REVISOR_CONFRONTACION%>')</script>
<%}%>