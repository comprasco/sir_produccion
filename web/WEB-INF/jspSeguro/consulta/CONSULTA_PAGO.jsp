	...
	<table width="100%" class="camposform">
        <tr>
            <%if (session.getAttribute(gov.sir.core.web.acciones.consulta.AWConsulta.TIPO_CONSULTA) != null &&
              ...
              <td>Consulta Simple</td>
              <td width="16"><span class="titulotbcentral"><img src="<%=request.getContextPath()%>/jsp/images/ico_flecha.gif" width="16" height="16"></span></td>
              <td class="campostip04">De 1 a 3 b&uacute;squedas</td>
            <%} else if (session.getAttribute(gov.sir.core.web.acciones.consulta.AWConsulta.TIPO_CONSULTA) != null &&
                ((String)session.getAttribute(gov.sir.core.web.acciones.consulta.AWConsulta.TIPO_CONSULTA)).equals
                  (gov.sir.core.negocio.modelo.TipoConsulta.TIPO_COMPLEJO)) {%>
