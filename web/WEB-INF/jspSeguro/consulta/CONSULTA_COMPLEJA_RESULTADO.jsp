...
function cambiarAccion(text) {
	document.RESULTADO_CONSULTA.<%= WebKeys.ACCION %>.value = text;
}
</script>
...
function cambiarAccion1(text) {
    document.RESULTADO_CONSULTA.<%=WebKeys.ACCION%>.value = text;
    document.RESULTADO_CONSULTA.submit();
}
...
<hr class="linehorizontal">
      ...
      try {
		...
		paginadorHelper.setId(AWConsulta.PAGINADOR_RESULTADOS);
                ...
                paginadorHelper.setVista("consultas.compleja.resultado.view");
      ...
      <table width="100%" class="camposform">
        <tr>
          ...
          <img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
           <td width="140">
              <input name="imageField" type="image" onClick="cambiarAccion('<%=AWConsulta.EJECUTAR_INTENTO_COMPLEJA%>');"src="<%=request.getContextPath()%>/jsp/images/btn_buscar.gif" width="139" height="21" border="0">
           </td>
		  <td width="140">
	          <input name="imageField" type="image" onClick="cambiarAccion('<%= AWConsulta.SELECCIONAR_RESULTADOS_CONSULTA_COMPLEJA %>');" src="<%=request.getContextPath()%>/jsp/images/btn_anexar.gif" width="139" height="21" border="0">
          </td>
          <td width="190">
          <input name="imageField" type="image" onClick="cambiarAccion('<%=AWConsulta.INICIA_CONSULTA_COMPLEJA%>');" src="<%=request.getContextPath()%>/jsp/images/btn_siguiente_consulta.gif" width="180" height="21" border="0">
          </td>
          <td width="140">
          ...
          <td width="140"><a href="javascript:cambiarAccion2('<%=AWConsulta.IMPRIMIR_SELECCION_CONSULTA_COMPLEJA%>');"><img src="<%=request.getContextPath()%>/jsp/images/btn_imprimir.gif" width="139" height="21" border="0"/></a></td>
        </tr>
      </table>
