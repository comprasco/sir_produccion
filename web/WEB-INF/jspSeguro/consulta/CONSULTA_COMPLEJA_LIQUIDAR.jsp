...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="tablagral">
    ...
    <form action="consultasLiquidacion.do" method="POST" name="forma"  id="forma">
  		<input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWLiquidacionConsulta.LIQUIDAR_CONSULTA_COMPLEJA %>" value="<%= AWLiquidacionConsulta.LIQUIDAR_CONSULTA_OBSERVACION_FOLIO %>">
	</form>	
    </tr>
</table>
</body>
