...
<%
	...
	Folio f=(Folio) request.getSession().getAttribute(AWConsulta.FOLIO_CORRECCION);
    ...
    <td valign="top" bgcolor="#79849B" class="tdtablacentral">
	    <table width="100%" class="camposform">
	      <tr>
	        ...
	        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= WebKeys.ACCION %>" value="<%= AWConsulta.VOLVER %>">
