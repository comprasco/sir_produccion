    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"> 
            ...
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWConsulta.CONSULTA_FOLIO_USUARIO_INTERNO%>" value="<%= AWConsulta.CONSULTA_FOLIO_USUARIO_INTERNO %>">
              <br>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <!-- fwtable fwsrc="SIR_central_pantallasinternas_subsecciones.png" fwbase="sub.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="1" -->
                <tr> 
                  <td width="12"><img name="sub_r1_c1" src="<%=request.getContextPath()%>/jsp/images/sub_r1_c1.gif" width="12" height="22" border="0" alt=""></td>
                  <td class="bgnsub"><span class="titulotbcentral">Consultar Folio</span></td>
              ...
              <table width="100%" class="camposform">
                <tr> 
                  ...
                  <td class="contenido">
                  	<input name="<%= CFolio.NUMERO_MATRICULA_INMOBILIARIA%>" type="text" class="camposformtext">
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" class="camposform">
                <tr>
                  ...
                  <td width="140">
                  <input name="imageField" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_consultar.gif" width="139" height="21" border="0">
                  </td>
                  <td>&nbsp;</td>
                </tr>
              </table>
