...
Folio folio = (Folio)session.getAttribute(AWConsulta.FOLIO_CALIFICACION);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
	...
	<hr class="linehorizontal">
  	...
  	<form action="consultas.calificacion.view" method="post" name="CONSULTAS" target="_self" id="CONSULTAS">
							<td  align="center">
