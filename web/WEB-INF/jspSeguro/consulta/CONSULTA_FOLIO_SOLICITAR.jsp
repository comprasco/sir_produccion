    ...
    <td class="tdtablaanexa02"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td valign="top" bgcolor="#79849B" class="tdtablacentral"> 
            ...
            <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= AWConsulta.VALIDA_FOLIO%>" value="<%= AWConsulta.VALIDA_FOLIO %>">
              <br>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <!-- BEGIN HELPER CIUDADANO -->
              <% 
              	try {
	              	DatosCiudadanoHelper ciudadanoHelper = new DatosCiudadanoHelper();
	              	ciudadanoHelper.setActionFormulario("CERTIFICADO");
	              	ciudadanoHelper.render(request,out);
              	}catch(HelperException re){
					out.println("ERROR " + re.getMessage());
				}
              %>
              <!-- FIN HELPER CIUDADANO -->
              
              <hr class="linehorizontal">
              <table width="100%" class="camposform">
                <tr>
                  <td width="20"><img src="<%=request.getContextPath()%>/jsp/images/ind_vinculo.gif" width="20" height="15"></td>
                  <td width="140"><input name="imageField" type="image" src="<%=request.getContextPath()%>/jsp/images/btn_validar.gif" width="139" height="21" border="0"></td>
                  <td>&nbsp;</td>
                </tr>
              </table>
            </form>
