...
<%
	...
	if(turno != null && turno.getIdWorkflow() != null){
		mensaje="La operacion sobre el turno " + turno.getIdWorkflow() + " no pudo realizarse. Debe solicitar la reimpresión de la consulta.";	
	} else {
		mensaje="La operacion  no pudo realizarse. Debe solicitar la reimpresión de la consulta.";
	}
