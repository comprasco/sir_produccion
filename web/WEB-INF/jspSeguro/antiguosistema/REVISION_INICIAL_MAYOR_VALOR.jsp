...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Antiguo Sistema
            </td>
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral"><img src="<%=request.getContextPath()%>/jsp/images/ico_administrador.gif" width="16" height="21"></td>
          <td width="10" background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">&nbsp;</td>
          <td background="<%=request.getContextPath()%>/jsp/images/tabla_gral_bgn001.gif" class="titulotbgral">Pago
            mayor valor
            </td>
  ...
  <tr> 
    ...
    <td class="tdtablaanexa02">
        ...
        <form action="antiguosistema.do" method="POST" name="BUSCAR" id="BUSCAR">
        <input  type="hidden" name="<%= WebKeys.ACCION %>" id="<%= WebKeys.ACCION %>" value="">
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="15%">Valor Pago Mayor Valor</td>
                    <td width="1%">$</td>
                    <td width="15%">
                    	<% 
                    		try {
 		              			textHelper.setNombre(AWAntiguoSistema.PAGO_MAYOR_VALOR_TOTAL);
		 		              	textHelper.setFuncion("onBlur=\"reescribirValor(this.value,this.id)\" onKeyDown=\"return validarCaracter(event);\"");
			                  	textHelper.setCssClase("camposformtext");
			                  	textHelper.setId(AWAntiguoSistema.PAGO_MAYOR_VALOR_TOTAL);
				...
				<table width="100%" class="camposform">
                  <tr>
                    <td width="3%"><img src="<%=request.getContextPath()%>/jsp/images/ind_campotxt.gif" width="20" height="15"></td>
                    <td width="15%">Justificaci&oacute;n del pago</td>
                    <td>
                    <% 
					try{
						helper.setCols("100");
						...
						helper.setId(AWAntiguoSistema.RAZON_MAYOR_VALOR);
						helper.setNombre(AWAntiguoSistema.RAZON_MAYOR_VALOR);
						helper.setRows("10");
                ...
                <table width="100%" class="camposform">
                  <tr>
                    ...
                    <td width="155">
                    	<img onClick="cambiarAccion('<%=  AWAntiguoSistema.AVANZAR_MAYOR_VALOR%>');"   src="<%=request.getContextPath()%>/jsp/images/btn_aceptar.gif" width="139" height="21" border="0">
                    	</td>
                    <td>
                    <a href="revision.inicial.view"><img  src="<%=request.getContextPath()%>/jsp/images/btn_volver.gif" width="139" height="21" border="0" style=""></a>
                    </td>
                  </tr>
                </table>
            </FORM>    
